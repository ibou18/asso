  ...
  (t = function (L) {
    ...
    (t = function () {
          ...
          render: function (t, e, i) {
            ...
            return this.format.replace(this.fre, function () {
              return (
                (r = arguments[1]),
                (n = arguments[3]),
                (s = o.precre.exec(r)) ? ((h = s[2]), (r = s[1])) : (h = !1),
                (a = l[r]) === N
                  ? ""
                  : n && e && e[n]
                  ? e[n].get
      ...
      (C = function (t, e) {
        var i;
        return 2 === e
          ? ((i = z.floor(t.length / 2)),
            t.length % 2 ? t[i] : (t[i - 1] + t[i]) / 2)
          : t.length % 2
          ? (i = (t.length * e + e) / 4) % 1
            ? (t[z.floor(i)] + t[z.floor(i) - 1]) / 2
            : t[i - 1]
          : (i = (t.length * e + 2) / 4) % 1
          ? (t[z.floor(i)] + t[z.floor(i) - 1]) / 2
          : t[i - 1];
      ...
      (p = function (t, e, i, s, r) {
        ...
        for (
          t = (!1 === e ? parseFloat(t).toString() : t.toFixed(e)).split(""),
            (n = (n = L.inArray(".", t)) < 0 ? t.length : n) < t.length &&
              (t[n] = r),
            a = n - i;
          0 < a;
          a -= i
      ...
      (L.fn.simpledraw = function (t, e, i, s) {
        ...
        return (
          t === N && (t = L(this).innerWidth()),
          e === N && (e = L(this).innerHeight()),
          (r = L.fn.sparkline.canvas(t, e, this, s)),
          (n = L(this).data("_jqs_mhandler")) && n.registerCanvas(r),
          r
        );
      }),
      ...
      (u = e({
        ...
        updateDisplay: function () {
          ...
          if (this.over) {
            ...
            if (a) {
              if (
                (((s = L.Event("sparklineRegionChange")).sparklines =
                  this.splist),
                this.$el.trigger(s),
                this.tooltip)
              ) {
        ...
        init: function (t) {
          ...
          (this.container = t.get("tooltipContainer") || S.body),
            ...
            L(window).bind(
              ...
              L.proxy(this.updateWindowDims, this)
            ),
        ...
        return this.each(function () {
          ...
          if (
            ((t = function () {
              ...
              (t =
                "html" === l || l === N
                  ? (((a = this.getAttribute(h.get("tagValuesAttribute"))) !==
                      N &&
                      null !== a) ||
                      (a = o.html()),
                ...
                (e =
                  "auto" === h.get("width")
                    ? t.length * h.get("defaultPixelsPerValue")
                    : h.get("width")),
                "auto" === h.get("height")
                  ? (h.get("composite") && L.data(this, "_jqs_vcanvas")) ||
                    (((s = S.createElement("span")).innerHTML = "a"),
                    o.html(s),
                    (i = L(s).innerHeight() || L(s).height()),
                    L(s).remove(),
                    (s = null))
                  : (i = h.get("height")),
                h.get("disableInteraction")
                  ? (r = !1)
                  : (r = L.data(this, "_jqs_mhandler"))
                  ? h.get("composite") || r.reset()
                  : ((r = new u(this, h)), L.data(this, "_jqs_mhandler", r)),
                !h.get("composite") || L.data(this, "_jqs_vcanvas")
                  ? ((n = new L.fn.sparkline[h.get("type")](
                      this,
                      t,
                      h,
                      e,
                    ...
                    r && r.registerSparkline(n))
                  : L.data(this, "_jqs_errnotify") ||
                    (alert(
      ...
      (L.sparkline_display_visible = function () {
        ...
        for (e = 0, i = x.length; e < i; e++)
          (t = x[e][0]),
            L(t).is(":visible") && !L(t).parents().is(":hidden")
              ? (x[e][1].call(t),
                L.data(x[e][0], "_jqs_pending", !1),
                s.push(e))
              : L(t).closest("html").length ||
                L.data(t, "_jqs_pending") ||
                (L.data(x[e][0], "_jqs_pending", !1), s.push(e));
        ...
        init: function (t, e) {
          ...
          (this.userOptions = e = e || {}),
            ...
            (this.tagOptionsPrefix =
              e.enableTagOptions && (e.tagOptionsPrefix || r.tagOptionsPrefix)),
            (i =
              (n = this.getTagSetting("type")) === y
                ? s[e.type || r.type]
                : s[n]),
          ...
          if (this.tagValCache.hasOwnProperty(t)) e = this.tagValCache.key;
            ...
            if ((e = this.tag.getAttribute(n + t)) === N || null === e) e = y;
              ...
              for (
                ...
                e[(r = s[i].split(":", 2))[0].replace(/(^\s*)|(\s*$)/g, "")] =
                  F(r[1].replace(/(^\s*)|(\s*$)/g, ""));
            else e = F(e);
      ...
      (L.fn.sparkline._base = e({
        ...
        setRegionHighlight: function (t, e, i) {
          ...
          return e > this.canvasWidth || i > this.canvasHeight || e < 0 || i < 0
            ? null
            : r !== (s = this.getRegion(t, e, i)) &&
                (r !== N && n && this.removeHighlight(),
                (this.currentRegion = s) !== N && n && this.renderHighlight(),
                !0);
        },
        clearRegionHighlight: function () {
          return (
            this.currentRegion !== N &&
            (this.removeHighlight(), !(this.currentRegion = N))
          );
        },
        ...
        getCurrentRegionTooltip: function () {
          ...
          if (
            ...
            for (o = [], n = t.length; n--; )
              (l = t[n][h]), -1 != (c = L.inArray(l, a)) && (o[c] = t[n]);
            t = o;
          }
          for (i = e.length, u = t.length, n = 0; n < i; n++)
            for (
              "string" == typeof (p = e[n]) && (p = new m(p)),
                s = p.fclass || "jqsfield",
                c = 0;
              c < u;
              c++
              ...
              (t[c].isNull && d.get("tooltipSkipNull")) ||
                ...
                (r = p.render(t[c], d.get("tooltipValueLookups"), d)),
                v.push('<div className="' + s + '">' + r + "</div>"));
      ...
      (r = {
        changeHighlight: function (t) {
          ...
          r &&
            ...
            L.isArray(e) || L.isArray(r)
              ? (s.replaceWithShapes(r, e),
                (this.regionShapes[i] = L.map(e, function (t) {
                  return t.id;
                })))
      ...
      (L.fn.sparkline.line = q =
        e(L.fn.sparkline._base, {
          type: "line",
          init: function (t, e, i, s, r) {
              ...
              (e = n[t]),
                ...
                i && 2 === r.length
                  ? (h.push(Number(r[0])),
                    ...
                    l.push(Number(r[1])))
                  : s
                  ? (h.push(e[0]), o.push(e[1]), l.push(e[1]))
                  : (h.push(t),
                    null === n[t] || "null" === n[t]
                      ? o.push(null)
                      : (o.push(Number(e)), l.push(Number(e))));
            this.options.get("xvalues") && (h = this.options.get("xvalues")),
              (this.maxy = this.maxyorg = z.max.apply(z, l)),
              (this.miny = this.minyorg = z.min.apply(z, l)),
              (this.maxx = z.max.apply(z, h)),
              (this.minx = z.min.apply(z, h)),
              (this.xvalues = h),
              (this.yvalues = o),
              (this.yminmax = l);
          },
          ...
          drawNormalRange: function (t, e, i, s, r) {
            var n = this.options.get("normalRangeMin"),
              ...
              o = z.round((i * (a - n)) / r);
            this.target
              .drawRect(t, h, s, o, N, this.options.get("normalRangeColor"))
              .append();
          },
          render: function () {
            var t,
            ...
            if (
              ...
              for (
                s = r = 0,
                  ...
                  W &&
                    (((y =
                      ...
                      S.get("minSpotColor") ||
                      (S.get("spotColor") && b[i] === this.miny)) &&
                      (_ -= z.ceil(W)),
                    (y ||
                      S.get("maxSpotColor") ||
                      (S.get("spotColor") && b[i] === this.maxy)) &&
                      ((_ -= z.ceil(W)), (s += z.ceil(W))),
                    (y ||
                      ((S.get("minSpotColor") || S.get("maxSpotColor")) &&
                        (b[0] === this.miny || b[0] === this.maxy))) &&
                      ((r += z.ceil(W)), (M -= z.ceil(W))),
                    (y ||
                      S.get("spotColor") ||
                      S.get("minSpotColor") ||
                      (S.get("maxSpotColor") &&
                        (b[i] === this.miny || b[i] === this.maxy))) &&
                      (M -= z.ceil(W))),
                  _--,
                  S.get("normalRangeMin") === N ||
                    S.get("drawNormalOnTop") ||
                    this.drawNormalRange(r, s, _, M, e),
                  h = [(a = [])],
                  u = c = null,
                  d = b.length,
                  R = 0;
                ...
                (o = w[R]),
                  ...
                  (l = b[R]),
                  (c =
                    (p = r + z.round((o - this.minx) * (M / t))) +
                    ((R < d - 1 ? r + z.round((g - this.minx) * (M / t)) : M) -
                      p) /
                      2),
                  (T[R] = [u || 0, c, R]),
                  (u = c),
                  null === l
                    ? R &&
                      (null !== b[R - 1] && ((a = []), h.push(a)), H.push(null))
                    : (l < this.miny && (l = this.miny),
                      l > this.maxy && (l = this.maxy),
                      a.length || a.push([p, s + _]),
                      (n = [p, s + z.round(_ - _ * ((l - this.miny) / e))]),
                      a.push(n),
                      H.push(n));
              for (f = [], v = [], m = h.length, R = 0; R < m; R++)
                (a = h[R]).length &&
                  (S.get("fillColor") &&
                    (a.push([a[a.length - 1][0], s + _]),
                    v.push(a.slice(0)),
                    a.pop()),
              ...
              if (W && S.get("valueSpots"))
                for (
                  (x = S.get("valueSpots")).get === N && (x = new V(x)), R = 0;
                  R < d;
                  R++
                )
                  (C = x.get(b[R])) &&
                    k
                      .drawCircle(
                        r + z.round((w[R] - this.minx) * (M / t)),
                        s + z.round(_ - _ * ((b[R] - this.miny) / e)),
                        W,
                        N,
                        C
                      )
              ...
              W &&
                ...
                k
                  .drawCircle(
                    r + z.round((w[w.length - 1] - this.minx) * (M / t)),
                    s + z.round(_ - _ * ((b[i] - this.miny) / e)),
                    W,
                    N,
                    S.get("spotColor")
                  )
                ...
                this.maxy !== this.minyorg &&
                  (W &&
                    S.get("minSpotColor") &&
                    ((o = w[L.inArray(this.minyorg, b)]),
                    k
                      .drawCircle(
                        r + z.round((o - this.minx) * (M / t)),
                        s + z.round(_ - _ * ((this.minyorg - this.miny) / e)),
                        W,
                        N,
                        S.get("minSpotColor")
                      )
                  ...
                  W &&
                    S.get("maxSpotColor") &&
                    ((o = w[L.inArray(this.maxyorg, b)]),
                    k
                      .drawCircle(
                        r + z.round((o - this.minx) * (M / t)),
                        s + z.round(_ - _ * ((this.maxyorg - this.miny) / e)),
                        W,
                        N,
                        S.get("maxSpotColor")
                      )
      ...
      (L.fn.sparkline.bar = X =
        e(L.fn.sparkline._base, r, {
          type: "bar",
          init: function (t, e, i, s, r) {
            var n,
              a,
              ...
              I = -1 / 0;
            for (
              X._super.init.call(this, t, e, i, s, r), g = 0, p = e.length;
              g < p;
              g++
            )
              ((n = "string" == typeof (S = e[g]) && -1 < S.indexOf(":")) ||
                L.isArray(S)) &&
                ((y = !0),
                n && (S = e[g] = B(S.split(":"))),
                (S = O(S, null)),
                (a = z.min.apply(z, S)) < q && (q = a),
                I < (h = z.max.apply(z, S)) && (I = h));
            (this.stacked = y),
              (this.regionShapes = {}),
              (this.barWidth = M),
              (this.barSpacing = _),
              (this.totalBarWidth = M + _),
              (this.width = s = e.length * M + (e.length - 1) * _),
              this.initTarget(),
              T && ((m = H === N ? -1 / 0 : H), (x = W === N ? 1 / 0 : W)),
              (l = []),
              (o = y ? [] : l);
            var j = [],
              P = [];
            for (g = 0, p = e.length; g < p; g++)
              if (y)
                ...
                (S = T ? A(e[g], m, x) : e[g]),
                  null !== (S = e[g] = F(S)) && l.push(S);
            (this.max = v = z.max.apply(z, l)),
              (this.min = f = z.min.apply(z, l)),
              (this.stackMax = I = y ? z.max.apply(z, j) : v),
              (this.stackMin = q = y ? z.min.apply(z, l) : f),
              i.get("chartRangeMin") !== N &&
                (i.get("chartRangeClip") || i.get("chartRangeMin") < f) &&
                (f = i.get("chartRangeMin")),
              i.get("chartRangeMax") !== N &&
              ...
              (this.xaxisOffset = d),
              (u = y ? z.max.apply(z, o) + z.max.apply(z, P) : v - f),
              (this.canvasHeightEf =
                c && f < 0 ? this.canvasHeight - 2 : this.canvasHeight - 1),
              f < d
                ? (k =
                    (((y && 0 <= v ? I : v) - d) / u) * this.canvasHeight) !==
                    z.ceil(k) && ((this.canvasHeightEf -= 2), (k = z.ceil(k)))
                : (k = this.canvasHeight),
              (this.yoffset = k),
              L.isArray(i.get("colorMap"))
          ...
          calcColor: function (t, e, i) {
            ...
            return (
              (s = this.stacked
                ? h.get("stackedBarColor")
                : e < 0
                ? h.get("negBarColor")
                : h.get("barColor")),
              0 === e && h.get("zeroColor") !== N && (s = h.get("zeroColor")),
              a && (r = a.get(e)) ? (s = r) : n && n.length > i && (s = n[i]),
              L.isArray(s) ? s[t % s.length] : s
            );
          },
            ...
            if (
              ...
              return c.get("nullColor")
                ? ((r = e
                  ...
                  (i = 0 < w ? w - 1 : w),
                  x.drawRect(y, i, this.barWidth - 1, 0, r, r))
                : N;
            for (a = w, h = 0; h < o; h++) {
              if (((l = u[h]), m && l === d)) {
                if (!p || g) continue;
              ...
              (s = 0 < v ? z.floor(C * (z.abs(l - d) / v)) + 1 : 1),
                l < d || (l === d && 0 === w)
                  ? ((i = a), (a += s))
                  : ((i = w - s), (w -= s)),
                (r = this.calcColor(h, l, t)),
                e && (r = this.calcHighlightColor(r, c)),
                f.push(x.drawRect(y, i, this.barWidth - 1, s - 1, r, r));
            }
            return 1 === f.length ? f[0] : f;
          },
        })),
      (L.fn.sparkline.tristate = h =
        e(L.fn.sparkline._base, r, {
          type: "tristate",
          init: function (t, e, i, s, r) {
            ...
            if (
              ...
              (s =
                o[t] < 0
                  ...
                  ? ((a = 0), r - 1)
                  : ((a = r - 1), 2)),
              null !== (h = this.calcColor(o[t], t)))
            )
              return (
                e && (h = this.calcHighlightColor(h, l)),
                g.drawRect(n, a, this.barWidth - 1, s - 1, h, h)
              );
          },
        })),
      (L.fn.sparkline.discrete = a =
        e(L.fn.sparkline._base, r, {
          type: "discrete",
          init: function (t, e, i, s, r) {
          ...
          renderRegion: function (t, e) {
            ...
            return (
              ...
              (i = z.round(f - f * ((s - o) / g))),
              (r =
                h.get("thresholdColor") && s < h.get("thresholdValue")
                  ? h.get("thresholdColor")
                  : h.get("lineColor")),
              e && (r = this.calcHighlightColor(r, h)),
              u.drawLine(n, i, n, i + d, r)
            );
          },
        })),
      (L.fn.sparkline.bullet = o =
        e(L.fn.sparkline._base, {
          type: "bullet",
          init: function (t, e, i, s, r) {
            var n, a, h;
          ...
          renderRange: function (t, e) {
            ...
            return (
              ...
              this.target.drawRect(0, 0, s - 1, this.canvasHeight - 1, r, r)
            );
          },
          renderPerformance: function (t) {
            ...
            return (
              ...
              this.target.drawRect(
                ...
                z.round(0.3 * this.canvasHeight),
                i - 1,
                z.round(0.4 * this.canvasHeight) - 1,
                s,
                s
              )
            );
          ...
          renderTarget: function (t) {
            var e = this.values[0],
              ...
              s = z.round(0.1 * this.canvasHeight),
        ...
        e(L.fn.sparkline._base, {
          ...
          init: function (t, e, i, s, r) {
            var n,
              a = 0;
            if (
              (l._super.init.call(this, t, e, i, s, r),
              (this.shapes = {}),
              (this.valueShapes = {}),
              (this.values = e = L.map(e, Number)),
            ...
            (this.total = a),
              this.initTarget(),
              (this.radius = z.floor(
                z.min(this.canvasWidth, this.canvasHeight) / 2
              ));
          },
          getRegion: function (t, e, i) {
            var s = this.target.getShapeAt(t, e, i);
          ...
          renderSlice: function (t, e) {
            ...
            for (n = c.length, r = 0; r < n; r++) {
              if (((s = i = f), 0 < d && (s = f + u * (c[r] / d)), t === r))
                return (
                  (a = o.get("sliceColors")[r % o.get("sliceColors").length]),
                  e && (a = this.calcHighlightColor(a, o)),
                  h.drawPieSlice(l, l, l - g, i, s, N, a)
                );
              f = s;
            }
          },
        ...
        e(L.fn.sparkline._base, {
          ...
          render: function () {
            var t,
              ...
              v = this.canvasHeight,
              m =
                d.get("chartRangeMin") === N
                  ? z.min.apply(z, u)
                  : d.get("chartRangeMin"),
              x =
                d.get("chartRangeMax") === N
                  ? z.max.apply(z, u)
                  : d.get("chartRangeMax"),
              y = 0;
            if (w._super.render.call(this)) {
              ...
              (this.quartiles = [s, r, n]),
                ...
                (g = f / (x - m + 1)),
                d.get("showOutliers") &&
                  ((y = z.ceil(d.get("spotRadius"))),
                  (g = (f -= 2 * z.ceil(d.get("spotRadius"))) / (x - m + 1)),
                  e < t &&
                    p
                      .drawCircle(
                        (e - m) * g + y,
                ...
                p
                  ...
                  .append(),
                d.get("target") &&
                  ((l = z.ceil(d.get("spotRadius"))),
                  p
                    .drawLine(
                      z.round((d.get("target") - m) * g + y),
                      z.round(v / 2 - l),
                      z.round((d.get("target") - m) * g + y),
                      z.round(v / 2 + l),
                      d.get("targetColor")
      ...
      (v = e(d, {
        ...
        _drawShape: function (t, e, i, s, r) {
          ...
          return (
            ...
            (a =
              i === N
                ? ' stroked="false" '
                : ' strokeWeight="' + r + 'px" strokeColor="' + i + '" '),
            (h =
              s === N
                ? ' filled="false"'
                : ' fillColor="' + s + '" filled="true" '),
            (o = p[0] === p[p.length - 1] ? "x " : ""),
        ...
        _drawCircle: function (t, e, i, s, r, n, a) {
          return (
            ...
            (r === N
              ? ' stroked="false" '
              : ' strokeWeight="' + a + 'px" strokeColor="' + r + '" ') +
            (n === N
              ? ' filled="false"'
        ...
        _drawPieSlice: function (t, e, i, s, r, n, a, h) {
          ...
          if (r === n) return "";
          if (
            (n - r == 2 * z.PI && ((r = 0), (n = 2 * z.PI)),
            (l = e + z.round(z.cos(r) * s)),
            (g = i + z.round(z.sin(r) * s)),
            (p = e + z.round(z.cos(n) * s)),
            (u = i + z.round(z.sin(n) * s)),
            l === p && g === u)
          ) {
            if (n - r < z.PI) return "";
            (l = p = e + s), (g = u = i);
          }
          return l === p && g === u && n - r < z.PI
            ? ""
            : ((o = [e - s, i - s, e + s, i + s, l, g, p, u]),
              (c =
                a === N
                  ? ' stroked="false" '
        ...
        replaceWithShapes: function (t, e) {
          var i,
            ...
            n = e.length;
          for (i = 0; i < n; i++)
            r += this["_draw" + e[i].type].apply(this, e[i].args);
          for (s[0].outerHTML = r, i = 1; i < t.length; i++)
            L("#jqsshape" + t[i]).remove();
        },
        insertAfterShape: function (t, e) {
          var i = L("#jqsshape" + t),
            s = this["_draw" + e.type].apply(this, e.args);
