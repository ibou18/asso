...
(function (exports, undefined) {
   ...
   * @private
   */
  define("tinymce/pasteplugin/SmartPaste", ["tinymce/util/Tools"], function (
    Tools
  ) {
  ...
  define("tinymce/pasteplugin/WordFilter", [
    ...
    function isWordContent(content) {
      return (
        /<font face="Times New Roman"|className="?Mso|style="[^"]*\bmso-|style='[^'']*\bmso-|w:WordDocument/i.test(
          content
        ) ||
        /className="OutlineElement/.test(content) ||
