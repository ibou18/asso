...
(function (factory) {
  ...
  var base_html =
    '<span className="irs">' +
    '<span className="irs-line" tabindex="-1"><span className="irs-line-left"></span><span className="irs-line-mid"></span><span className="irs-line-right"></span></span>' +
  ...
  var disable_html = '<span className="irs-disable-mask"></span>';
  ...
  IonRangeSlider.prototype = {
    ...
    append: function () {
      var container_html =
        '<span className="irs js-irs-' + this.plugin_count + '"></span>';
    ...
    appendGrid: function () {
      ...
      for (i = 0; i < big_num + 1; i++) {
        ...
        html +=
          '<span className="irs-grid-pol" style="left: ' + big_w + '%"></span>';
