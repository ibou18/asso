      ...
      return (
        this.each(function () {
          ...
          if (p.parent().hasClass(k.wrapperClass)) {
            var u = p.scrollTop();
            if (
              ((b = p.closest("." + k.barClass)),
              (v = p.closest("." + k.railClass)),
              y(),
              T.isPlainObject(E))
            ) {
              ...
              if ("scrollTo" in E) u = parseInt(k.scrollTo);
                ...
                return b.remove(), v.remove(), void p.unwrap();
              x(u, !1, !0);
            }
            ...
            v.css($),
              ...
              p.bind("touchmove", function (e) {
                ...
                e.originalEvent.touches.length) &&
                  (x(
                    (o - e.originalEvent.touches[0].pageY) / k.touchScrollStep,
                    !0
                  ),
                  (o = e.originalEvent.touches[0].pageY));
              }),
              y(),
              "bottom" === k.start
                ? (b.css({ top: p.outerHeight() - b.outerHeight() }), x(0, !0))
                : "top" !== k.start &&
                  (x(T(k.start).position().top, null, !0),
                  k.alwaysVisible || b.hide()),
              (g = this),
              window.addEventListener
                ? (g.addEventListener("DOMMouseScroll", w, !1),
                  g.addEventListener("mousewheel", w, !1))
          ...
          function x(e, t, i) {
            ...
            if (
              (t &&
                ((n =
                  parseInt(b.css("top")) +
                  ((e * parseInt(k.wheelStep)) / 100) * b.outerHeight()),
            ...
            (l = r),
              a >= p.outerHeight()
                ...
                : (b.stop(!0, !0).fadeIn("fast"),
                  k.railVisible && v.stop(!0, !0).fadeIn("fast"));
          }
          function S() {
            k.alwaysVisible ||
  ...
  (function (e, t) {
    ...
    var u = {
        ...
        show: function (e, t, i) {
            ...
            (a =
              "touches" in e && e.touches.length
                ? ((o = e.touches[0].pageY - s.top),
                  e.touches[0].pageX - s.left)
                : ((o = e.pageY - s.top), e.pageX - s.left))
              ? a
              : 0),
            (o = 0 <= o ? o : 0);
          ...
          (d["-webkit-transition-duration"] = c + "ms"),
            (d["-moz-transition-duration"] = c + "ms"),
            (d["-o-transition-duration"] = c + "ms"),
            (d["transition-duration"] = c + "ms"),
            n.setAttribute("style", p(d));
        },
        hide: function (e, t) {
          for (
            var i = (t = t || this).getElementsByClassName("waves-rippling"),
              n = 0,
              s = i.length;
            n < s;
            n++
    ...
    var d = {
      ...
      allowEvent: function (e) {
        var t = !0;
        return (
          /^(mousedown|mousemove)$/.test(e.type) && d.touches && (t = !1), t
        );
      },
      ...
      if (null !== i) {
        ...
        if ((d.registerEvent(t), "touchstart" === t.type && u.delay)) {
          var n = !1,
            ...
            o = function (e) {
              s && (clearTimeout(s), (s = null), u.show(t, i)),
                n || ((n = !0), u.hide(e, i));
            };
          i.addEventListener(
            "touchmove",
    ...
    return (
      ...
      (t.attach = function (e, t) {
        ...
        for (var s = 0, o = e.length; s < o; s++)
          (n = (i = e[s]).tagName.toLowerCase()),
            -1 !== ["input", "img"].indexOf(n) &&
              (l[n](i), (i = i.parentElement)),
      ...
      (t.calm = function (e) {
        for (
          var t = { type: "mouseup", button: 1 }, i = 0, n = (e = c(e)).length;
          i < n;
          i++
        )
          u.hide(t, e[i]);
    ...
    !(function (T) {
      ...
      String.prototype.includes ||
        ...
        (t = function (e) {
          ...
          return (
            a != a && (a = 0),
            !(i < s + Math.min(Math.max(a, 0), i)) && -1 != l.call(t, n, a)
          );
        }),
        e
      ...
      T.valHooks.select.set = function (e, t) {
        return (
          t && !s.useDefault && T(e).data("selected", !0),
      ...
      (T.fn.triggerNative = function (e) {
        ...
        (T.expr.pseudos.aicontains = function (e, t, i) {
          var n = T(e).find("a");
          return (n.data("tokens") || n.data("normalizedText") || n.text())
            .toString()
            .toUpperCase()
            .includes(i[3].toUpperCase());
        }),
      ...
      var c = function (t) {
          ...
          return function (e) {
            return (
              (e = null == e ? "" : "" + e), n.test(e) ? e.replace(s, i) : e
            );
          };
        },
        k = c({
        ...
        p = function (e, t) {
          s.useDefault ||
            ((T.valHooks.select.set = s._set), (s.useDefault = !0)),
            (this.$element = T(e)),
          ...
          if (e.is("select")) {
            ...
            if (t) {
              ...
              (s.template = T.extend(
                ...
                e.data("selectpicker", (t = new p(this, s)));
            }
            "string" == typeof r &&
              (o = t[r] instanceof Function ? t[r].apply(t, a) : t.options[r]);
          }
        });
        return void 0 !== o ? o : t;
      }
        ...
        (p.prototype = {
                  ...
                  t.$button.addClass("bs-invalid"),
                    t.$element.on({
                      ...
                      "rendered.bs.select": function () {
                        this.validity.valid &&
                          t.$button.removeClass("bs-invalid"),
          ...
          createDropdown: function () {
            var e = this.multiple || this.options.showTick ? " show-tick" : "",
              ...
              n = this.options.header
                ? '<div className="popover-title"><button type="button" className="close" aria-hidden="true">&times;</button>' +
                  this.options.header +
                  "</div>"
                : "",
              ...
              o =
                this.multiple && this.options.actionsBox
                  ? '<div className="bs-actionsbox"><div className="btn-group btn-group-sm btn-block"><button type="button" className="actions-btn bs-select-all btn btn-default">' +
                    this.options.selectAllText +
                    '</button><button type="button" className="actions-btn bs-deselect-all btn btn-default">' +
                    this.options.deselectAllText +
                    "</button></div></div>"
                  : "",
              a =
                this.multiple && this.options.doneButton
                  ? '<div className="bs-donebutton"><div className="btn-group btn-block"><button type="button" className="btn btn-sm btn-default">' +
              ...
              r =
                ...
                i +
                ' role="button"><span className="filter-option pull-left"></span>&nbsp;<span className="bs-caret">' +
                this.options.template.caret +
                '</span></button><div className="dropdown-menu open" role="combobox">' +
                n +
                s +
                o +
                '<ul className="dropdown-menu inner" role="listbox" aria-expanded="false"></ul>' +
                a +
                "</div></div>";
            return T(r);
          },
          ...
          createLi: function () {
            var $ = this,
              ...
              C = function (e, t, i, n) {
                return (
                  "<li" +
                  (void 0 !== i && "" !== i ? ' className="' + i + '"' : "") +
                  (null != t ? ' data-original-index="' + t + '"' : "") +
                  (null != n ? 'data-optgroup="' + n + '"' : "") +
                  ">" +
                  e +
                  "</li>"
                );
              ...
              S = function (e, t, i, n) {
                return (
                  '<a tabindex="0"' +
                  (void 0 !== t ? ' className="' + t + '"' : "") +
                  (i ? ' style="' + i + '"' : "") +
                  ($.options.liveSearchNormalize
                    ? ' data-normalized-text="' + a(k(T(e).html())) + '"'
                    : "") +
                  (void 0 !== n || null !== n
                    ? ' data-tokens="' + n + '"'
                    : "") +
            ...
            if (
              this.options.title &&
              !this.multiple &&
              (y--, !this.$element.find(".bs-title-option").length)
            ) {
              ...
              (e.className = "bs-title-option"),
                ...
                void 0 === T(t.options[t.selectedIndex]).attr("selected") &&
            ...
            return (
              E.each(function (e) {
                ...
                if ((y++, !t.hasClass("bs-title-option"))) {
                  ...
                  if (
                    ("" !== l && p && (l = "<span>" + l + "</span>"),
                    $.options.hideDisabled && ((p && !c) || h))
                  )
                    return (
                      (i = t.data("prevHiddenIndex")),
                      t.next().data("prevHiddenIndex", void 0 !== i ? i : e),
                      void y--
                    );
                  if (
                    (t.data("content") ||
                      (o = l + '<span className="text">' + o + r + "</span>"),
                    c && !0 !== t.data("divider"))
                  ) {
                    ...
                    if (0 === t.index()) {
                      ...
                      (m =
                        ...
                        0 !== e &&
                          0 < w.length &&
                          (y++, w.push(C("", null, "divider", x + "div"))),
                        y++,
                        w.push(C(m, null, "dropdown-header" + f, x));
                    }
                    if ($.options.hideDisabled && p) return void y--;
                    w.push(C(S(o, "opt " + n + f, s, a), e, "", x));
                  } else if (!0 === t.data("divider"))
                    w.push(C("", e, "divider"));
                  else if (!0 === t.data("hidden"))
                    (i = t.data("prevHiddenIndex")),
                      t.next().data("prevHiddenIndex", void 0 !== i ? i : e),
                      w.push(C(S(o, n, s, a), e, "hidden is-hidden"));
                  else {
                    var v =
                    ...
                    if (
                      ...
                      void 0 !== (i = t.data("prevHiddenIndex"))
                    ) {
                      var b = E.eq(i)[0].previousElementSibling;
                      b && "OPTGROUP" === b.tagName && !b.disabled && (v = !0);
                    }
                    v && (y++, w.push(C("", null, "divider", x + "div"))),
                      w.push(C(S(o, n, s, a), e));
                  }
                  $.liObj[e] = y;
                }
              }),
          ...
          render: function (e) {
                ...
                .map(function () {
                  if (this.selected) {
                    ...
                    var e,
                      t = T(this),
                      i =
                        t.data("icon") && n.options.showIcon
                          ? '<i className="' +
                            n.options.iconBase +
                            " " +
                            t.data("icon") +
                    ...
                    return (
                      ...
                      void 0 !== t.attr("title")
                        ? t.attr("title")
                        : t.data("content") && n.options.showContent
                        ? t.data("content").toString()
                        : i + t.html() + e
                    );
                  }
                })
            ...
            if (
              ...
              if (
                (1 < a.length && s.length > a[1]) ||
                (1 == a.length && 2 <= s.length)
              ) {
                t = this.options.hideDisabled ? ", [disabled]" : "";
                var r = i.not(
                  '[data-divider="true"], [data-hidden="true"]' + t
                ).length;
                o = (
                  "function" == typeof this.options.countSelectedText
                    ? this.options.countSelectedText(s.length, r)
                    : this.options.countSelectedText
                )
                  .replace("{0}", s.length.toString())
            ...
            if (e || (!1 !== this.options.size && !this.sizeInfo)) {
              ...
              var u = a.offsetHeight,
                ...
                y = {
                  vert:
                    x.vert +
                    parseInt($ ? $.marginTop : w.css("marginTop")) +
                    parseInt($ ? $.marginBottom : w.css("marginBottom")) +
                    2,
                  horiz:
                    x.horiz +
                    parseInt($ ? $.marginLeft : w.css("marginLeft")) +
                    parseInt($ ? $.marginRight : w.css("marginRight")) +
                    2,
                };
          ...
          setSize: function () {
            if (
              ...
              var o,
                ...
                E = function () {
                  ...
                  u.options.container && !i.is("body")
                    ? (((e = i.offset()).top += parseInt(
                        i.css("borderTopWidth")
                      )),
                      (e.left += parseInt(i.css("borderLeftWidth"))))
                    : (e = { top: 0, left: 0 });
                  var n = u.options.windowPadding;
                  (d = t.top - e.top - s.scrollTop()),
                    (c = s.height() - d - g - e.top - n[2]),
                    (h = t.left - e.left - s.scrollLeft()),
                    (p = s.width() - h - v - e.left - n[1]),
                    (d -= n[0]),
                    (h -= n[3]);
                };
              if ((E(), "auto" === this.options.size)) {
                var i = function () {
                  var e,
                    ...
                    n = Array.prototype.filter
                      ? Array.prototype.filter.call(i, t("hidden", !1))
                      : u.$lis.not(".hidden"),
                    s = Array.prototype.filter
                      ? Array.prototype.filter.call(n, t("dropdown-header", !0))
                      : n.filter(".dropdown-header");
                  E(),
                    (o = c - S.vert),
                    (a = p - S.horiz),
                    (l = u.options.container
                      ? (f.data("height") || f.data("height", f.height()),
                        (r = f.data("height")),
                        f.data("width") || f.data("width", f.width()),
                        f.data("width"))
                      : ((r = f.height()), f.width())),
                ...
                this.$lis.not(t).length > this.options.size
              ) {
                var n = this.$lis
                    .not(".divider")
                    .not(t)
          ...
          selectPosition: function () {
            this.$bsContainer = T('<div className="bs-container" />');
            var t,
              i,
              n,
              s = this,
            ...
            this.$button.on("click", function () {
              ...
              s.isDisabled() ||
                ...
                s.$bsContainer
                  ...
                  .toggleClass("open", !e.hasClass("open"))
                  .append(s.$menu));
            }),
          ...
          clickListener: function () {
            ...
            t.data("spaceSelect", !1),
              ...
              this.$element.on("shown.bs.select", function () {
                if (w.options.liveSearch || w.multiple) {
                  if (!w.multiple) {
                    ...
                    var t =
                      w.$lis.eq(e)[0].offsetTop - w.$menuInner[0].offsetTop;
                    (t =
                      t -
                      w.$menuInner[0].offsetHeight / 2 +
                      w.sizeInfo.liHeight / 2),
                      (w.$menuInner[0].scrollTop = t);
                  }
              ...
              this.$menuInner.on("click", "li a", function (e) {
                ...
                if (
                  (w.multiple &&
                    1 !== w.options.maxOptions &&
                    e.stopPropagation(),
                  e.preventDefault(),
                  !w.isDisabled() && !t.parent().hasClass("disabled"))
                ) {
                      ...
                      if ((c && p) || (h && u))
                        if (c && 1 == c)
                          ...
                          var m =
                            ...
                            v = g[0].replace("{n}", c),
                            b = g[1].replace("{n}", h),
                            $ = T('<div className="notify"></div>');
                          g[2] &&
                            ((v = v.replace("{var}", g[2][1 < c ? 0 : 1])),
                            (b = b.replace("{var}", g[2][1 < h ? 0 : 1]))),
                            r.prop("selected", !1),
                            w.$menu.append($),
                            c &&
                              p &&
                              ($.append(T("<div>" + v + "</div>")),
                              (o = !1),
                              w.$element.trigger("maxReached.bs.select")),
                            h &&
                              u &&
                              ($.append(T("<div>" + b + "</div>")),
                              (o = !1),
                              w.$element.trigger("maxReachedGrp.bs.select")),
                            setTimeout(function () {
                              w.setSelected(i, !1);
                            }, 10),
                  ...
                  !w.multiple || (w.multiple && 1 === w.options.maxOptions)
                    ? w.$button.focus()
                    : w.options.liveSearch && w.$searchbox.focus(),
                    o &&
                      ((n != w.$element.val() && w.multiple) ||
                        (s != w.$element.prop("selectedIndex") &&
                          !w.multiple)) &&
                      ((x = [i, r.prop("selected"), l]),
              ...
              this.$menu.on(
                ...
                function (e) {
                  e.currentTarget == this &&
                    (e.preventDefault(),
                    e.stopPropagation(),
                    w.options.liveSearch && !T(e.target).hasClass("close")
                      ? w.$searchbox.focus()
                      : w.$button.focus());
                }
              ),
              ...
              this.$menu.on("click", ".actions-btn", function (e) {
                w.options.liveSearch ? w.$searchbox.focus() : w.$button.focus(),
                  e.preventDefault(),
                  e.stopPropagation(),
              ...
              this.$element.change(function () {
                w.render(!1),
                  w.$element.trigger("changed.bs.select", x),
                  (x = null);
              });
          },
          liveSearchListener: function () {
            var s = this,
              o = T('<li className="no-results"></li>');
            this.$button.on("click.dropdown.data-api", function () {
              ...
              this.$searchbox.on("input propertychange", function () {
                if (
                  ...
                  if (
                    (e = s.options.liveSearchNormalize
                      ? t.not(
                          ":a" +
                            s._searchStyle() +
                            '("' +
                    ...
                    o.html(
                      s.options.noneResultsText.replace(
                        "{0}",
                        '"' + k(s.$searchbox.val()) + '"'
                      )
                    ),
                      s.$menuInner.append(o),
                      s.$lis.addClass("hidden");
                  else {
                    e.addClass("hidden");
                    var i,
                      n = s.$lis.not(".hidden");
                    n.each(function (e) {
                      ...
                      t.hasClass("divider")
                        ...
                        : t.hasClass("dropdown-header") &&
                          n.eq(e + 1).data("optgroup") !== t.data("optgroup")
                        ? t.addClass("hidden")
                        : (i = null);
                    }),
                      i && i.addClass("hidden"),
          ...
          val: function (e) {
            return void 0 !== e
              ? (this.$element.val(e), this.render(), this.$element)
              : this.$element.val();
          },
          ...
          keydown: function (t) {
            var e,
              ...
              s,
              o = T(this),
              a = (o.is("input") ? o.parent().parent() : o.parent()).data(
                "this"
              ),
            ...
            if (
              !(s = a.$newElement.hasClass("open")) &&
              ((48 <= t.keyCode && t.keyCode <= 57) ||
                (96 <= t.keyCode && t.keyCode <= 105) ||
                (65 <= t.keyCode && t.keyCode <= 90))
            )
              return (
                a.options.container
                  ? a.$button.trigger("click")
                  : (a.setSize(), a.$menu.parent().addClass("open"), (s = !0)),
            ...
            if (
              ...
              (i = a.options.liveSearch
                ...
                : e.index(e.find("a").filter(":focus").parent())),
                (n = a.$menuInner.data("prevIndex")),
                38 == t.keyCode
                  ? ((!a.options.liveSearch && i != n) || -1 == i || i--,
                    i < 0 && (i += e.length))
                  : 40 == t.keyCode &&
                    ((a.options.liveSearch || i == n) && i++, (i %= e.length)),
              ...
              (e = a.$lis.filter(r)).each(function (e) {
                ...
                l[t.keyCode]
                  ? ((d = 1), T(document).data("keycount", d))
                  : d >= c.length &&
                    (T(document).data("keycount", 0), d > c.length && (d = 1)),
                e
                  .eq(c[d - 1])
                  .children("a")
                  .focus();
