...
(function (factory) {
  ...
  prototype.resetPreview = function () {
    this.$preview.each(function () {
      ...
      $this
        .html($this.data(CROPPER_PREVIEW).original)
  ...
  prototype.addListeners = function () {
    ...
    this.$element
      .on(EVENT_DRAG_START, options.dragstart)
      .on(EVENT_DRAG_MOVE, options.dragmove)
      .on(EVENT_DRAG_END, options.dragend)
      .on(EVENT_ZOOM_IN, options.zoomin)
      .on(EVENT_ZOOM_OUT, options.zoomout);
    this.$cropper
      .on(EVENT_MOUSE_DOWN, $.proxy(this.dragstart, this))
      .on(EVENT_DBLCLICK, $.proxy(this.dblclick, this));
    ...
    $document
      .on(EVENT_MOUSE_MOVE, (this._dragmove = proxy(this.dragmove, this)))
      .on(EVENT_MOUSE_UP, (this._dragend = proxy(this.dragend, this)));
  ...
  prototype.removeListeners = function () {
    ...
    this.$element
      .off(EVENT_DRAG_START, options.dragstart)
      .off(EVENT_DRAG_MOVE, options.dragmove)
      .off(EVENT_DRAG_END, options.dragend)
      .off(EVENT_ZOOM_IN, options.zoomin)
      .off(EVENT_ZOOM_OUT, options.zoomout);
    this.$cropper
      .off(EVENT_MOUSE_DOWN, this.dragstart)
      .off(EVENT_DBLCLICK, this.dblclick);
    ...
    $document
      .off(EVENT_MOUSE_MOVE, this._dragmove)
      .off(EVENT_MOUSE_UP, this._dragend);
  ...
  $.extend(prototype, {
    ...
    zoom: function (delta) {
      ...
      if (delta && this.built && !this.disabled && this.options.zoomable) {
        zoomEvent =
          delta > 0 ? $.Event(EVENT_ZOOM_IN) : $.Event(EVENT_ZOOM_OUT);
    ...
    setDragMode: function (mode) {
      ...
      $dragBox
        .toggleClass(CLASS_CROP, cropable)
  ...
  <div className="cropper-container">
    <div className="cropper-canvas"></div>
    <div className="cropper-drag-box" data-drag="move"></div>
    <div className="cropper-crop-box">
      ...
      <span className="cropper-face" data-drag="all"></span>
      <span className="cropper-line line-e" data-drag="e"></span>
      <span className="cropper-line line-n" data-drag="n"></span>
      <span className="cropper-line line-w" data-drag="w"></span>
      <span className="cropper-line line-s" data-drag="s"></span>
      <span className="cropper-point point-e" data-drag="e"></span>
      <span className="cropper-point point-n" data-drag="n"></span>
      <span className="cropper-point point-w" data-drag="w"></span>
      <span className="cropper-point point-s" data-drag="s"></span>
      <span className="cropper-point point-ne" data-drag="ne"></span>
      <span className="cropper-point point-nw" data-drag="nw"></span>
      <span className="cropper-point point-sw" data-drag="sw"></span>
      <span className="cropper-point point-se" data-drag="se"></span>
    </div>
  </div>
  */
