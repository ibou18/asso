/*! Summernote v0.8.2 | (c) 2013-2015 Alan Hong and other contributors | MIT license */ !(function (
  a
) {
        ...
        Y = function (b, c) {
          ...
          if (A(b.node) === b.offset) {
            ...
            W(b.node)
              ...
              : ((d = b.node), (e = c ? A(b.node) : b.offset + 1));
          return {
            node: d,
            offset: e,
          };
    ...
    Context = function (a, b) {
      ...
      return (
        ...
        (this.initialize = function () {
          return (
            (this.layoutInfo = d.createLayout(a, b)),
            this._initialize(),
            a.hide(),
            this
          );
        ...
        (this.createInvokeHandler = function (a, b) {
          return function (d) {
            d.preventDefault(),
              c.invoke(
                a,
                b || $(d.target).closest("[data-value]").data("value")
              );
          };
        }),
  ...
  var Renderer = function (a, b, c, d) {
      this.render = function (e) {
        ...
        return (
          d && d(f, c), c && c.callback && c.callback(f), e && e.append(f), f
        );
      };
    },
    renderer = {
    ...
    toolbar = renderer.create('<div className="note-toolbar panel-heading"/>'),
    editingArea = renderer.create('<div className="note-editing-area"/>'),
    codable = renderer.create('<textarea className="note-codable"/>'),
    editable = renderer.create(
      '<div className="note-editable panel-body" contentEditable="true"/>'
    ),
    ...
    airEditor = renderer.create('<div className="note-editor"/>'),
    airEditable = renderer.create(
      '<div className="note-editable" contentEditable="true"/>'
    ),
    buttonGroup = renderer.create('<div className="note-btn-group btn-group">'),
    button = renderer.create(
      '<button type="button" className="note-btn btn btn-default btn-sm" tabindex="-1">',
      function (a, b) {
        b &&
          b.tooltip &&
          a
    ...
    palette = renderer.create(
      ...
      function (a, b) {
        for (var c = [], d = 0, e = b.colors.length; e > d; d++) {
          ...
          c.push('<div className="note-color-row">' + h.join("") + "</div>");
        }
        a.html(c.join("")),
        ...
        b.fade && a.addClass("fade"),
          a.html(
            [
              ...
              b.title
                ? '    <div className="modal-header">      <button type="button" className="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>      <h4 className="modal-title">' +
                  b.title +
                  "</h4>    </div>"
                : "",
              '    <div className="modal-body">' + b.body + "</div>",
              b.footer
                ? '    <div className="modal-footer">' + b.footer + "</div>"
                : "",
              "  </div>",
              "</div>",
            ].join("")
    ...
    range = (function () {
        ...
        c = function (a, d, e, f) {
          ...
          (this.getPoints = function () {
            ...
            (this.normalize = function () {
              var a = function (a, b) {
                  if (
                    (dom.isVisiblePoint(a) && !dom.isEdgePoint(a)) ||
                    (dom.isVisiblePoint(a) && dom.isRightEdgePoint(a) && !b) ||
                    (dom.isVisiblePoint(a) && dom.isLeftEdgePoint(a) && b) ||
                    (dom.isVisiblePoint(a) &&
                      dom.isBlock(a.node) &&
                      dom.isEmpty(a.node))
                  )
                    return a;
                  ...
                  if (
                    ((dom.isLeftEdgePointOf(a, c) ||
                      dom.isVoid(dom.prevPoint(a).node)) &&
                      !b) ||
                    ((dom.isRightEdgePointOf(a, c) ||
                      dom.isVoid(dom.nextPoint(a).node)) &&
                      b)
                  ) {
                    ...
                    if (!dom.isEditable(b.node)) {
                      ...
                      d
                        ? (dom.isLeftEdgePoint(b) && h.push(b.node),
                          dom.isRightEdgePoint(b) &&
                            list.contains(h, b.node) &&
                            (e = b.node))
                        : (e = c ? dom.ancestor(b.node, a) : b.node),
                        e && a(e) && g.push(e);
                    }
                  },
                  !0
          ...
          (this.isOnEditable = h(dom.isEditable)),
            ...
            (this.wrapBodyInlineWithPara = function () {
              ...
              if (dom.isInline(b.sc)) {
                ...
                (d = list.last(e)),
                  dom.isInline(d) ||
                    (d = e[e.length - 2] || b.sc.childNodes[b.so]);
              } else d = b.sc.childNodes[b.so > 0 ? b.so - 1 : 0];
              var f = dom.listPrev(d, dom.isParaInline).reverse();
              if (
                ((f = f.concat(dom.listNext(d.nextSibling, dom.isParaInline))),
                f.length)
              ) {
            ...
            (this.getWordRange = function (a) {
              ...
              return (
                a &&
                  (b = dom.nextPointUntil(b, function (a) {
                    return !dom.isCharPoint(a);
                  })),
      ...
      return {
        ...
        createFromSelection: function () {
          ...
          if (agent.isW3CRangeSupport) {
            ...
            var l = a(k, !0),
              m = a(j, !1);
            dom.isText(l.node) &&
              dom.isLeftEdgePoint(l) &&
              dom.isTextNode(m.node) &&
              dom.isRightEdgePoint(m) &&
              m.node.nextSibling === l.node &&
              (l = m),
              (b = l.cont),
              (d = l.offset),
              (e = m.cont),
        ...
        createFromNode: function (a) {
          ...
          return (
            dom.isVoid(b) &&
              ((c = dom.listPrev(b).length - 1), (b = b.parentNode)),
            dom.isBR(d)
              ? ((e = dom.listPrev(d).length - 1), (d = d.parentNode))
              : dom.isVoid(d) &&
                ((e = dom.listPrev(d).length), (d = d.parentNode)),
            this.create(b, c, d, e)
          );
        },
      ...
      var b = [],
        ...
        f = function (b) {
          null !== b.contents && a.html(b.contents),
            null !== b.bookmark &&
              range.createFromBookmark(d, b.bookmark).select();
        };
    ...
    Style = function () {
      ...
      (this.fromNode = function (b) {
        ...
        (this.current = function (a) {
          ...
          return (
            (c.anchor = a.isOnAnchor() && dom.ancestor(a.sc, dom.isAnchor)),
      ...
      (this.insertOrderedList = function (a) {
        ...
        (this.wrapList = function (a, b) {
          ...
          return (
            ...
            f &&
              (dom.appendChildNodes(g, list.from(f.childNodes)), dom.remove(f)),
            a
          );
        }),
          ...
          return (
            $.each(a, function (a, d) {
              ...
              (d = b
                ...
                : list.from(i.childNodes).filter(dom.isLi)),
                (b || !dom.isList(g.parentNode)) &&
                  (d = d.map(function (a) {
        ...
        (this.insertParagraph = function (b) {
          ...
          if (e) {
            ...
            if (
              dom.isEmpty(e) &&
              dom.isPara(e) &&
              dom.isBlockquote(e.parentNode)
            )
              dom.insertAfter(e, e.parentNode), (d = e);
            else {
    ...
    Editor = function (a) {
      ...
      (this.initialize = function () {
        ...
        (this.preventDefaultEditableShortCuts = function (a) {
          (a.ctrlKey || a.metaKey) &&
            list.contains([66, 73, 85], a.keyCode) &&
            a.preventDefault();
        }),
        ...
        (this.pasteByEvent = function (b) {
          ...
          if (c && c.items && c.items.length) {
            ...
            "file" === d.kind &&
              ...
              a.invoke("editor.insertImagesOrCallback", [d.getAsFile()]),
  ...
  var Codeview = function (a) {
    ...
    AutoLink = function (a) {
      ...
      (this.events = {
        ...
        (this.handleKeyup = function (a) {
          list.contains([key.code.ENTER, key.code.SPACE], a.keyCode) &&
            this.replace();
        });
    },
    AutoSync = function (a) {
    ...
    Placeholder = function (a) {
      ...
      (this.events = {
        ...
        (this.update = function () {
          var b =
            !a.invoke("codeview.isActivated") && a.invoke("editor.isEmpty");
    ...
    Buttons = function (a) {
      ...
      (this.initialize = function () {
        ...
        (this.isFontInstalled = function (a) {
          return (
            b.fontInstalledMap.hasOwnProperty(a) ||
              (b.fontInstalledMap[a] =
                agent.isFontInstalled(a) ||
                list.contains(e.fontNamesIgnoreCheck, a)),
            b.fontInstalledMap[a]
          );
        }),
            ...
            return c
              .buttonGroup([
                c.button({
                  ...
                  contents:
                    c.icon(e.icons.magic) + " " + c.icon(e.icons.caret, "span"),
                    ...
                    c.dropdown({
                      items: [
                        ...
                        '  <div className="note-palette-title">' +
                          ...
                          "</div>",
                        "  <div>",
                        '    <button type="button" className="note-color-reset btn btn-default" data-event="backColor" data-value="inherit">',
                        f.color.transparent,
                        "    </button>",
                        "  </div>",
                        ...
                        '  <div className="note-palette-title">' +
                          ...
                          "</div>",
                        "  <div>",
                        '    <button type="button" className="note-color-reset btn btn-default" data-event="removeFormat" data-value="foreColor">',
                      ...
                      click: function (b) {
                        ...
                        if (d && e) {
                          var f =
                              "backColor" === d ? "background-color" : "color",
                            g = c
                              .closest(".note-color")
        ...
        (this.tableMoveHandler = function (a) {
          ...
          h.css({
            ...
            3 < k.c &&
              k.c < e.insertTableMaxSize.col &&
              i.css({
                width: k.c + 1 + "em",
              }),
            3 < k.r &&
              k.r < e.insertTableMaxSize.row &&
              i.css({
                height: k.r + 1 + "em",
              }),
            f.html(k.c + " x " + k.r);
      ...
      (this.initialize = function () {
        var a = e.dialogsInBody ? $(document.body) : d,
          b =
            ...
            f.link.textToDisplay +
            '</label><input className="note-link-text form-control" type="text" /></div><div className="form-group"><label>' +
            f.link.url +
            '</label><input className="note-link-url form-control" type="text" value="http://" /></div>' +
            (e.disableLinkTarget
              ? ""
              : '<div className="checkbox"><label><input type="checkbox" checked> ' +
                f.link.openInNewWindow +
                "</label></div>"),
          g =
            '<button href="#" className="btn btn-primary note-link-btn disabled" disabled>' +
            f.link.insert +
            "</button>";
        this.$dialog = c
          .dialog({
      ...
      (this.initialize = function () {
        ...
        if (e.maximumImageFileSize) {
          var g = Math.floor(Math.log(e.maximumImageFileSize) / Math.log(1024)),
            h =
              1 * (e.maximumImageFileSize / Math.pow(1024, g)).toFixed(2) +
              " " +
              " KMGTP"[g] +
              "B";
        ...
        var i =
            '<div className="form-group note-group-select-from-files"><label>' +
            f.image.selectFromFiles +
            '</label><input className="note-image-input form-control" type="file" name="files" accept="image/*" multiple="multiple" />' +
            b +
            '</div><div className="form-group note-group-image-url" style="overflow:auto;"><label>' +
            f.image.url +
            '</label><input className="note-image-url form-control col-md-12" type="text" /></div>',
          j =
            '<button href="#" className="btn btn-primary note-image-btn disabled" disabled>' +
            f.image.insert +
            "</button>";
        this.$dialog = c
          .dialog({
    ...
    VideoDialog = function (a) {
      ...
      (this.initialize = function () {
        var a = e.dialogsInBody ? $(document.body) : d,
          b =
            '<div className="form-group row-fluid"><label>' +
            f.video.url +
            ' <small className="text-muted">' +
            f.video.providers +
            '</small></label><input className="note-video-url form-control span12" type="text" /></div>',
          g =
            '<button href="#" className="btn btn-primary note-video-btn disabled" disabled>' +
            f.video.insert +
            "</button>";
        this.$dialog = c
          .dialog({
    ...
    HelpDialog = function (a) {
      ...
      (this.createShortCutList = function () {
        ...
        return Object.keys(b)
          .map(function (c) {
            var d = b[c],
              e = $('<div><div className="help-list-item"/></div>');
            return (
              e
                .append(
                  $("<label><kbd>" + c + "</kdb></label>").css({
                    width: 180,
                    "margin-right": 10,
                  })
                )
    ...
    AirPopover = function (a) {
      ...
      (this.events = {
        ...
        "summernote.focusout": function (a, c) {
          agent.isFF ||
            (c.relatedTarget &&
              dom.ancestor(c.relatedTarget, func.eq(b.$popover[0]))) ||
            b.hide();
        },
      }),
        (this.shouldInitialize = function () {
      ...
      (this.events = {
        ...
        (this.createItemTemplates = function (a, b) {
          ...
          return b.map(function (b, d) {
            var e = $('<div className="note-hint-item"/>');
            return (
              e.append(c.template ? c.template(b) : b + ""),
              e.data({
                index: a,
                item: b,
              }),
        ...
        (this.createGroup = function (a, c) {
          var d = $(
            '<div className="note-hint-group note-hint-group-' + a + '"/>'
          );
          return (
            this.searchKeyword(a, c, function (c) {
              (c = c || []),
