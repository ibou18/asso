...
var jvm = {
  inherits: function (l, t) {
    ...
    (e.prototype = t.prototype),
      (l.prototype = new e()),
      ((l.prototype.constructor = l).parentclassName = t);
  },
  mixin: function (l, t) {
    var e;
...
(jvm.$ = jQuery),
  ...
  (jvm.SVGElement.prototype.addclassName = function (l) {
    ...
    try {
      document.namespaces.rvml ||
        ...
        (jvm.VMLElement.prototype.createElement = function (l) {
          return document.createElement("<rvml:" + l + ' className="rvml">');
        });
    } catch (l) {
      jvm.VMLElement.prototype.createElement = function (l) {
        return document.createElement(
          "<" + l + ' xmlns="urn:schemas-microsoft.com:vml" className="rvml">'
        );
      };
    }
  ...
  (jvm.VMLElement.prototype.addclassName = function (l) {
