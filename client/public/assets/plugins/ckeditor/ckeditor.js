...
(function () {
  (window.CKEDITOR && window.CKEDITOR.dom) ||
        ...
        var a = /(^|.*[\\\/])ckeditor\.js(?:\?.*|;.*)?$/i,
          e = {
            ...
            basePath: (function () {
              ...
              if (!b)
                for (
                  var c = document.getElementsByTagName("script"), e = 0;
                  e < c.length;
                  e++
                ) {
          ...
          on: function (b, d, e, m, f) {
            ...
            if (0 > g.getListenerIndex(d)) {
              ...
              for (var v = g.length - 1; 0 <= v; v--)
                if (g[v].priority <= f)
                  return g.splice(v + 1, 0, h), { removeListener: l };
              g.unshift(h);
            }
    ...
    (CKEDITOR.warn = function (a, e) {
      CKEDITOR.verbosity & CKEDITOR.VERBOSITY_WARN &&
        CKEDITOR.fire("log", { type: "warn", errorCode: a, additionalData: e });
    }),
      ...
      function (a) {
        if (window.console && window.console.log) {
          ...
          if ((a = a.data.additionalData))
            console[e]("[CKEDITOR] Error code: " + b + ".", a);
    ...
    (function () {
      var a = [],
        ...
        h = function (a, g) {
          return "#" == g[0]
            ? String.fromCharCode(parseInt(g.slice(1), 10))
            : f[g];
        };
      ...
      CKEDITOR.tools = {
        arrayCompare: function (a, g) {
          ...
          for (var f = 0; f < a.length; f++) if (a[f] != g[f]) return !1;
          return !0;
        },
        getIndex: function (a, g) {
          for (var f = 0; f < a.length; ++f) if (g(a[f])) return f;
          return -1;
        },
        clone: function (a) {
          var g;
        ...
        extend: function (a) {
          var g = arguments.length,
            f,
            b;
          "boolean" == typeof (f = arguments[g - 1])
            ? g--
            : "boolean" == typeof (f = arguments[g - 2]) &&
              ((b = arguments[g - 1]), (g -= 2));
          for (var h = 1; h < g; h++) {
            var c = arguments[h],
              d;
        ...
        buildStyleHtml: function (a) {
          ...
          for (var g, f = [], b = 0; b < a.length; b++)
            if ((g = a[b]))
              /@import|[{}]/.test(g)
                ? f.push("\x3cstyle\x3e" + g + "\x3c/style\x3e")
                : f.push(
        ...
        indexOf: function (a, g) {
          if ("function" == typeof g)
            ...
            f = 0;
            for (b = a.length; f < b; f++) if (a[f] === g) return f;
          }
          return -1;
        },
        search: function (a, g) {
            ...
            var c = g,
              g = function () {
                ...
                for (g in b) {
                  var f = b[g];
                  a[g] =
                    "function" == typeof f ? CKEDITOR.tools.bind(f, this) : f;
                }
                c.apply(this, arguments);
              };
          f &&
            ((g.prototype = this.prototypedCopy(f.prototype)),
            (g.prototype.constructor = g),
            (g.base = f),
            (g.baseProto = f.prototype),
        ...
        parseCssText: function (a, g, f) {
          ...
          a.replace(/&quot;/g, '"').replace(
            ...
            function (a, f, h) {
              g &&
                ((f = f.toLowerCase()),
                "font-family" == f && (h = h.replace(/\s*,\s*/g, ",")),
        ...
        objectCompare: function (a, g, f) {
          ...
          if (!f) for (b in g) if (a[b] != g[b]) return !1;
          return !0;
        },
        ...
        checkIfAnyObjectPropertyMatches: function (a, g) {
          for (var f in a) if (f.match(g)) return !0;
          return !1;
        },
        ...
        getCookie: function (a) {
          a = a.toLowerCase();
          for (
            var g = document.cookie.split(";"), f, b, h = 0;
            h < g.length;
            h++
          )
            if (
              ((f = g[h].split("\x3d")),
              (b = decodeURIComponent(CKEDITOR.tools.trim(f[0]).toLowerCase())),
              b === a)
            )
              return decodeURIComponent(1 < f.length ? f[1] : "");
          return null;
        },
          ...
          if (!a || 40 != a.length) {
            ...
            for (f = 0; f < a.length; f++)
              var b = "abcdefghijklmnopqrstuvwxyz0123456789".charAt(a[f] % 36),
                g = g + (0.5 < Math.random() ? b.toUpperCase() : b);
            a = g;
    ...
    (CKEDITOR.dtd = (function () {
      var a = CKEDITOR.tools.extend,
        e = function (a, g) {
          for (
            var f = CKEDITOR.tools.clone(a), b = 1;
            b < arguments.length;
            b++
          ) {
            g = arguments[b];
        ...
        k = { command: 1, link: 1, meta: 1, noscript: 1, script: 1, style: 1 },
        m = {},
        f = { "#": 1 },
      ...
      e = {
        ...
        h5: b,
        h6: b,
        head: a({ title: 1, base: 1 }, k),
        header: c,
        hgroup: { h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1 },
        hr: m,
        html: a({ head: 1, body: 1 }, c, k),
        i: b,
        iframe: f,
        img: m,
        input: m,
        ...
        on: function (e) {
          ...
          b[e] ||
            ...
            this.$.addEventListener
              ...
              : this.$.attachEvent && this.$.attachEvent("on" + e, b));
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.node.prototype, {
      ...
      getAddress: function (a) {
        for (
          var e = [], b = this.getDocument().$.documentElement, c = this.$;
          c && c != b;
      ...
      getIndex: function (a) {
        function e(a, f) {
          ...
          return h && h.nodeType == CKEDITOR.NODE_TEXT
            ? b(h)
              ? e(h, f)
              : h
            : null;
        ...
        if (
          !this.$.parentNode ||
          (a && c.nodeType == CKEDITOR.NODE_TEXT && b(c) && !e(c) && !e(c, !0))
        )
          return -1;
        do
          (a &&
            ...
            (k || b(c))) ||
            (d++, (k = c.nodeType == CKEDITOR.NODE_TEXT));
      ...
      getParent: function (a) {
        ...
        return e &&
          (e.nodeType == CKEDITOR.NODE_ELEMENT ||
      ...
      getPosition: function (a) {
        ...
        if (
          ...
          if ("sourceIndex" in e)
            return 0 > e.sourceIndex || 0 > b.sourceIndex
      ...
      getAscendant: function (a, e) {
        ...
        for (; b; ) {
          if (c(d ? new CKEDITOR.dom.node(b) : b))
      ...
      ltrim: function () {
        for (var a; this.getFirst && (a = this.getFirst()); ) {
          if (a.type == CKEDITOR.NODE_TEXT) {
            ...
            if (e)
              e.length < b &&
                (a.split(b - e.length), this.$.removeChild(this.$.firstChild));
            else {
              a.remove();
              continue;
            }
      ...
      isReadOnly: function (a) {
        ...
        if (!a && e && "undefined" != typeof e.$.isContentEditable)
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.window.prototype, {
      ...
      getViewPaneSize: function () {
        ...
        return {
          ...
          height:
            (e ? a.documentElement.clientHeight : a.body.clientHeight) || 0,
        };
      },
    ...
    (function () {
      ...
      var d = document.createElement("_").classList,
        d =
          "undefined" !== typeof d &&
          null !== String(d.add).match(/\[Native code\]/gi),
        k = /[\n\t\r]/g;
      CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
        ...
        getDocumentPosition: function (a) {
          ...
          if (
            ...
            var k = this.$.getBoundingClientRect(),
              ...
              y = !0;
            CKEDITOR.env.ie &&
              ((y = g.getDocumentElement().contains(this)),
              (g = g.getBody().contains(this)),
              (y = (e && g) || (!e && y)));
            y &&
              (CKEDITOR.env.webkit ||
              (CKEDITOR.env.ie && 12 <= CKEDITOR.env.version)
                ? ((b = d.$.scrollLeft || m.scrollLeft),
                  (c = d.$.scrollTop || m.scrollTop))
                : ((c = e ? d.$ : m), (b = c.scrollLeft), (c = c.scrollTop)),
              (b = k.left + b - p),
              (c = k.top + c - t));
          } else
            for (
        ...
        scrollIntoParent: function (a, b, c) {
          ...
          a instanceof CKEDITOR.dom.window &&
            (a = y ? e.getBody() : e.getDocumentElement());
          e = a.getWindow();
          d = t(this, e);
          var A = t(a, e),
            z = this.$.offsetHeight;
          ...
          for (b in a)
            if (
              ...
              c.element.equals(this) &&
                c.elementMode != CKEDITOR.ELEMENT_MODE_APPENDTO)
            )
              return c;
          return null;
        },
    ...
    (function () {
        ...
        if (!a && !this._.guardLTR) {
          ...
          this._.guardLTR = function (a, b) {
            return (
              (!b || !m.equals(a)) &&
              (!B || !a.equals(B)) &&
              (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(g.root))
            );
          };
        }
              ...
              ? c.type == CKEDITOR.NODE_ELEMENT &&
                (c =
                  0 < l
                    ...
                    : !1 === h(c, !0)
                    ? null
                    : c.getPreviousSourceNode(!0, n, h))
              : ((c = d),
                c.type == CKEDITOR.NODE_ELEMENT &&
                  ((c = c.getChild(f)) ||
                    (c =
                      !1 === h(d, !0) ? null : d.getNextSourceNode(!0, n, h)))),
            c && !1 === h(c) && (c = null));
        for (; c && !this._.end; ) {
          this.current = c;
      ...
      CKEDITOR.dom.walker.bookmark = function (a, b) {
        ...
        return function (c) {
          var d, f;
          d =
            c && c.type != CKEDITOR.NODE_ELEMENT && (f = c.getParent()) && g(f);
          d = a ? d : d || g(c);
          return !!(b ^ d);
        };
      };
        ...
        return function (g) {
          ...
          c &&
            ...
            (c =
              c.isBlockBoundary() &&
              (!g ||
                (g.type == CKEDITOR.NODE_ELEMENT && g.isBlockBoundary()))));
          return !!(a ^ c);
        };
      };
            ...
            : b.type == CKEDITOR.NODE_TEXT ||
              (b.type == CKEDITOR.NODE_ELEMENT &&
                (b.is(CKEDITOR.dtd.$inline) ||
                  ...
                  (!CKEDITOR.env.needsBrFiller && b.is(n) && g(b))))
            ? !0
            : !1;
          return !!(a ^ b);
        };
    ...
    (function () {
      ...
      function e(a, b, c, d, f) {
        ...
        function e() {
          ...
          b < P - 1 || b < T - 1 || c
            ? (c
                ...
                : T == b + 1 && F
                ? a.moveToPosition(H[b], CKEDITOR.POSITION_BEFORE_END)
                : a.moveToPosition(H[b + 1], CKEDITOR.POSITION_BEFORE_START),
              d &&
                (b = N[b + 1]) &&
                b.type == CKEDITOR.NODE_ELEMENT &&
        ...
        var w = a.startContainer,
          ...
          G,
          L;
        if (r && C.type == CKEDITOR.NODE_TEXT && w.equals(C))
          (w = a.document.createText(w.substring(x, B))), c.append(w);
        else {
          C.type == CKEDITOR.NODE_TEXT
            ...
            : 0 < C.getChildCount()
            ? B >= C.getChildCount()
              ? ((C = C.getChild(B - 1)), (F = !0))
              : (C = C.getChild(B))
            : (I = F = !0);
          w.type == CKEDITOR.NODE_TEXT
            ? r
              ? (G = !0)
              : w.split(x)
            : 0 < w.getChildCount()
          ...
          for (
            ...
            W = ca.getNext();
            for (
              K != P || (ca.equals(H[K]) && P < T)
                ? b && (J = O.append(ca.clone(0, f)))
                : D
                ? l(ca, O, !1, E)
                : G && O.append(a.document.createText(ca.substring(x)));
              W;
          ...
          O = c;
          for (K = R; K <= T; K++)
            if (((c = H[K]), (W = c.getPrevious()), c.equals(N[K])))
              b && (O = O.getChild(0));
            else {
              K != T || (c.equals(N[K]) && T < P)
                ? b && (J = O.append(c.clone(0, f)))
                : F
                ? l(c, O, !1, I)
                : L && O.append(a.document.createText(c.substring(0, B)));
              if (K > U) for (; W; ) W = l(W, O, !0);
              O = J;
            }
          r || e();
        }
        ...
        return function (f) {
          return c(f) || b(f)
            ...
            : (f.type == CKEDITOR.NODE_TEXT &&
              ...
              (f.type == CKEDITOR.NODE_ELEMENT && !f.is(k))
            ? !1
            : !0;
        };
      }
      ...
      CKEDITOR.dom.range.prototype = {
        ...
        createBookmark2: (function () {
          function a(b) {
            ...
            f =
              ...
              l == f.getChildCount()
                ? 0
                : f.getChild(l - 1).type == CKEDITOR.NODE_TEXT &&
                  f.getChild(l).type == CKEDITOR.NODE_TEXT;
            ...
            if (g.type == CKEDITOR.NODE_TEXT) {
              ...
              g.getText()
                ...
                : ((l = g.getPrevious(c)),
                  f
                    ? ((d = f),
                      (g = l ? l.getNext() : g.getParent().getFirst()))
                    : ((g = g.getParent()), (d = l ? l.getIndex(!0) + 1 : 0)));
            }
            b.container = g;
            b.offset = d;
          }
          ...
          return function (c) {
            var d = this.collapsed,
              ...
              l = { container: this.endContainer, offset: this.endOffset };
        ...
        trim: function (a, b) {
          ...
          if ((!a || f) && c && c.type == CKEDITOR.NODE_TEXT) {
            if (d)
              if (d >= c.getLength())
                (d = c.getIndex() + 1), (c = c.getParent());
              else {
                var l = c.split(d),
                  d = c.getIndex() + 1,
                  c = c.getParent();
                this.startContainer.equals(this.endContainer)
                  ? this.setEnd(l, this.endOffset - this.startOffset)
        ...
        enlarge: function (a, b) {
          ...
          switch (a) {
            ...
            case CKEDITOR.ENLARGE_ELEMENT:
              ...
              B.type == CKEDITOR.NODE_TEXT
                ? (F &&
                    ((B = !CKEDITOR.tools.trim(B.substring(0, F)).length && B),
                    (x = !!B)),
                  B && ((w = B.getPrevious()) || (r = B.getParent())))
                : (F && (w = B.getChild(F - 1) || B.getLast()), w || (r = B));
              for (r = c(r); r || w; ) {
                if (r && !w) {
                  !C && r.equals(h) && (C = !0);
                  if (f ? r.isBlockBoundary() : !e.contains(r)) break;
                  (x && "inline" == r.getComputedStyle("display")) ||
                    ((x = !1), C ? (k = r) : this.setStartBefore(r));
                  w = r.getPrevious();
                }
                for (; w; )
                  if (((B = !1), w.type == CKEDITOR.NODE_COMMENT))
                    w = w.getPrevious();
                  else {
                    if (w.type == CKEDITOR.NODE_TEXT)
                      ...
                      (w.$.offsetWidth > (CKEDITOR.env.webkit ? 1 : 0) ||
                        (b && w.is("br"))) &&
                      !w.data("cke-bookmark")
                    )
                      if (x && CKEDITOR.dtd.$removeEmpty[w.getName()]) {
                        ...
                        if (d.test(D)) w = null;
                          ...
                          for (
                            var F = w.$.getElementsByTagName("*"), E = 0, I;
                            (I = F[E++]);
              ...
              C = x = !1;
              B.type == CKEDITOR.NODE_TEXT
                ? CKEDITOR.tools.trim(B.substring(F)).length
                  ? (x = !0)
                  : ((x = !B.getLength()),
                    F == B.getLength()
                      ? (w = B.getNext()) || (r = B.getParent())
                      : l(B, F) && (r = B.getParent()))
                : (w = B.getChild(F)) || (r = B);
              for (; r || w; ) {
                if (r && !w) {
                  ...
                  if (f ? r.isBlockBoundary() : !e.contains(r)) break;
                  (x && "inline" == r.getComputedStyle("display")) ||
                    ((x = !1), C ? (m = r) : r && this.setEndAfter(r));
                  w = r.getNext();
                }
                for (; w; ) {
                  B = !1;
            ...
            case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
              ...
              var G,
                L,
                N = CKEDITOR.dom.walker.blockBoundary(
              ...
              this.setStartAt(
                G,
                !G.is("br") &&
                  ((!r && this.checkStartOfBlock()) || (r && G.contains(r)))
              ...
              this.setEndAt(
                G,
                (!r && this.checkEndOfBlock()) || (r && G.contains(r))
        ...
        shrink: function (a, b, c) {
          if (!this.collapsed) {
            ...
            k &&
              (f =
                d[a == CKEDITOR.SHRINK_ELEMENT ? "lastForward" : "next"]()) &&
              this.setStartAt(
                f,
                b
                  ? CKEDITOR.POSITION_AFTER_START
        ...
        splitBlock: function (a, b) {
          ...
          "br" != a &&
            (f ||
              ((f = this.fixBlock(!0, a)),
              (l = new CKEDITOR.dom.elementPath(this.endContainer, this.root)
                .block)),
            l || (l = this.fixBlock(!1, a)));
          ...
          f &&
            f.equals(l) &&
            (d
              ? ((h = new CKEDITOR.dom.elementPath(
                  this.startContainer,
                  this.root
                )),
                this.moveToPosition(l, CKEDITOR.POSITION_AFTER_END),
                (l = null))
              : c
              ? ((h = new CKEDITOR.dom.elementPath(
                  this.startContainer,
      ...
      a.prototype = {
        getNextParagraph: function (a) {
          ...
          if (this._.nestedEditable) {
            if ((g = this._.nestedEditable.iterator.getNextParagraph(a)))
              return (
                (this.activeFilter =
          ...
          if (!this._.started) {
            ...
            t.enlarge(
              (this.forceBrBreak && !e) || !this.enlargeBr
                ? CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS
                : CKEDITOR.ENLARGE_BLOCK_CONTENTS
            );
            t.collapsed ||
              ((e = new CKEDITOR.dom.walker(t.clone())),
              (p = CKEDITOR.dom.walker.bookmark(!0, !0)),
              (e.evaluator = p),
              (this._.nextNode = e.next()),
              (e = new CKEDITOR.dom.walker(t.clone())),
              (e.evaluator = p),
              (e = e.previous()),
              (this._.lastNode = e.getNextSourceNode(!0, null, t.root)),
              this._.lastNode &&
          ...
          for (this._.nextNode = null; p; ) {
            var y = 0,
              ...
              r = 0;
            if (z)
              p.type == CKEDITOR.NODE_TEXT && d.test(p.getText()) && (z = 0);
            else {
              var w = p.getName();
              if (
                CKEDITOR.dtd.$block[w] &&
                ...
                p.isBlockBoundary(this.forceBrBreak && !A && { br: 1 })
              ) {
                if ("br" == w) z = 1;
                ...
                e &&
                  (e.setEndAt(p, CKEDITOR.POSITION_BEFORE_START),
                  "br" != w && (this._.nextNode = p));
                y = 1;
              } else {
                if (p.getFirst()) {
                  e ||
                    ((e = this.range.clone()),
                    e.setStartAt(p, CKEDITOR.POSITION_BEFORE_START));
                  p = p.getFirst();
                  continue;
                }
                z = 1;
            ...
            if (e && !y)
              for (; !p.getNext(f) && !m; ) {
                w = p.getParent();
                if (w.isBlockBoundary(this.forceBrBreak && !A && { br: 1 })) {
                  y = 1;
                  z = 0;
                  m || w.equals(t);
          ...
          if (!g) {
            ...
            !p.equals(e.root)
              ? (g = p)
              : !g || (this.enforceRealBlocks && g.is(h))
              ? ((g = this.range.document.createElement(a)),
              ...
              ? (e.checkStartOfBlock() && e.checkEndOfBlock()) ||
                ...
                e.insertNode(g))
              : m ||
                (this._.nextNode = g.equals(t)
                  ? null
                  : this._getNextSourceNode(
                      e.getBoundaryNodes().endNode,
                      1,
                      t
                    ));
          }
          u &&
            ...
            ("br" == u.getName()
              ? u.remove()
              : u.getLast() &&
                "br" == u.getLast().$.nodeName.toLowerCase() &&
                u.getLast().remove());
          q &&
            (u = g.getLast()) &&
            u.type == CKEDITOR.NODE_ELEMENT &&
            "br" == u.getName() &&
            (!CKEDITOR.env.needsBrFiller || u.getPrevious(k) || u.getNext(k)) &&
            u.remove();
          this._.nextNode ||
            (this._.nextNode =
              m || g.equals(t) || !t ? null : this._getNextSourceNode(g, 1, t));
          return g;
        },
        _getNextSourceNode: function (a, b, c) {
          ...
          for (a = a.getNextSourceNode(b, null, d); !k(a); )
    ...
    (function () {
      function a(a, b, c, d, f) {
        ...
        for (g in b) {
          ...
          for (k in L) {
            ...
            for (n in z)
              "!" == n.charAt(0) &&
                ((n = n.slice(1)), p.push(n), (t[n] = !0), (C = !1));
            ...
            if (
              ...
              if (a)
                if (!0 === a) a = !0;
                  ...
                  for (var e = 0, l = c.length, h; e < l; ++e)
                    (h = c[e]), g[h] || (g[h] = a(h));
                  a = !1;
                }
              else a = !1;
      ...
      function c(a, b, c) {
        if (!a.match || a.match(b)) {
          ...
          c.hadInvalidAttribute =
            d(a.attributes, b.attributes) || c.hadInvalidAttribute;
          ...
          c.hadInvalidclassName = a || c.hadInvalidClass;
        }
      }
      function d(a, b) {
        if (!a) return !1;
      ...
      function f(a, b) {
        ...
        if ((f = a.requiredClasses))
          for (g = b.classes, c = 0; c < f.length; ++c)
            ...
            } else if (!CKEDITOR.tools.checkIfAnyArrayItemMatches(g, d))
              return !1;
        return (
          h(b.styles, a.requiredStyles) && h(b.attributes, a.requiredAttributes)
        );
      }
      function h(a, b) {
        if (!b) return !0;
      ...
      function g(a) {
        var b,
          ...
          g = {},
          e = 1;
        for (a = I(a); (b = a.match(H)); )
          (c = b[2])
            ? ((d = n(c, "styles")), (f = n(c, "attrs")), (c = n(c, "classes")))
            : (d = f = c = null),
            (g["$" + e++] = {
              elements: b[1],
              classes: c,
      ...
      function u(a, b, d, f) {
        ...
        if (f.doFilter) {
          a: {
            h = b.name;
            k = a._;
            a = k.allowedRules.elements[h];
            l = k.allowedRules.generic;
            h = k.disallowedRules.elements[h];
            ...
            if (a || l) {
              ...
              if (k) for (z = 0, C = k.length; z < C; ++z) c(k[z], b, m);
              if (a) for (z = 0, C = a.length; z < C; ++z) e(a[z], b, m, r);
              if (l) for (z = 0, C = l.length; z < C; ++z) e(l[z], b, m, r);
              a = m;
            } else a = null;
          }
      ...
      function z(a) {
        return (
          a.type == CKEDITOR.NODE_ELEMENT &&
          ("br" == a.name || F.$block[a.name])
        );
      }
      function r(a, b, c) {
        var d = a.name;
        if (F.$empty[d] || !a.children.length)
          "hr" == d && "br" == b
            ? a.replaceWith(A())
            : (a.parent && c.push({ check: "it", el: a.parent }), a.remove());
        else if (F.$block[d] || "tr" == d)
          if ("br" == b)
            a.previous && !z(a.previous) && ((b = A()), b.insertBefore(a)),
              a.next && !z(a.next) && ((b = A()), b.insertAfter(a)),
            ...
            b: {
              ...
              for (var g = 0, l = d.length, e; g < l; ++g)
                if (
                  ((e = d[g]), e.type == CKEDITOR.NODE_ELEMENT && !f[e.name])
                ) {
                  f = !1;
                  break b;
                }
              ...
              for (
                ...
                (e = d[--l]),
                  ...
                  (e.type == CKEDITOR.NODE_TEXT ||
                    (e.type == CKEDITOR.NODE_ELEMENT && F.$inline[e.name]))
                    ? (h ||
      ...
      function w(a, b, c) {
        ...
        for (d = 0; d < c.length; ++d)
          if (
            ((f = c[d]),
            !((f.check && !a.check(f.check, !1)) || (f.left && !f.left(b))))
          ) {
            f.right(b, O);
            break;
          }
      ...
      function C(a, b) {
        ...
        for (g in d)
          if ("class" == g)
            for (
              c = d[g].split(/\s+/), l = a.classes.join("|");
              (h = c.pop());
        ...
        for (e in f) if (a.styles[e] != f[e]) return !1;
        return !0;
      }
      function x(a, b) {
        var c, d;
        ...
        if (a instanceof CKEDITOR.editor) {
          ...
          !0 === b
            ...
            : (b || (this.customConfig = !1),
              ...
              this.allow(
                G[a.enterMode] + " " + G[a.shiftEnterMode],
                "default",
                1
              ),
      ...
      CKEDITOR.filter.prototype = {
        ...
        applyTo: function (a, b, c, d) {
          ...
          var f = this,
            ...
            l,
            h = !1,
            k = { doFilter: !c, doTransform: !0, doCallbacks: !0, toHtml: b };
          a.forEach(
            function (a) {
              if (a.type == CKEDITOR.NODE_ELEMENT) {
                ...
                a: {
                  ...
                  1 == d.children.length &&
                    (r = d.children[0]).type == CKEDITOR.NODE_ELEMENT &&
                    u(f, r, c, k);
                  c = !c.length;
                }
                c || g.push(a);
          ...
          for (var w; (c = g.pop()); )
            c.type == CKEDITOR.NODE_ELEMENT ? r(c, d, a) : c.remove();
          for (; (m = a.pop()); )
            if (((c = m.el), c.parent))
              switch (((w = F[c.parent.name] || F.span), m.check)) {
                case "it":
                  F.$removeEmpty[c.name] && !c.children.length
                    ? r(c, d, a)
                    : p(c) || r(c, d, a);
                  break;
                case "el-up":
            ...
            for (f = 0; f < a.length; ++f) {
              ...
              for (e = 0; e < b.length; ++e)
                (l = b[e]),
                  ...
                  k instanceof CKEDITOR.style && (k = B(k)),
                  c.push({
                    check: h == g ? null : h,
                    left: k,
        ...
        check: function (a, b, c) {
          ...
          if ("string" == typeof a) {
            ...
            (d = a.getDefinition()),
              (f = d.styles),
              (h = d.attributes || {}),
              f && !CKEDITOR.tools.isEmpty(f)
                ? ((f = E(f)), (h.style = CKEDITOR.tools.writeCssText(f, !0)))
                : (f = {}),
              (f = {
                name: d.element,
                attributes: h,
          ...
          b =
            0 < k.length
              ? !1
              : CKEDITOR.tools.objectCompare(f.attributes, h.attributes, !0)
              ? !0
              : !1;
        ...
        transform: function (a, b) {
          if ("string" == typeof b) a.name = b;
            ...
            for (g in f)
              if ("class" == g)
                for (
                  c = a.classes.join("|"), l = f[g].split(/\s+/);
                  (h = l.pop());
    ...
    (function () {
      var a,
        e = function (b) {
          ...
          a ||
            (e && (a = !1 !== m.execCommand(e, { from: "keystrokeHandler" })),
                      ...
                      (CKEDITOR.env.ie && 8 >= CKEDITOR.env.version
                        ? (f.$.onreadystatechange = function () {
                            if (
                              ...
                              (f.$.onreadystatechange = null), v(b, !0);
                          })
                        : ((f.$.onload = function () {
                            setTimeout(function () {
                              v(b, !0);
    ...
    (CKEDITOR.resourceManager.prototype = {
      ...
      getFilePath: function (a) {
        ...
        return CKEDITOR.getUrl(
          this.getPath(a) + (e ? e.file : this.fileName + ".js")
        );
      },
              ...
              a.call(
                ...
                function (a) {
                  ...
                  for (f in a) {
                    ...
                    if (!e[f]) {
                      if (n.icons)
                        for (var u = n.icons.split(","), q = u.length; q--; )
                          CKEDITOR.skin.addIcon(
                            u[q],
                            n.path +
                              "icons/" +
                              (CKEDITOR.env.hidpi && n.hidpi ? "hidpi/" : "") +
                              u[q] +
                              ".png"
                          );
                      e[f] = 1;
    ...
    (function () {
      ...
      function m(a) {
        ...
        c.fn
          ? (c.fn.call(a, a.config),
            (CKEDITOR.getUrl(a.config.customConfig) != b && m(a)) ||
          ...
          for (var l in c) {
            ...
            k &&
              ...
              0 <= CKEDITOR.tools.indexOf(k, a.langCode)
                ? (r = a.langCode)
                : ((r = a.langCode.replace(/-.*/, "")),
                  (r =
                    r != a.langCode && 0 <= CKEDITOR.tools.indexOf(k, r)
                      ? r
                      : 0 <= CKEDITOR.tools.indexOf(k, "en")
                      ? "en"
                      : k[0])),
              h.langEntries && h.langEntries[r]
                ? ((a.lang[l] = h.langEntries[r]), (r = null))
                : g.push(CKEDITOR.getUrl(h.path + "lang/" + r + ".js")));
            f.push(r);
            d.push(h);
          }
          CKEDITOR.scriptLoader.load(g, function () {
            for (
              var c = ["beforeInit", "init", "afterInit"], g = 0;
              g < c.length;
              g++
            )
              for (var e = 0; e < d.length; e++) {
                ...
                0 === g &&
                  ...
                  l.lang &&
                  l.langEntries &&
                  (a.lang[l.name] = l.langEntries[f[e]]);
                if (l[c[g]]) l[c[g]](a);
              }
      ...
      CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
        ...
        setData: function (a, b, c) {
          ...
          b &&
            "object" == typeof b &&
            ((c = b.internal), (f = b.callback), (d = !b.noSnapshot));
        ...
        getSelectedHtml: function (a) {
          ...
          for (
            var d = new CKEDITOR.dom.documentFragment(), f, g, e, l = 0;
            l < c.length;
            l++
          ) {
            var h = c[l],
              k = h.startContainer;
            k.getName && "tr" == k.getName()
              ? (f ||
                  ((f = k.getAscendant("table").clone()),
                  f.append(k.getAscendant("tbody").clone()),
                  d.append(f),
                  (f = f.findOne("tbody"))),
                (g && g.equals(k)) || ((g = k), (e = k.clone()), f.append(e)),
                e.append(h.cloneContents()))
              : d.append(h.cloneContents());
          }
          ...
          for (var c, d, k = 0, m; (c = this._.htmlPartsRegex.exec(b)); ) {
            ...
            if ((d = c[1]))
              if (
                ((d = d.toLowerCase()),
                m &&
                  CKEDITOR.dtd.$cdata[d] &&
                  (this.onCDATA(m.join("")), (m = null)),
                !m)
              ) {
                this.onTagClose(d);
                continue;
    ...
    (function () {
      ...
      CKEDITOR.htmlParser.fragment.fromHtml = function (k, m, f) {
        function h(a) {
          ...
          if (0 < p.length)
            for (var c = 0; c < p.length; c++) {
              ...
              (e && !e[f]) || (a && g && !g[a] && CKEDITOR.dtd[a])
                ? f == A.name && (n(A, A.parent, 1), c--)
                : (b || (l(), (b = 1)),
                  (d = d.clone()),
                  (d.parent = A),
                  (A = d),
        ...
        function n(b, c, d) {
          ...
          var e = A;
          void 0 === b.previous &&
            (v(c, b) && ((A = c), q.onTagOpen(f, {}), (b.returnPoint = c = A)),
            g(b),
            (a(b) && !b.children.length) || c.add(b),
            "pre" == b.name && (r = !1),
            "textarea" == b.name && (z = !1));
          b.returnPoint
            ? ((A = b.returnPoint), delete b.returnPoint)
            : (A = d ? c : e);
        }
        function v(a, b) {
          if (
        ...
        var q = new CKEDITOR.htmlParser(),
          t =
            m instanceof CKEDITOR.htmlParser.element
              ? m
              : "string" == typeof m
              ? new CKEDITOR.htmlParser.element(m)
          ...
          if (a(f)) p.push(f);
            ...
            if ("br" == d) y.push(f);
              ...
              for (
                ...
                !((k = (g = A.name)
                  ? CKEDITOR.dtd[g] ||
                    (A._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span)
                  : c),
                f.isUnknown || A.isUnknown || k[d]);
                ...
                if (A.isOptionalClose) q.onTagClose(g);
                  ...
                  (g = A.children),
                    ((g = g[g.length - 1]) && "li" == g.name) ||
                      n((g = new CKEDITOR.htmlParser.element("li")), A),
                    !f.returnPoint && (f.returnPoint = A),
                    (A = g);
                else if (d in CKEDITOR.dtd.$listItem && !u(d, g))
                  q.onTagOpen("li" == d ? "ul" : "dl", {}, 0, 1);
                else if (g in e && !u(d, g))
                  !f.returnPoint && (f.returnPoint = A), (A = A.parent);
                else if ((g in CKEDITOR.dtd.$inline && p.unshift(A), A.parent))
                  n(A, A.parent, 1);
                else {
                  f.isOrphan = 1;
                  break;
        ...
        q.onText = function (a) {
          if (
            !((A._.hasInlineStarted && !y.length) || r || z) &&
      ...
      CKEDITOR.htmlParser.filter = CKEDITOR.tools.createClass({
        ...
        proto: {
          addRules: function (a, c) {
            ...
            "number" == typeof c
              ? (d = c)
              : c && "priority" in c && (d = c.priority);
            "number" != typeof d && (d = 10);
            "object" != typeof c && (c = {});
            a.elementNames &&
              this.elementNameRules.addMany(a.elementNames, d, c);
            a.attributeNames &&
          ...
          for (var d = 0, e = this.rules, m = e.length, f; c && d < m; d++)
            (f = e[d]),
              (a.nonEditable && !f.options.applyToAll) ||
                ...
                (c = c.replace(f.value[0], f.value[1]));
          return c;
        },
      };
    })(),
    (function () {
          ...
          return function (f) {
            if (f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
              var e = [],
                ...
                m;
              if (h)
                for (l(h, 1) && e.push(h); h; )
                  k(h) &&
                    (r = c(h)) &&
                    l(r) &&
                    ((m = c(r)) && !k(m)
                      ? e.push(r)
                      : (g(z).insertAfter(r), r.remove())),
                    (h = h.previous);
              for (h = 0; h < e.length; h++) e[h].remove();
              if ((e = !a || !1 !== ("function" == typeof d ? d(f) : d)))
                z ||
                CKEDITOR.env.needsBrFiller ||
                f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT
                  ? z ||
        ...
        function l(a, b) {
          ...
          return a.type == CKEDITOR.NODE_TEXT &&
            ...
            (c.index &&
              ...
              (a.value = c[0])),
            (!CKEDITOR.env.needsBrFiller && z && (!b || a.parent.name in w)) ||
              (!z && (((c = a.previous) && "br" == c.name) || !c || k(c))))
            ? !0
            : !1;
        }
        var h = { elements: {} },
      ...
      function k(a) {
        return (
          a &&
          ((a.type == CKEDITOR.NODE_ELEMENT && a.name in r) ||
      ...
      function l(a) {
        return a.replace(D, function (a, b, c) {
          return (
            "\x3c" +
            b +
            c.replace(F, function (a, b) {
              return E.test(b) && -1 == c.indexOf("data-cke-saved-" + b)
      ...
      function g(a, b) {
        return a.replace(b, function (a, b, c) {
          0 === a.indexOf("\x3ctextarea") &&
            (a =
              b +
              u(c).replace(/</g, "\x26lt;").replace(/>/g, "\x26gt;") +
              "\x3c/textarea\x3e");
          return (
            "\x3ccke:encoded\x3e" +
            encodeURIComponent(a) +
        ...
        b.on(
          ...
          function (a) {
            ...
            CKEDITOR.env.ie &&
              9 > CKEDITOR.env.version &&
              "pre" == d &&
              ((d = "div"), (c = "\x3cpre\x3e" + c + "\x3c/pre\x3e"), (f = 1));
            ...
            c = u(c);
            d =
              !1 === a.fixForBody ? !1 : e(a.enterMode, b.config.autoParagraph);
            c = CKEDITOR.htmlParser.fragment.fromHtml(c, a.context, d);
            d &&
              ((f = c),
              !f.children.length &&
                CKEDITOR.dtd[f.name][d] &&
                ((d = new CKEDITOR.htmlParser.element(d)), f.add(d)));
            a.dataValue = c;
          },
          null,
          null,
        ...
        b.on(
          ...
          function (a) {
            ...
            a.data.dataValue = CKEDITOR.htmlParser.fragment.fromHtml(
              c,
              a.data.context,
              e(a.data.enterMode, b.config.autoParagraph)
            );
          },
          null,
          null,
          ...
          elements: {
            ...
            table: function (a) {
              a.children.slice(0).sort(function (a, b) {
                ...
                a.type == CKEDITOR.NODE_ELEMENT &&
                  b.type == a.type &&
                  ((c = CKEDITOR.tools.indexOf(z, a.name)),
                  (d = CKEDITOR.tools.indexOf(z, b.name)));
                (-1 < c && -1 < d && c != d) ||
    ...
    (CKEDITOR.htmlParser.cssStyle = function (a) {
      ...
      (
        ...
        .replace(/&quot;/g, '"')
        .replace(/\s*([^ :;]+)\s*:\s*([^;]+)\s*(?=;|$)/g, function (a, c, d) {
    ...
    (function () {
      ...
      CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(
        new CKEDITOR.htmlParser.node(),
        {
          ...
          setHtml: function (a) {
            a = this.children =
              CKEDITOR.htmlParser.fragment.fromHtml(a).children;
    ...
    (function () {
      ...
      CKEDITOR.template = function (k) {
        if (a[k]) this.output = a[k];
          ...
          this.output = a[k] = Function(
            "data",
            "buffer",
            "return buffer?buffer.push('" + m + "'):['" + m + "'].join('');"
          );
        }
      };
    })(),
    ...
    (function () {
      ...
      CKEDITOR.inlineAll = function () {
        ...
        for (b in CKEDITOR.dtd.$editable)
          for (
            var c = CKEDITOR.document.getElementsByTag(b), d = 0, k = c.count();
            d < k;
            d++
          )
            (a = c.getItem(d)),
    ...
    (CKEDITOR.replaceclassName = "ckeditor"),
    (function () {
      function a(a, d, k, m) {
        if (!CKEDITOR.env.isCompatible) return null;
        a = CKEDITOR.dom.element.get(a);
      ...
      function b(a) {
        ...
        m &&
          a.ui
            .space("contents")
            .setStyle("height", CKEDITOR.tools.cssLength(m));
      ...
      CKEDITOR.editor.prototype.setMode = function (a, b) {
        ...
        if (a != e.mode && m && m[a]) {
          ...
          if (e.mode) {
            ...
            "source" == e.mode &&
              m == h &&
              (e.fire("lockSnapshot", { forceUpdate: !0 }), (l = 1));
    ...
    (function () {
      function a(a) {
        ...
        m(b, d.block, f) &&
          l.collapsed &&
          !l.getCommonAncestor().isReadOnly() &&
          ((d = l.clone()),
        ...
        if (f.startPath().contains(g)) {
          ...
          if (d)
            return (
              (e = f.clone()),
              e.collapse(),
              e.setEndAt(d, CKEDITOR.POSITION_AFTER_END),
              (a = new CKEDITOR.dom.walker(e)),
              (a.guard = b(!0)),
              (d = !1),
              a.checkForward(),
        ...
        proto: {
          ...
          insertElementIntoRange: function (a, b) {
            ...
            if (g)
              for (
                ;
                (e = b.getCommonAncestor(0, 1)) &&
                (l = CKEDITOR.dtd[e.getName()]) &&
                (!l || !l[f]);

              )
                e.getName() in CKEDITOR.dtd.span
                  ? b.splitElement(e)
                  : b.checkStartOfBlock() && b.checkEndOfBlock()
                  ? (b.setStartBefore(e), b.collapse(!0), e.remove())
                  : b.splitBlock(
            ...
            if (!this.is("textarea")) {
              ...
              this.attachListener(a, "key", function (b) {
                ...
                if (c in m) {
                  ...
                  (f = k(b))
                    ...
                    : e.collapsed &&
                      ((h = l.block) &&
                      (n = h[c ? "getPrevious" : "getNext"](g)) &&
                      n.type == CKEDITOR.NODE_ELEMENT &&
                      n.is("table") &&
                      e[c ? "checkStartOfBlock" : "checkEndOfBlock"]()
                        ? (a.fire("saveSnapshot"),
                          e[c ? "checkEndOfBlock" : "checkStartOfBlock"]() &&
                            h.remove(),
                          e["moveToElementEdit" + (c ? "End" : "Start")](n),
                          e.select(),
                          a.fire("saveSnapshot"),
                          (d = 1))
                        : l.blockLimit &&
                          l.blockLimit.is("td") &&
                          (r = l.blockLimit.getAscendant("table")) &&
                          e.checkBoundaryOfElement(
                            r,
                            c ? CKEDITOR.START : CKEDITOR.END
                          ) &&
                          (n = r[c ? "getPrevious" : "getNext"](g))
                        ? (a.fire("saveSnapshot"),
                          e["moveToElementEdit" + (c ? "End" : "Start")](n),
                          e.checkStartOfBlock() && e.checkEndOfBlock()
                            ? n.remove()
              ...
              CKEDITOR.env.gecko &&
                this.attachListener(this, "mouseup", function (b) {
                  if (
                    2 == b.data.$.button &&
                    ((b = b.data.getTarget()), !b.getOuterHtml().replace(q, ""))
                  ) {
                    var c = a.createRange();
      ...
      t = (function () {
                  ...
                  C && e in CKEDITOR.dtd.$list
                    ...
                    : ((l = !!m[e]),
                      "br" != e ||
                        ...
                        (n && n != p - 1) ||
                        ((t =
                          (g = n ? h[n - 1].node : y.getItem(n + 1)) &&
                          (!a(g) || !g.is("br"))),
                        (g = g && a(g) && k.$block[g.getName()])),
                      -1 != q || l || (q = n),
                      l || (w = n),
                      h.push({
                        isElement: 1,
                      ...
                      (g = t = 0)))
                : h.push({ isElement: 0, node: f, allowed: 1 });
        ...
        function d(b, c) {
          ...
          for (r && f.push(" "); h < e; h++)
            (l = g.getItem(h)),
              a(l) && !l.is(m) ? (f = f.concat(d(l, c))) : f.push(l);
          r && f.push(" ");
          return f;
        }
        function g(b) {
        ...
        function e(b) {
          return (
            b &&
            a(b) &&
            (b.is(k.$removeEmpty) || (b.is("a") && !b.isBlockBoundary()))
          );
        }
        function l(b, c, d, f) {
          var g = b.clone(),
          ...
          (e = new CKEDITOR.dom.walker(g).next()) &&
            a(e) &&
            n[e.getName()] &&
            (h = e.getPrevious()) &&
            a(h) &&
            ...
            f.contains(e) &&
            e.isIdentical(h) &&
            (e.moveChildren(h), e.remove(), l(b, c, d, f));
        }
        function h(b, c) {
          function d(b, c) {
            if (
        ...
        var k = CKEDITOR.dtd,
          ...
          y = { p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1 },
        ...
        return function (n, q, H, t) {
          ...
          if (!t.checkReadOnly()) {
            var v =
              new CKEDITOR.dom.elementPath(t.startContainer, t.root)
                .blockLimit || t.root;
            n = {
              type: q,
              dontFilter: A,
            ...
            var J, E;
            "text" == n.type &&
              q.shrink(CKEDITOR.SHRINK_ELEMENT, !0, !1) &&
              ((J = CKEDITOR.dom.element.createFromHtml(
                "\x3cspan\x3e\x26nbsp;\x3c/span\x3e",
                q.document
              )),
              q.insertNode(J),
            ...
            if ((J = H)) {
              ...
              if ("text" == n.type && n.inlineStylesRoot) {
                ...
                for (t = n.inlineStylesRoot.getParent(); !E.equals(t); )
              ...
              if (
                ...
                a: {
                  ...
                  if (
                    ...
                    a((K = E.getFirst())) &&
                    K.is(y) &&
                    !K.hasAttribute("contenteditable")
                  ) {
            ...
            if (J) {
              ...
              for (h(q, K); t < q.length; t++) {
                ...
                if ((M = v.isLineBreak)) {
                  ...
                  v.hasBlockSibling
                    ? (M = 1)
                    : (X = M.startContainer.getAscendant(k.$block, 1)) &&
                      X.is({ div: 1, p: 1 })
                    ? ((ga = X.getPosition(V)),
                      ga == CKEDITOR.POSITION_IDENTICAL ||
                      ga == CKEDITOR.POSITION_CONTAINS
                        ? (M = 0)
                        : ((V = M.splitElement(X)),
                          M.moveToPosition(V, CKEDITOR.POSITION_AFTER_START),
                          (M = 1)))
                    : (M = 0);
                }
                if (M) H = 0 < t;
                  ...
                  M = K.startPath();
                  !v.isBlock &&
                    m(n.editor, M.block, M.blockLimit) &&
                    (Y = f(n.editor)) &&
                    ((Y = J.createElement(Y)),
                    Y.appendBogus(),
                    K.insertNode(Y),
                    CKEDITOR.env.needsBrFiller &&
                      (S = Y.getBogus()) &&
                      S.remove(),
                    K.moveToPosition(Y, CKEDITOR.POSITION_BEFORE_END));
                  ...
                  v.lastNotAllowed &&
                    t < q.length - 1 &&
                    ((da = W ? A : da) &&
                      K.setEndAt(da, CKEDITOR.POSITION_AFTER_START),
                    (u = 0));
                  K.collapse();
                }
              }
              ...
              S &&
                ...
                K.setEndAt(M, CKEDITOR.POSITION_AFTER_END));
              n.dontMoveCaret = H;
            ...
            for (Z = S.createBookmark(); (Q = n.zombies.pop()); )
              Q.getParent() &&
                ((Y = S.clone()),
                Y.moveToElementEditStart(Q),
                Y.removeEmptyBlocksAtEnd());
            if (da)
              for (; (Q = da.pop()); )
                CKEDITOR.env.needsBrFiller
                  ? Q.appendBogus()
                  : Q.append(S.document.createText(" "));
            for (; (Q = n.mergeCandidates.pop()); ) Q.mergeSiblings();
            S.moveToBookmark(Z);
            if (!n.dontMoveCaret) {
              for (Q = g(S); Q && a(Q) && !Q.is(k.$empty); ) {
                if (Q.isBlockBoundary())
                  S.moveToPosition(Q, CKEDITOR.POSITION_BEFORE_END);
                else {
        ...
        return function (d) {
          ...
          g.is("table")
            ...
            : (g.is({ tbody: 1, thead: 1, tfoot: 1 }) && (g = b(g, "tr", e)),
              g.is("tr") &&
                (g = b(g, g.getParent().is("thead") ? "th" : "td", e)),
      ...
      y = {
        eol: {
          detect: function (a, b) {
            ...
            e.block &&
              f.checkBoundaryOfElement(e.block, CKEDITOR.START) &&
              (c.setEndBefore(e.block), (a.appendEolBr = 1));
          },
          fix: function (a, b) {
            var c = b.getDocument(),
              d;
        ...
        tree: {
          rebuild: function (a, b) {
            ...
            if (f.blockLimit.is({ tr: 1, table: 1 })) {
        ...
        return {
          list: {
            detectMerge: function (a, b) {
              ...
              a.mergeList =
                e && h && e.getParent().equals(h.getParent()) && !e.equals(h);
              a.mergeListItems =
                f.block &&
                g.block &&
                f.block.is(CKEDITOR.dtd.$listItem) &&
            ...
            return {
              ...
              detectRanges: function (f, g) {
                var e = c(g, f.bookmark),
                  ...
                  l,
                  k,
                  m = e.getCommonAncestor();
                m.is(CKEDITOR.dtd.$tableContent) &&
                  !m.is(d) &&
                  (m = m.getAscendant("table", !0));
                k = m;
                ...
                if (m || k)
                  m && k && b(m, k)
                    ...
                    ? k ||
                      ((f.tableSurroundingRange = h),
                      h.setStartAt(m, CKEDITOR.POSITION_AFTER_END),
                      e.setEndAt(m, CKEDITOR.POSITION_AFTER_END))
                    : ((f.tableSurroundingRange = h),
                      h.setEndAt(k, CKEDITOR.POSITION_BEFORE_START),
                      e.setStartAt(k, CKEDITOR.POSITION_AFTER_START)),
                    (f.tableContentsRanges = l ? l : a(e));
              },
    ...
    (function () {
      ...
      function m(a, b) {
        ...
        if (c) {
          ...
          h &&
            ...
            (d = c.getSelection()),
            (c = c.createRange()),
            c.setStart(h[0].node, h[0].offset),
            c.collapse(!0),
            d.removeAllRanges(),
            d.addRange(c),
            d.extend(h[1].node, h[1].offset));
        }
      }
      function f(a, b) {
        return b
        ...
        for (var b = 0; b < a.length; b++) {
          ...
          if (!c.collapsed) {
            if (c.startContainer.isReadOnly())
              for (
                var d = c.startContainer, f;
                d &&
                !(
                  ((f = d.type == CKEDITOR.NODE_ELEMENT) && d.is("body")) ||
                  !d.isReadOnly()
                );
            ...
            f &&
              f.type == CKEDITOR.NODE_TEXT &&
              (e ? h.setEndAfter(f) : h.setEndBefore(f));
            ...
            d.evaluator = function (d) {
              if (d.type == CKEDITOR.NODE_ELEMENT && d.isReadOnly()) {
                ...
                d.getPosition(h.endContainer) & CKEDITOR.POSITION_CONTAINS ||
                  (f.setStartAfter(d), f.collapsed || a.splice(b + 1, 0, f));
                return !0;
              }
              return !1;
            };
      ...
      var n,
        v,
        u = CKEDITOR.dom.walker.invisible(1),
        q = (function () {
          function a(b) {
            return function (a) {
      ...
      CKEDITOR.on("instanceCreated", function (b) {
        ...
        d.on("contentDom", function () {
          ...
          h.attachListener(
            ...
            function () {
              q &&
                ...
                (q =
                  d._.previousActive &&
                  d._.previousActive.equals(f.getActive()));
              d.unlockSelection(q);
              q = 0;
            },
            null,
          ...
          if (CKEDITOR.env.ie || r)
            t
              ? h.attachListener(h, "beforedeactivate", b, null, null, -1)
              : h.attachListener(d, "selectionCheck", b, null, null, -1),
              h.attachListener(
                h,
                ...
                n.on("mousedown", function (a) {
                  function b(a) {
                    ...
                    if (d) {
                      ...
                      d.setEndPoint(
                        0 > e.compareEndPoints("StartToStart", c)
                          ? "EndToEnd"
                          : "StartToStart",
                        c
                      );
          ...
          if (r && (CKEDITOR.env.webkit || CKEDITOR.env.gecko)) {
            ...
            h.attachListener(
              CKEDITOR.env.ie ? h : f.getDocumentElement(),
              "mouseup",
              e,
              d
            );
        ...
        CKEDITOR.on("instanceReady", function (a) {
          ...
          b.on(
            ...
            function () {
              ...
              c &&
                (c.getCustomData("ready") ? m(a) : c.setCustomData("ready", 1));
            },
            null,
            null,
            -1
      ...
      CKEDITOR.dom.selection = function (a) {
        ...
        if (a)
          if (a.getRangeAt)
            d =
              (f = a.rangeCount && a.getRangeAt(0)) &&
              new CKEDITOR.dom.node(f.commonAncestorContainer);
          else {
            try {
              f = a.createRange();
            } catch (g) {}
            d =
              ...
              CKEDITOR.dom.element.get(
                (f.item && f.item(0)) || f.parentElement()
              );
          }
        if (
          !d ||
      ...
      CKEDITOR.dom.selection.prototype = {
          ...
          : function () {
              ...
              if (!c || !c.rangeCount) b = CKEDITOR.SELECTION_NONE;
                ...
                d == c.endContainer &&
                  ...
                  y[d.childNodes[c.startOffset].nodeName.toLowerCase()] &&
            ...
            ? (function () {
                ...
                var b = function (b, c) {
                  ...
                  if (-1 == m || (m == f.length - 1 && 0 > n)) {
                    ...
                    for (d = f.length; 0 < h && 0 < d; )
                      (e = f[--d]),
                        e.nodeType == CKEDITOR.NODE_TEXT &&
                          ((q = e), (h -= e.nodeValue.length));
                  ...
                  h = h.text.replace(/(\r\n|\r)/g, "\n").length;
                  if (!h)
                    return { container: d, offset: a(g) + (0 < n ? 0 : 1) };
                  for (; 0 < h; )
                    try {
                      (e = g[0 < n ? "previousSibling" : "nextSibling"]),
                        e.nodeType == CKEDITOR.NODE_TEXT &&
                          ((h -= e.nodeValue.length), (q = e)),
                        (g = e);
                    } catch (y) {
                    ...
                    for (var d = [], f = 0; f < c.length; f++) {
                      for (
                        var g = c.item(f),
                          ...
                          h = 0,
                          a = new CKEDITOR.dom.range(this.root);
                        h < e.childNodes.length && e.childNodes[h] != g;
                        h++
                      );
        ...
        getSelectedElement: function () {
          ...
          var b = this,
            c = CKEDITOR.tools.tryThese(
              ...
              function () {
                for (
                  var a = b.getRanges()[0].clone(), c, d, f = 2;
                  f &&
                  !(
                    (c = a.getEnclosedNode()) &&
                    c.type == CKEDITOR.NODE_ELEMENT &&
        ...
        selectRanges: function (a) {
          ...
          this.reset();
          if (b)
            for (var b = this.root, c, f = 0; f < a.length; ++f)
              (c = a[f]),
            ...
            if (this.isLocked) {
              ...
              a: {
                ...
                if (
                  ...
                  e.type == CKEDITOR.NODE_ELEMENT &&
                  ((l = l.clone()),
                  l.shrink(CKEDITOR.SHRINK_ELEMENT, !0),
                  (h = l.getEnclosedNode()) &&
                ...
                if (t) {
                  ...
                  if (
                    (e.startContainer.type == CKEDITOR.NODE_ELEMENT &&
                      e.startContainer.getName() in b) ||
                    (e.endContainer.type == CKEDITOR.NODE_ELEMENT &&
                      e.endContainer.getName() in b)
                  )
                    e.shrink(CKEDITOR.NODE_ELEMENT, !0), (a = e.collapsed);
                  p = e.createBookmark();
                  b = p.startNode;
                  a || (g = p.endNode);
                  ...
                  g
                    ? ((h = e.document.$.body.createTextRange()),
                      h.moveToElementText(g.$),
                      p.setEndPoint("EndToEnd", h),
                      p.moveEnd("character", -1))
                    : ((n = b.getNext(l)),
                      (q = b.hasAscendant("pre")),
                      (n =
                        !(n && n.getText && n.getText().match(h)) &&
                        (q ||
                          !b.hasPrevious() ||
                          (b.getPrevious().is && b.getPrevious().is("br")))),
                      (q = e.document.createElement("span")),
                      q.setHtml("\x26#65279;"),
                      q.insertBefore(b),
                      n && e.document.createText("﻿").insertBefore(b));
                  e.setStartBefore(b);
                  b.remove();
                  a
                    ? (n
                      ...
                      q.remove())
                    : (e.setEndBefore(g), g.remove(), p.select());
                } else {
                  g = this.getNative();
                  if (!g) return;
                  ...
                  for (p = 0; p < a.length; p++) {
                    if (
                      ...
                      (q = a[p + 1]),
                      (h = n.clone()),
                      h.setStart(n.endContainer, n.endOffset),
                      h.setEnd(q.startContainer, q.startOffset),
                      !h.collapsed &&
                    ...
                    e.collapsed &&
                      ...
                      "br" == n.getName()
                        ? (m(this.root),
                          e.moveToPosition(n, CKEDITOR.POSITION_BEFORE_START))
                        : e.moveToPosition(h, CKEDITOR.POSITION_AFTER_END));
                    q.setStart(e.startContainer.$, e.startOffset);
                    try {
                      q.setEnd(e.endContainer.$, e.endOffset);
                    } catch (H) {
                      if (0 <= H.toString().indexOf("NS_ERROR_ILLEGAL_VALUE"))
                        e.collapse(1), q.setEnd(e.endContainer.$, e.endOffset);
                      else throw H;
                    }
                    g.addRange(q);
                  }
    ...
    (function () {
      ...
      function b(c) {
        ...
        if (c.collapsed)
          ...
          for (
            A.getPosition(u) == CKEDITOR.POSITION_FOLLOWING && (A = 0);
            A;
            ...
            if (A.equals(u)) (A = null), (k = !0);
              ...
              if (v && m && CKEDITOR.dtd.$block[z])
                for (
                  var C = A,
                    ...
                    D = x.length,
                    ea = 0,
                    C = D && new CKEDITOR.dom.range(C.getDocument());
                  ea < D;
                  ++ea
                ) {
                  var B = x[ea],
                    ha = CKEDITOR.filter.instances[B.data("cke-filter")];
                  if (ha ? ha.check(this) : 1)
                    C.selectNodeContents(B), b.call(this, C);
                }
              ...
              if (x)
                if (
                  ...
                  (ea = l),
                  !B ||
                    (!(B.getDtd() || CKEDITOR.dtd.span)[D] && !ea) ||
                    (x.parentRule && !x.parentRule(B)))
                )
                  k = !0;
                else {
                  if (
                    (r ||
                      (z &&
                        ...
                        (A.getPosition(u) | L) != L) ||
                      ((r = c.clone()), r.setStartBefore(A)),
                    (z = A.type),
                    z == CKEDITOR.NODE_TEXT ||
                      v ||
                      (z == CKEDITOR.NODE_ELEMENT && !A.getChildCount()))
                  ) {
                    for (
                      var z = A, E;
                      (k = !z.getNext(I)) &&
                      ((E = z.getParent()), n[E.getName()]) &&
                      e(E, t, h, N);
              ...
              for (
                ...
                if (w.getName() == g) {
                  for (aa in h.attributes)
                    !D[aa] &&
                      (F = w.getAttribute(fa)) &&
                      (k.getAttribute(aa) == F ? (x[aa] = 1) : (D[aa] = 1));
                  for (fa in h.styles)
                    !B[fa] &&
                      (F = w.getStyle(fa)) &&
                      (k.getStyle(fa) == F ? (z[fa] = 1) : (B[fa] = 1));
                }
                w = w.getParent();
              }
        ...
        function b() {
          for (
            var a = new CKEDITOR.dom.elementPath(d.getParent()),
              c = new CKEDITOR.dom.elementPath(k.getParent()),
              f = null,
              g = null,
              e = 0;
            e < a.elements.length;
          ...
          for (
            ...
            if (this.checkElementRemovable(h)) {
              ...
              (a.checkBoundaryOfElement(h, CKEDITOR.END) ||
                (l = a.checkBoundaryOfElement(h, CKEDITOR.START)))
                ? ((g = h), (g.match = l ? "start" : "end"))
                : (h.mergeSiblings(),
                  h.is(this.element)
                    ? u.call(this, h)
                    : t(h, r(this)[h.getName()]));
            }
          if (g) {
            h = d;
            for (e = 0; ; e++) {
      ...
      function f(a) {
        ...
        for (var d, f = a.document, g; (d = c.getNextParagraph()); )
          !d.isReadOnly() &&
      ...
      function u(a, b) {
        ...
        for (e in d)
          if (
            ("class" != e && !this._.definition.fullMatch) ||
            a.getAttribute(e) == w(e, d[e])
          )
            (b && "data-" == e.slice(0, 5)) ||
              ((g = a.hasAttribute(e)), a.removeAttribute(e));
        for (var h in c)
          (this._.definition.fullMatch && a.getStyle(h) != w(h, c[h], !0)) ||
      ...
      function q(a) {
        for (
          ...
          (d = c.getItem(f)), d.isReadOnly() || u.call(this, d, !0);
        for (var g in b)
          if (g != this.element)
            for (c = a.getElementsByTag(g), f = c.count() - 1; 0 <= f; f--)
      ...
      function x(a, b, c) {
        ...
        for (var g, e = f.createIterator(); (g = e.getNextRange()); )
          b.call(this, g, c);
        a.selectRanges(f);
      ...
      CKEDITOR.style.prototype = {
        apply: function (a) {
          if (a instanceof CKEDITOR.dom.document)
            return x.call(this, a.getSelection());
        ...
        remove: function (a) {
          if (a instanceof CKEDITOR.dom.document)
            return x.call(this, a.getSelection(), 1);
          if (this.checkApplicable(a.elementPath(), a)) {
            var b = this._.enterMode;
            b || (this._.enterMode = a.activeEnterMode);
        ...
        buildPreview: function (a) {
          ...
          var c = ["\x3c", d],
            f = b.attributes;
          if (f) for (var g in f) c.push(" ", g, '\x3d"', f[g], '"');
      ...
      attachStyleStateChange: function (a, e) {
        ...
        b ||
          ...
          this.on("selectionChange", function (a) {
            for (var d = 0; d < b.length; d++) {
              var e = b[d],
                m = e.style.checkActive(a.data.path, this)
    ...
    (CKEDITOR.dom.elementPath.prototype = {
      ...
      contains: function (a, e, b) {
        ...
        for (e = 0; e < k; e++) if (c(d[e])) return d[e];
        return null;
      },
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.text.prototype, {
      ...
      split: function (a) {
        ...
        e.childNodes.length == b &&
          (a >= c
            ? ((k = d.createText("")), k.insertAfter(this))
            : ((a = d.createText("")), a.insertAfter(k), a.remove()));
        return k;
      },
    ...
    (function () {
      function a(a, c, d) {
        ...
        m.equals(h.getPrevious())
          ? ((c.startOffset =
              c.startOffset - m.getLength() - a.getPrevious().getLength()),
            (m = a.getNext()))
          : m.equals(a.getPrevious()) &&
            ((c.startOffset -= m.getLength()), (m = a.getNext()));
          ...
          return {
            getNextRange: function (m) {
              ...
              if (f && 1 < a.length) {
                  ...
                  for (var l = 0; a[e + l + 1]; ) {
                    ...
                    for (g = g.getById(d[l + 1].startNode); ; ) {
                      ...
                      if (g.equals(h)) m = 1;
                        ...
                        c(h) ||
                        (h.type == CKEDITOR.NODE_ELEMENT && h.isBlockBoundary())
                      )
                        continue;
                      break;
                    }
                ...
                for (f.moveToBookmark(d.shift()); l--; )
                  (h = a[++e]),
        ...
        setUiColor: function (a) {
          ...
          return (this.setUiColor = function (a) {
            ...
            var c = CKEDITOR.skin.chameleon,
              ...
              l = "";
            "function" == typeof c &&
              ((e = c(this, "editor")), (l = c(this, "panel")));
            a = [[h, a]];
            d([b], e, a);
            d(f, l, a);
          }).call(this, a);
    ...
    (function () {
      ...
      if ((a = CKEDITOR._.pending))
        for (delete CKEDITOR._.pending, e = 0; e < a.length; e++)
    ...
    (CKEDITOR.skin.chameleon = (function () {
      var a = (function () {
          return function (a, b) {
            for (var e = a.match(/[^#]./g), m = 0; 3 > m; m++) {
              ...
              h = (
                "0" +
                (0 > b ? 0 | (h * (1 + b)) : 0 | (h + (255 - h) * b)).toString(
                  16
                )
              ).slice(-2);
              e[f] = h;
      ...
      return function (c, d) {
        var k = c.uiColor,
          k = {
            id: "." + c.id,
            defaultBorder: a(k, -0.1),
            defaultGradient: e(a(k, 0.9), k),
            lightGradient: e(a(k, 1), a(k, 0.7)),
            mediumGradient: e(a(k, 0.8), a(k, 0.5)),
            ckeButtonOn: e(a(k, 0.6), a(k, 0.7)),
            ckeResizer: a(k, -0.4),
            ckeToolbarSeparator: a(k, 0.5),
            ckeColorauto: a(k, 0.8),
            dialogBody: a(k, 0.7),
            dialogTabSelected: e("#FFFFFF", "#FFFFFF"),
            dialogTabSelectedBorder: "#FFF",
            elementsPathColor: a(k, -0.6),
            elementsPathBg: k,
            menubuttonIcon: a(k, 0.5),
            menubuttonIconHover: a(k, 0.3),
          };
    ...
    CKEDITOR.plugins.add("dialogui", {
      onLoad: function () {
        var a = function (a) {
          ...
          m = function (a) {
            for (var b in a)
              (k.test(b) || "title" == b || "type" == b) && delete a[b];
            return a;
          },
          f = function (a) {
              ...
              if (!(3 > arguments.length)) {
                ...
                CKEDITOR.ui.dialog.labeledElement.call(
                  ...
                  function () {
                    ...
                    for (b in m)
                      a.push(
                        b + '\x3d"' + CKEDITOR.tools.htmlEncode(m[b]) + '" '
                      );
                    a.push(
                      "\x3e",
                    ...
                    for (
                      ...
                      var y = c.items[k],
                        ...
                        r = CKEDITOR.tools.extend(
                          {},
                          c,
                          { id: r, title: null, type: null },
                          !0
                        ),
                        A = CKEDITOR.tools.extend({}, r, { title: A }, !0),
                        C = {
                          type: "radio",
                      ...
                      m(r);
                      m(A);
                      "undefined" != typeof r.inputStyle &&
                        (r.style = r.inputStyle);
              ...
              if (!(3 > arguments.length)) {
                ...
                CKEDITOR.ui.dialog.labeledElement.call(
                  ...
                  function () {
                    ...
                    for (
                      var k = 0, y;
                      k < c.items.length && (y = c.items[k]);
                      k++
                    )
                      e.push(
                        '\x3coption value\x3d"',
                        CKEDITOR.tools
                          .htmlEncode(void 0 !== y[1] ? y[1] : y[0])
                          .replace(/"/g, "\x26quot;"),
                        '" /\x3e ',
                        CKEDITOR.tools.htmlEncode(y[0])
                      );
                    "undefined" != typeof a.inputStyle &&
                      (a.style = a.inputStyle);
        ...
        CKEDITOR.ui.dialog.textInput.prototype = CKEDITOR.tools.extend(
          new CKEDITOR.ui.dialog.labeledElement(),
          {
            ...
            getValue: function () {
              var a =
                CKEDITOR.ui.dialog.uiElement.prototype.getValue.call(this);
              if (this.bidi && a) {
            ...
            eventProcessors: {
              onChange: function (a, b) {
                if (!CKEDITOR.env.ie || 8 < CKEDITOR.env.version)
                  return d.onChange.apply(this, arguments);
                a.on(
                  "load",
                  function () {
        ...
        CKEDITOR.ui.dialog.file.prototype = CKEDITOR.tools.extend(
          ...
          c,
          {
            ...
            registerEvents: function (a) {
              ...
              for (f in a)
                if ((c = f.match(b)))
                  this.eventProcessors[f]
                    ? this.eventProcessors[f].call(this, this._.dialog, a[f])
                    : d(this, this._.dialog, c[1].toLowerCase(), a[f]);
              return this;
            },
            reset: function () {
              function a() {
                ...
                c.$.write(
                  [
                    ...
                    '\x3cform enctype\x3d"multipart/form-data" method\x3d"POST" dir\x3d"' +
                      ...
                      p +
                      '" action\x3d"',
                    CKEDITOR.tools.htmlEncode(d.action),
                    '"\x3e\x3clabel id\x3d"',
                    b.labelId,
                    '" for\x3d"',
                    A,
                    '" style\x3d"display:none"\x3e',
                    CKEDITOR.tools.htmlEncode(d.label),
                    '\x3c/label\x3e\x3cinput style\x3d"width:100%" id\x3d"',
                    A,
                    '" aria-labelledby\x3d"',
                    b.labelId,
                    '" type\x3d"file" name\x3d"',
                    CKEDITOR.tools.htmlEncode(d.id || "cke_upload"),
                    '" size\x3d"',
                    CKEDITOR.tools.htmlEncode(0 < h ? h : ""),
        ...
        CKEDITOR.dialog.addUIElement("fieldset", {
          build: function (a, b, c) {
            for (
              ...
              e.push(p);
              k.push(
                CKEDITOR.dialog._.uiElementBuilders[f.type].build(a, f, p)
              );
            }
    ...
    (function () {
      ...
      function b(a, b) {
        for (
          var c = a.$.getElementsByTagName("input"), d = 0, f = c.length;
          d < f;
          d++
        ) {
          var e = new CKEDITOR.dom.element(c[d]);
          "text" == e.getAttribute("type").toLowerCase() &&
            (b
      ...
      function k(a) {
        var b = CKEDITOR.dom.element.createFromHtml(
            CKEDITOR.addTemplate("dialog", t).output({
      ...
      function l(a) {
        function b(c) {
          ...
          a.move(
            f.x + h[3] < g
              ? -h[3]
              : f.x - h[1] > l.width - k.width - g
              ? l.width - k.width + ("rtl" == e.lang.dir ? 0 : h[1])
              : f.x,
            f.y + h[0] < g
              ? -h[0]
              : f.y - h[2] > l.height - k.height - g
              ? l.height - k.height + h[2]
              : f.y,
            1
          );
      ...
      function g(a) {
        function b(c) {
          var n = "rtl" == e.lang.dir,
            ...
            y = m.height,
            q =
              p + (c.data.$.screenX - l.x) * (n ? -1 : 1) * (a._.moved ? 1 : 2),
          ...
          if (
            ...
            p = Math.max(d.minWidth || 0, q - g);
          if (
            f == CKEDITOR.DIALOG_RESIZE_HEIGHT ||
            f == CKEDITOR.DIALOG_RESIZE_BOTH
          )
            y = Math.max(d.minHeight || 0, A - h);
          a.resize(p, y);
          a._.moved || a.layout();
          c.data.preventDefault();
        }
        ...
        if (f != CKEDITOR.DIALOG_RESIZE_NONE) {
          var e = a.getParentEditor(),
            ...
            p = CKEDITOR.tools.addFunction(function (d) {
              ...
              f.$.getElementsByTagName("iframe").length &&
              ...
              CKEDITOR.env.ie6Compat &&
                ((f = x.getChild(0).getFrameDocument()),
                f.on("mousemove", b),
                f.on("mouseup", c));
          ...
          a.on("load", function () {
            ...
            b = CKEDITOR.dom.element.createFromHtml(
              '\x3cdiv class\x3d"cke_resizer' +
                ...
                e.lang.dir +
                '" title\x3d"' +
                CKEDITOR.tools.htmlEncode(e.lang.common.resize) +
      ...
      CKEDITOR.dialog = function (b, f) {
        ...
        function n(c) {
          if (x == CKEDITOR.dialog._.currentTop) {
            var d = c.data.getKeystroke(),
              ...
              g = [37, 38, 39, 40];
            w = v = 0;
            if (9 == d || d == CKEDITOR.SHIFT + 9)
              m(d == CKEDITOR.SHIFT + 9 ? -1 : 1), (w = 1);
            else if (
              d == CKEDITOR.ALT + 121 &&
              !x._.tabBarMode &&
              1 < x.getPageCount()
              ...
              (x._.tabBarMode = !0),
                ...
                (x._.currentFocusIndex = -1),
                (w = 1);
            else if (-1 != CKEDITOR.tools.indexOf(g, d) && x._.tabBarMode)
              (d =
                -1 != CKEDITOR.tools.indexOf([f ? 39 : 37, 38], d)
                  ? a.call(x)
                  : e.call(x)),
                x.selectPage(d),
                x._.tabs[d][0].focus(),
              ...
              if (13 == d)
                (d = c.data.getTarget()),
                  d.is("a", "button", "select", "textarea") ||
                    (d.is("input") && "button" == d.$.type) ||
                    ((d = this.getButton("ok")) &&
        ...
        CKEDITOR.event.call(this);
        this.definition = q = CKEDITOR.fire(
          "dialogDefinition",
          { name: f, definition: q },
          b
        ).definition;
        ...
        var x = this,
          B = function (a) {
            var b = x._.contents,
              ...
              d;
            for (d in b)
              for (var f in b[d]) if ((c = a.call(this, b[d][f]))) return;
          };
        this.on(
          "ok",
          function (a) {
          ...
          function () {
            ...
            b.config.dialog_startupFocusTab && a
              ...
              : this._.hasFocus ||
                ...
                q.onFocus ? (a = q.onFocus.call(this)) && a.focus() : m(1));
          },
          this,
          null,
          4294967295
        ...
        l(this);
        g(this);
        new CKEDITOR.dom.text(q.title, CKEDITOR.document).appendTo(
          this.parts.title
        );
        for (z = 0; z < q.contents.length; z++)
          (u = q.contents[z]) && this.addPage(u);
        this.parts.tabs.on(
          "click",
          function (a) {
            var b = a.data.getTarget();
        ...
        z = [];
        u = CKEDITOR.dialog._.uiElementBuilders.hbox
          .build(
            this,
            {
              type: "hbox",
      ...
      CKEDITOR.dialog.prototype = {
        ...
        layout: function () {
          ...
          CKEDITOR.env.ie6Compat ||
            (b.height + (0 < f ? f : 0) > c.height ||
            b.width + (0 < d ? d : 0) > c.width
              ? a.setStyle("position", "absolute")
              : a.setStyle("position", "fixed"));
          this.move(
            this._.moved ? this._.position.x : d,
            this._.moved ? this._.position.y : f
          );
        },
        foreach: function (a) {
        ...
        addPage: function (a) {
          if (
            ...
            a.accessKey &&
              (E(this, this, "CTRL+" + a.accessKey, L, G),
        ...
        addFocusable: function (a, b) {
          if ("undefined" == typeof b)
            (b = this._.focusList.length),
              this._.focusList.push(new m(this, a, b));
          else {
          ...
          uiElement: function (a, b, c, d, f, e, g) {
            if (!(4 > arguments.length)) {
              var h = (d.call ? d(b) : d) || "div",
                ...
                p = (this.domId =
                  m.id || CKEDITOR.tools.getNextId() + "_uiElement");
              b.requiredContent &&
              ...
              for (
                var y =
                    m["class"] && m["class"].split ? m["class"].split(" ") : [],
                  p = 0;
                p < y.length;
                p++
              )
              ...
              b.align &&
                ((y = b.align),
                (l["margin-left"] = "left" == y ? 0 : "auto"),
                (l["margin-right"] = "right" == y ? 0 : "auto"));
              for (p in l) q.push(p + ":" + l[p]);
              b.hidden && q.push("display:none");
              for (p = q.length - 1; 0 <= p; p--) "" === q[p] && q.splice(p, 1);
              0 < q.length &&
                (m.style = (m.style ? m.style + "; " : "") + q.join("; "));
              for (p in m)
                k.push(p + '\x3d"' + CKEDITOR.tools.htmlEncode(m[p]) + '" ');
              ...
              this.accessKeyUp &&
                this.accessKeyDown &&
                b.accessKey &&
                E(this, a, "CTRL+" + b.accessKey);
              var A = this;
              a.on("load", function () {
                var b = A.getInputElement();
                if (b) {
                  var c =
                    A.type in { checkbox: 1, ratio: 1 } &&
                    CKEDITOR.env.ie &&
                    8 > CKEDITOR.env.version
              ...
              CKEDITOR.ui.dialog.uiElement.call(
                ...
                function () {
                  ...
                  for (k = 0; k < c.length; k++) {
                    ...
                    g
                      ? g[k] && d.push("width:" + q(g[k]))
                      : d.push("width:" + Math.floor(100 / c.length) + "%");
                    h && d.push("height:" + q(h));
                    f &&
                      void 0 !== f.padding &&
                      d.push("padding:" + q(f.padding));
                    CKEDITOR.env.ie &&
                      CKEDITOR.env.quirks &&
                      e[k].align &&
                      d.push("text-align:" + e[k].align);
              ...
              CKEDITOR.ui.dialog.uiElement.call(
                ...
                function () {
                  ...
                  for (var d = 0; d < c.length; d++) {
                    ...
                    f &&
                      void 0 !== f.padding &&
                      k.push("padding:" + q(f.padding));
                    CKEDITOR.env.ie &&
                      CKEDITOR.env.quirks &&
                      e[d].align &&
                      k.push("text-align:" + e[d].align);
        ...
        var a = {
          build: function (a, b, c) {
            for (
              ...
              e.push(k);
              g.push(
                CKEDITOR.dialog._.uiElementBuilders[f.type].build(a, f, k)
              );
            }
      ...
      CKEDITOR.plugins.add("a11yhelp", {
        ...
        init: function (a) {
          ...
          a.addCommand("a11yHelp", {
            exec: function () {
              var b = a.langCode,
                b = e.availableLangs[b]
                  ? b
                  : e.availableLangs[b.replace(/-.*/, "")]
                  ? b.replace(/-.*/, "")
                  : "en";
              CKEDITOR.scriptLoader.load(
                CKEDITOR.getUrl(e.path + "dialogs/lang/" + b + ".js"),
                function () {
        ...
        var e = 0,
          b = function (b, d, h, k) {
            if (k) {
              ...
              a.addCommand(
                h,
                new CKEDITOR.styleCommand(k, { contentForms: g })
              );
              a.ui.addButton &&
                a.ui.addButton(b, {
                  label: d,
        ...
        exec: function (a) {
          ...
          if (d) {
            ...
            if (b == CKEDITOR.TRISTATE_OFF) {
              ...
              for (d.insertBefore(m[0]); 0 < m.length; )
              ...
              for (h = {}; (b = l.getNextParagraph()); ) {
                ...
                d &&
                  m &&
                  !m.getCustomData("blockquote_moveout") &&
                  (f.push(m),
                ...
                (l = f.shift()),
                  ...
                  l.getPrevious()
                    ? l.getNext()
                      ...
                      : l.remove().insertAfter(d)
                    : l.remove().insertBefore(d),
                  d.getCustomData("blockquote_processed") ||
                    (m.push(d),
                    CKEDITOR.dom.element.setMarker(
                      h,
                      d,
              ...
              for (f = m.length - 1; 0 <= f; f--) {
                ...
                a: {
                  h = d;
                  for (
                    var l = 0, g = h.getChildCount(), n = void 0;
                    l < g && (n = h.getChild(l));
                    l++
                  )
                    if (
              ...
              if (a.config.enterMode == CKEDITOR.ENTER_BR)
                for (d = !0; b.length; )
                  if (((l = b.shift()), "div" == l.getName())) {
                    ...
                    !d ||
                      !l.getPrevious() ||
                      (l.getPrevious().type == CKEDITOR.NODE_ELEMENT &&
                    ...
                    for (
                      d =
                        l.getNext() &&
                        !(
                          l.getNext().type == CKEDITOR.NODE_ELEMENT &&
                          l.getNext().isBlockBoundary()
                        );
                      l.getFirst();

                    )
                      l.getFirst().remove().appendTo(f);
    ...
    (function () {
      ...
      function e(b) {
        function c() {
          ...
          "beforepaste" == B.mainPasteEvent &&
            (a.on("paste", function (a) {
              F ||
                (e(),
                a.data.preventDefault(),
                w(a),
                k("paste") || b.openDialog("paste"));
            }),
        ...
        function m(a, c) {
          ...
          if (!d.getById("cke_pastebin")) {
            ...
            var n = new CKEDITOR.dom.element(
              (!CKEDITOR.env.webkit && !f.is("body")) || CKEDITOR.env.ie
                ? "div"
                : "body",
              d
            );
            ...
            CKEDITOR.env.webkit
              ? (f.append(n),
                ...
                f.is("body") ||
                  ((p =
                    "static" != f.getComputedStyle("position")
                      ? f
                      : CKEDITOR.dom.element.get(f.$.offsetParent)),
                  (p = p.getDocumentPosition().y)))
              : f.getAscendant(CKEDITOR.env.ie ? "body" : "html", 1).append(n);
            n.setStyles({
              position: "absolute",
            ...
            setTimeout(function () {
              CKEDITOR.env.webkit &&
                (CKEDITOR.document.getBody().$.scrollTop = y);
              h && h.removeListener();
        ...
        function w(c) {
          ...
          f && B.canClipboardApiBeTrusted(d.dataTransfer, b)
            ? (c.data.preventDefault(),
              setTimeout(function () {
                a(b, d);
              }, 0))
            : m(c, function (c) {
                d.dataValue = c.replace(
      ...
      function d() {
        ...
        return {
          get: function (c) {
            return "plain-text" == c
              ? b.plainText || (b.plainText = new CKEDITOR.filter("br"))
              : "semantic-content" == c
              ? ((c = b.semanticContent) ||
        ...
        init: function (a) {
          ...
          a.on(
            ...
            function (a) {
              ...
              -1 < b.indexOf("Apple-") &&
                ((b = b.replace(
                  /<span className="Apple-converted-space">&nbsp;<\/span>/gi,
                  " "
                )),
                "html" != a.data.type &&
                  (b = b.replace(
                    /<span className="Apple-tab-span"[^>]*>([^<]*)<\/span>/gi,
                    function (a, b) {
                ...
                (b = b.replace(/(<[^>]+) className="Apple-[^"]*"/gi, "$1")));
          ...
          a.on(
            ...
            function (d) {
              ...
              "text" == f && "html" == h
                ? (e = k(a, e, l.get("plain-text")))
                : n == CKEDITOR.DATA_TRANSFER_EXTERNAL &&
                  a.pasteFilter &&
                  !d.dontFilter &&
                  (e = k(a, e, a.pasteFilter));
      ...
      CKEDITOR.plugins.clipboard = {
        ...
        internalDrop: function (b, c, d, f) {
          ...
          (l = this.isDropRangeAffectedByDragRange(b, c)) ||
          ...
          l = e.startNode;
          c &&
            b.getPosition(l) & CKEDITOR.POSITION_PRECEDING &&
              ...
              try {
                ...
                if (k) {
                  ...
                  var x = b.document.$.elementFromPoint(d, f),
                    ...
                    D;
                  if (B.equals(b.editable()) || "html" == B.getName())
                    return e &&
                      e.startContainer &&
                  ...
                  d < D.left
                    ...
                    : h.setStartAt(B, CKEDITOR.POSITION_BEFORE_END);
                  h.collapse(!0);
                }
              } catch (F) {
                return null;
        ...
        initPasteDataTransfer: function (a, b) {
          if (this.isCustomCopyCutSupported && a && a.data && a.data.$) {
            ...
            this.copyCutData && c.id == this.copyCutData.id
              ? ((c = this.copyCutData), (c.$ = a.data.$.clipboardData))
              : (this.copyCutData = c);
            return c;
          }
      ...
      var l = CKEDITOR.plugins.clipboard.isCustomDataTypesSupported
        ? "cke/id"
        : "Text";
      CKEDITOR.plugins.clipboard.dataTransfer = function (a, b) {
        ...
        this.id ||
          (this.id = "Text" == l ? "" : "cke-" + CKEDITOR.tools.getUniqueId());
        if ("Text" != l)
          try {
          ...
          "text/html" == a
            ? ((b = b.replace(this._.metaRegExp, "")),
              (a = this._.bodyRegExp.exec(b)) &&
                a.length &&
                ((b = a[1]), (b = b.replace(this._.fragmentRegExp, ""))))
            : "Text" == a &&
              CKEDITOR.env.gecko &&
              this.getFilesCount() &&
              "file://" == b.substring(0, 7) &&
              (b = "");
          return b;
        },
        setData: function (a, b) {
          ...
          if (this.isFramed) {
            var m = CKEDITOR.env.air
              ...
              ? "javascript:void(function(){" +
                ...
                "}())"
              : "";
            k.frame = e.output({ id: this.id + "_frame", src: m });
          }
          m = a.output(k);
          d && d.push(m);
          return m;
            ...
            switch (e) {
              ...
              case "mouseup":
                return (
                  (m = this._.focusIndex),
                  (f =
                    0 <= m && this.element.getElementsByTag("a").getItem(m)) &&
                    (f.$[e] ? f.$[e]() : f.$["on" + e]()),
                  !1
                );
            }
    ...
    (function () {
      function a(a, c, d, k, m) {
        ...
        var f = e[m];
        f ||
          ((f = e[m] = new CKEDITOR.ui.panel(c, k)),
          (f.element = d.append(
            CKEDITOR.dom.element.createFromHtml(f.render(a), c)
          )),
        ...
        proto: {
          ...
          showBlock: function (a, c, d, e, m, f) {
            ...
            var n = this.element,
              ...
              g =
                CKEDITOR.env.ie && !CKEDITOR.env.edge
                  ? g
                  : new CKEDITOR.dom.window(g.$.contentWindow),
              v = n.getDocument(),
              u = this._.parentElement.getPositionedAncestor(),
              q = c.getDocumentPosition(v),
              v = u ? u.getDocumentPosition(v) : { x: 0, y: 0 },
              t = "rtl" == this._.dir,
              p = q.x + (e || 0) - v.x,
              y = q.y + (m || 0) - v.y;
            !t || (1 != d && 4 != d)
              ? t || (2 != d && 3 != d) || (p += c.$.offsetWidth - 1)
              : (p += c.$.offsetWidth);
            if (3 == d || 4 == d) y += c.$.offsetHeight - 1;
            this._.panel._.offsetParentId = c.getId();
            n.setStyles({ top: y + "px", left: 0, display: "" });
            n.setOpacity(0);
                ...
                var a = CKEDITOR.tools.bind(function () {
                  ...
                  CKEDITOR.env.ie &&
                    ...
                    "rtl" == b.getComputedStyle("direction") &&
                      (p = CKEDITOR.env.ie8Compat
                        ? p -
                          2 * n.getDocument().getDocumentElement().$.scrollLeft
                        : p - (a.$.scrollWidth - a.$.clientWidth)));
                  var a = n.getFirst(),
                    k;
                  ...
                  n.setStyles({ top: y + "px", left: p + "px" });
                  n.setOpacity(1);
                  f && f();
                }, this);
          ...
          showAsChild: function (a, c, d, e, m, f) {
            if (
              ...
              a._.panel._.offsetParentId != d.getId()
            )
              this.hideChild(),
    ...
    CKEDITOR.plugins.add("menu", {
      ...
      beforeInit: function (a) {
        for (
          var e = a.config.menu_groups.split(","),
            b = (a._.menuGroups = {}),
            c = (a._.menuItems = {}),
            d = 0;
          d < e.length;
    ...
    (function () {
      ...
      var e =
        '\x3cspan class\x3d"cke_menuitem"\x3e\x3ca id\x3d"{id}" class\x3d"cke_menubutton cke_menubutton__{name} cke_menubutton_{state} {cls}" href\x3d"{href}" title\x3d"{title}" tabindex\x3d"-1"_cke_focus\x3d1 hidefocus\x3d"true" role\x3d"{role}" aria-haspopup\x3d"{hasPopup}" aria-disabled\x3d"{disabled}" {ariaChecked}';
      CKEDITOR.env.gecko &&
        CKEDITOR.env.mac &&
      ...
      var e =
        ...
        b = CKEDITOR.addTemplate(
          "menuItem",
          e +
            '\x3cspan class\x3d"cke_menubutton_inner"\x3e\x3cspan class\x3d"cke_menubutton_icon"\x3e\x3cspan class\x3d"cke_button_icon cke_button__{iconName}_icon" style\x3d"{iconStyle}"\x3e\x3c/span\x3e\x3c/span\x3e\x3cspan class\x3d"cke_menubutton_label"\x3e{label}\x3c/span\x3e{arrowHtml}\x3c/span\x3e\x3c/a\x3e\x3c/span\x3e'
        ),
            ...
            for (var e = 0; e < f.length; e++) {
              ...
              if (l)
                for (var g in l) {
                  ...
                  !n ||
                    (n.command && !this.editor.getCommand(n.command).state) ||
                    ((n.state = l[g]), this.add(n));
                }
            }
          },
          onClick: function (a) {
        ...
        proto: {
          ...
          show: function (b, c, e, f) {
            ...
            if (!g) {
              ...
              v["rtl" == l.lang.dir ? 37 : 39] = CKEDITOR.env.ie
                ? "mouseup"
                : "click";
            ...
            CKEDITOR.ui.fire("ready", this);
            this.parent
              ? this.parent._.panel.showAsChild(g, this.id, b, c, e, f)
              : g.showBlock(this.id, b, c, e, f);
            l.fire("menuShow", [g]);
          },
          ...
          render: function (a, e, m) {
            ...
            a = {
              ...
              iconStyle: CKEDITOR.skin.getIconStyle(
                ...
                u == this.icon ? null : this.icon,
                this.iconOffset
              ),
              arrowHtml: n ? c.output({ label: v }) : "",
      ...
      function a(a, b) {
        ...
        var v = CKEDITOR.tools.addFunction(m),
          u = CKEDITOR.tools.addFunction(function (b, c) {
            ...
            switch (c.getKeystroke()) {
              ...
              case 9:
                return (
                  (e = CKEDITOR.document.getById(f + (b + 1))) ||
                    (e = CKEDITOR.document.getById(f + "0")),
                  e.focus(),
                  !1
                );
              case e ? 37 : 39:
              case CKEDITOR.SHIFT + 9:
                return (
                  (e = CKEDITOR.document.getById(f + (b - 1))) ||
                    (e = CKEDITOR.document.getById(f + (g.list.length - 1))),
                  e.focus(),
                  !1
                );
              case 27:
        ...
        a.on("selectionChange", function () {
          for (
            ...
            var C = z[w],
              x = 0;
            r = C.data("cke-display-name")
              ? C.data("cke-display-name")
              : C.data("cke-real-element-type")
              ? C.data("cke-real-element-type")
              : C.getName();
            (m = C.hasAttribute("contenteditable")
          ...
          for (k = 0; k < f; k++)
            (r = e[k]),
              (m = a.lang.elementspath.eleTitle.replace(/%1/, r)),
              (r = c.output({
                id: n + k,
                label: m,
                text: r,
          ...
          b.on("dirChanged", function (a) {
            ...
            for (var e = new CKEDITOR.dom.walker(d), l; (l = e.next()); )
              if (l.type == CKEDITOR.NODE_ELEMENT)
                if (!l.equals(f) && l.getDirection())
                  d.setStartAfter(l), (e = new CKEDITOR.dom.walker(d));
                else {
                  ...
                  if (g)
                    for (
                      ...
                      l.hasClass(g[v] + n[0]) &&
                        (l.removeClass(g[v] + n[0]), l.addClass(g[v] + n[1]));
                  g = l.getStyle("margin-right");
                  n = l.getStyle("margin-left");
                  g
                    ? l.setStyle("margin-left", g)
                    : l.removeStyle("margin-left");
                  n
                    ? l.setStyle("margin-right", n)
                    : l.removeStyle("margin-right");
                }
          });
        },
      });
      ...
      CKEDITOR.plugins.indent.specificDefinition.prototype = {
        ...
        refreshJob: function (a, b, k) {
          ...
          a.activeFilter.checkFeature(this)
            ? (b.state = b.refresh.call(this, a, k))
            : (b.state = e);
          return b.state;
        },
    ...
    (function () {
      function a(a) {
        function c(e) {
          for (
            var h = u.startContainer, m = u.endContainer;
            h && !h.getParent().equals(e);
          ...
          if (!h || !m) return !1;
          for (var q = h, h = [], t = !1; !t; )
            q.equals(m) && (t = !0), h.push(q), (q = q.getNext());
          ...
          for (
            var q = d.isIndent ? 1 : -1,
              m = h[0],
              h = h[h.length - 1],
              t = CKEDITOR.plugins.list.listToArray(e, g),
              w = t[h.getCustomData("listarray_index")].indent,
              m = m.getCustomData("listarray_index");
            m <= h.getCustomData("listarray_index");
            m++
          )
            if (((t[m].indent += q), 0 < q)) {
              var v = t[m].parent;
              t[m].parent = new CKEDITOR.dom.element(
                v.getName(),
                v.getDocument()
              );
            }
          for (
            m = h.getCustomData("listarray_index") + 1;
            m < t.length && t[m].indent > w;
            m++
          )
            t[m].indent += q;
          h = CKEDITOR.plugins.list.arrayToList(
            t,
            g,
            null,
            a.config.enterMode,
          ...
          if (!d.isIndent) {
            ...
            if ((x = e.getParent()) && x.is("li"))
              for (
                var q = h.listNode.getChildren(), B = [], D, m = q.count() - 1;
                0 <= m;
                m--
              )
                (D = q.getItem(m)) && D.is && D.is("li") && B.push(D);
          }
          ...
          if (B && B.length)
            for (m = 0; m < B.length; m++) {
              for (
                D = e = B[m];
                (D = D.getNext()) && D.is && D.getName() in k;

              )
                CKEDITOR.env.needsNbspFiller &&
                  !e.getFirst(b) &&
                  e.append(u.document.createText(" ")),
                  e.append(D);
              e.insertAfter(x);
            }
        ...
        for (
          ...
          for (
            var q = u.getCommonAncestor();
            q && (q.type != CKEDITOR.NODE_ELEMENT || !k[q.getName()]);
          ...
          q ||
            ((q = u.startPath().contains(k)) &&
              u.setEndAt(q, CKEDITOR.POSITION_BEFORE_END));
          if (!q) {
            var t = u.getEnclosedNode();
            t &&
              t.type == CKEDITOR.NODE_ELEMENT &&
              t.getName() in k &&
              (u.setStartAt(t, CKEDITOR.POSITION_AFTER_START),
              u.setEndAt(t, CKEDITOR.POSITION_BEFORE_END),
              (q = t));
          }
          q &&
            u.startContainer.type == CKEDITOR.NODE_ELEMENT &&
            u.startContainer.getName() in k &&
            ((t = new CKEDITOR.dom.walker(u)),
            (t.evaluator = e),
            (u.startContainer = t.next()));
          q &&
            u.endContainer.type == CKEDITOR.NODE_ELEMENT &&
            u.endContainer.getName() in k &&
            ((t = new CKEDITOR.dom.walker(u)),
            (t.evaluator = e),
            (u.endContainer = t.previous()));
          if (q) return c(q);
        }
        return 0;
      }
              ...
              refresh: this.isIndent
                ? function (a, b) {
                    var c = this.getContext(b),
                      d = CKEDITOR.plugins.indentList.firstItemInPath(
                        this.context,
                        b,
                        c
                      );
    ...
    (function () {
      function a(a, b, c) {
        function d(c) {
          if (
            !(
              !(l = k[c ? "getFirst" : "getLast"]()) ||
              (l.is && l.isBlockBoundary()) ||
              !(m = b.root[c ? "getPrevious" : "getNext"](
            ...
            a.document
              .createElement("br")
              [c ? "insertBefore" : "insertAfter"](l);
        }
        for (
          var f = CKEDITOR.plugins.list.listToArray(b.root, c), e = [], g = 0;
          g < b.contents.length;
          g++
        ) {
          var h = b.contents[g];
      ...
      function b(a, b, c, d) {
        for (var f, e; (f = a[d ? "getLast" : "getFirst"](u)); )
          (e = f.getDirection(1)) !== b.getDirection(1) &&
            f.setAttribute("dir", e),
            f.remove(),
      ...
      function k(a, d, f) {
        ...
        l
          ? (l = l.getBogus()) && l.remove()
          : u && (l = u.getPrevious(g)) && n(l) && l.remove();
        (l = e.getLast()) &&
          l.type == CKEDITOR.NODE_ELEMENT &&
          l.is("br") &&
          l.remove();
        (l = d.startContainer.getChild(d.startOffset))
          ? e.insertBefore(l)
          : d.startContainer.append(e);
        v &&
          (e = m(v)) &&
          (k.contains(v) ? (b(e, v.getParent(), v), e.remove()) : k.append(e));
        for (; f.checkStartOfBlock() && f.checkEndOfBlock(); ) {
          ...
          e.is("li") &&
            ((k = e.getParent()),
            e.equals(k.getLast(g)) && e.equals(k.getFirst(g)) && (e = k));
        ...
        (f = f.next()) &&
          f.type == CKEDITOR.NODE_ELEMENT &&
          f.getName() in CKEDITOR.dtd.$list &&
          c(f);
        d.moveToBookmark(h);
        d.select();
        a.fire("saveSnapshot");
      ...
      CKEDITOR.plugins.list = {
        listToArray: function (a, b, c, d, e) {
          ...
          for (var g = 0, h = a.getChildCount(); g < h; g++) {
            ...
            k.type == CKEDITOR.NODE_ELEMENT &&
              ...
              CKEDITOR.plugins.list.listToArray(k, b, c, d + 1);
            if ("li" == k.$.nodeName.toLowerCase()) {
              var l = { parent: a, indent: d, element: k, contents: [] };
              e
                ? (l.grandparent = e)
                : ((l.grandparent = a.getParent()),
                  l.grandparent &&
                    "li" == l.grandparent.$.nodeName.toLowerCase() &&
              ...
              c.push(l);
              for (var m = 0, n = k.getChildCount(), u; m < n; m++)
                (u = k.getChild(m)),
                  u.type == CKEDITOR.NODE_ELEMENT && f[u.getName()]
        ...
        arrayToList: function (a, b, c, d, e) {
          ...
          for (
            var h,
              k = a[c].parent.getDocument(),
              m = new CKEDITOR.dom.documentFragment(k),
              n = null,
              u = c,
            ...
            if (G.indent == v) {
              (n && a[u].parent.getName() == n.getName()) ||
                ((n = a[u].parent.clone(!1, 1)),
                e && n.setAttribute("dir", e),
                m.append(n));
              D = n.append(G.element.clone(0, 1));
              F != n.getDirection(1) && D.setAttribute("dir", F);
              for (h = 0; h < G.contents.length; h++)
                D.append(G.contents[h].clone(1, 1));
              u++;
            } else if (G.indent == Math.max(v, 0) + 1)
              (G = a[u - 1].element.getDirection(1)),
                (u = CKEDITOR.plugins.list.arrayToList(
                  a,
                  null,
                  u,
                  d,
                ...
                !D.getChildCount() &&
                  CKEDITOR.env.needsNbspFiller &&
                  7 >= k.$.documentMode &&
                  D.append(k.createText(" ")),
                D.append(u.listNode),
                (u = u.nextIndex);
            else if (-1 == G.indent && !c && h) {
              f[h.getName()]
                ? ((D = G.element.clone(!1, !0)),
                  F != h.getDirection(1) && D.setAttribute("dir", F))
                : (D = new CKEDITOR.dom.documentFragment(k));
              var n = h.getDirection(1) != F,
                ...
                R =
                  ...
                  (d != CKEDITOR.ENTER_BR || n || H || N),
                P,
                T = G.contents.length,
                O;
              for (h = 0; h < T; h++)
                if (((P = G.contents[h]), l(P) && 1 < T))
                  R ? (O = P.clone(1, 1)) : D.append(P.clone(1, 1));
                else if (
                  ...
                  R
                    ? (E ||
                        ((E = k.createElement(I)),
                        D.append(E),
                        n && E.setAttribute("dir", F)),
                      H && E.setAttribute("style", H),
                      N && E.setAttribute("class", N),
                      O && (E.append(O), (O = null)),
                      E.append(P.clone(1, 1)))
                    : D.append(P.clone(1, 1));
          ...
          if (b)
            for (a = m.getFirst(); a; ) {
              if (
                ...
                a.getName() in CKEDITOR.dtd.$listItem &&
                  ((c = a), (k = e = d = void 0), (d = c.getDirection())))
              ) {
                for (e = c.getParent(); e && !(k = e.getDirection()); )
                  e = e.getParent();
        ...
        exec: function (b) {
          ...
          for (
            ...
            x.type == CKEDITOR.NODE_ELEMENT &&
              "td" == x.getName() &&
              l.setStartAt(u.startNode, CKEDITOR.POSITION_AFTER_START);
            B.type == CKEDITOR.NODE_ELEMENT &&
              "td" == B.getName() &&
              l.setEndAt(u.endNode, CKEDITOR.POSITION_BEFORE_END);
            l = l.createIterator();
            for (
              l.forceBrBreak = this.state == CKEDITOR.TRISTATE_OFF;
              (u = l.getNextParagraph());

            )
              if (!u.getCustomData("list_block")) {
                CKEDITOR.dom.element.setMarker(m, u, "list_block", 1);
                for (
                  var D = b.elementPath(u),
                    x = D.elements,
                    B = 0,
                    D = D.blockLimit,
                    F,
                  ...
                  if (f[F.getName()] && D.contains(F)) {
                    ...
                    (x = F.getCustomData("list_group_object"))
                      ? x.contents.push(u)
                      : ((x = { root: F, contents: [u] }),
                        k.push(x),
                        CKEDITOR.dom.element.setMarker(
                ...
                B ||
                  ((B = D),
                  B.getCustomData("list_group_object_" + n)
                    ? B.getCustomData("list_group_object_" + n).contents.push(u)
                    : ((x = { root: B, contents: [u] }),
                      CKEDITOR.dom.element.setMarker(
                        m,
                        B,
                        "list_group_object_" + n,
                        x
                      ),
                      k.push(x)));
              }
          ...
          for (F = []; 0 < k.length; )
            if (((x = k.shift()), this.state == CKEDITOR.TRISTATE_OFF))
              if (f[x.root.getName()]) {
                ...
                D = [];
                for (u = 0; u < n.contents.length; u++)
                  (E = n.contents[u]),
                    (E = E.getAscendant("li", !0)) &&
                      !E.getCustomData("list_item_processed") &&
                      (D.push(E),
                      CKEDITOR.dom.element.setMarker(
                        x,
                        E,
                ...
                for (
                  var E = n.root.getDocument(), I = void 0, G = void 0, u = 0;
                  u < D.length;
                  u++
                ) {
                  ...
                  I.is(this.type) ||
                    ...
                    I.copyAttributes(G, { start: 1, type: 1 }),
                    G.removeStyle("list-style-type"),
                    (B[L].parent = G));
                }
                x = CKEDITOR.plugins.list.arrayToList(
                  B,
                  x,
                  null,
                  h.config.enterMode
                ...
                for (u = 0; u < D && (B = x.listNode.getChild(u)); u++)
                ...
                1 == D.length &&
                  ...
                  D[0].moveChildren && D[0].moveChildren(x),
                  D[0].append(x),
                  (D[0] = x));
                l = l.contents[0].getParent();
                for (E = 0; E < D.length; E++)
                  l = l.getCommonAncestor(D[E].getParent());
              ...
              if ("wysiwyg" == a.mode && c in { 8: 1, 46: 1 }) {
                ...
                if (h && h.collapsed) {
                  ...
                  if (u) {
                    var x;
                    (x = l.contains(f)) &&
                    h.checkBoundaryOfElement(x, CKEDITOR.START) &&
                    (x = x.getParent()) &&
                    x.is("li") &&
                    (x = m(x))
                      ? ((e = x),
                      ...
                      : (C.range.setStartAt(v, CKEDITOR.POSITION_AFTER_START),
                        C.range.setEnd(h.startContainer, h.startOffset),
                        (x = C.previous()) &&
                          x.type == CKEDITOR.NODE_ELEMENT &&
                          (x.getName() in f || x.is("li")) &&
                          (x.is("li") ||
                            (C.range.selectNodeContents(x),
                            C.reset(),
                            (C.evaluator = d),
                            (x = C.previous())),
                          (e = x),
                    ...
                    if (e) k(a, c, h), b.cancel();
                      ...
                      var B = l.contains(f);
                      B &&
                        h.checkBoundaryOfElement(B, CKEDITOR.START) &&
                        ((e = B.getFirst(g)),
                        h.checkBoundaryOfElement(e, CKEDITOR.START) &&
                          ((x = B.getPrevious(g)),
                          m(e)
                            ? x && (h.moveToElementEditEnd(x), h.select())
                            : a.execCommand("outdent"),
                          b.cancel()));
                    }
                  } else if ((e = l.contains("li"))) {
                    if (
                      (C.range.setEndAt(v, CKEDITOR.POSITION_BEFORE_END),
                      (u = (v = e.getLast(g)) && d(v) ? v : e),
                      (l = 0),
                      (x = C.next()) &&
                      x.type == CKEDITOR.NODE_ELEMENT &&
                      x.getName() in f &&
                      x.equals(v)
                        ? ((l = 1), (x = C.next()))
                        : h.checkBoundaryOfElement(u, CKEDITOR.END) && (l = 2),
                      l && x)
                    ) {
                      h = h.clone();
                      ...
                      if (
                        1 == l &&
                        (c.optimize(), !c.startContainer.equals(e))
                      ) {
                    ...
                    C.range.setEndAt(v, CKEDITOR.POSITION_BEFORE_END),
                      (x = C.next()) &&
                        ...
                        x.is(f) &&
                        ((x = x.getFirst(g)),
                        l.block && h.checkStartOfBlock() && h.checkEndOfBlock()
                          ? (l.block.remove(),
                            h.moveToElementEditStart(x),
                            h.select())
                          : m(x)
                          ? (h.moveToElementEditStart(x), h.select())
                          : ((h = h.clone()),
                            h.moveToElementEditStart(x),
                            k(a, c, h)),
                        b.cancel());
    ...
    (function () {
      function a(a, b, c) {
        ...
        "wysiwyg" == a.mode &&
          ...
          a.elementPath().isContextFor("p") ||
            ((b = CKEDITOR.ENTER_BR), (c = 1)),
          a.fire("saveSnapshot"),
          b == CKEDITOR.ENTER_BR ? m(a, b, null, c) : f(a, b, null, c),
          a.fire("saveSnapshot"));
      }
      function e(a) {
      ...
      CKEDITOR.plugins.enterkey = {
        enterBlock: function (a, f, k, v) {
          if ((k = k || e(a))) {
            ...
            if (q && t) {
              if (y && (y.is("li") || y.getParent().is("li"))) {
                ...
                if (z.is("li"))
                  v || r
                    ? (v && r && k.remove(),
                      y[r ? "insertAfter" : "insertBefore"](z))
                    : y.breakParent(z);
                else {
                  if (a)
                    if (
                      (p.block.is("li")
                        ? ((z = u.createElement(
                          ...
                          x && z.setAttribute("dir", q),
                          C && z.setAttribute("style", C),
                          t && z.setAttribute("class", t),
                          y.moveChildren(z))
                        : (z = p.block),
                      v || r)
                    )
                      z[v ? "insertBefore" : "insertAfter"](k);
                    else y.breakParent(k), z.insertAfter(k);
                  else if ((y.appendBogus(!0), v || r))
                    for (; (u = y[v ? "getFirst" : "getLast"]()); )
                      u[v ? "insertBefore" : "insertAfter"](k);
                  else
                    for (y.breakParent(k); (u = y.getLast()); )
                      u.insertAfter(k);
                  y.remove();
                }
                A.selectBookmarks(w);
              ...
              if (y && y.getParent().is("blockquote")) {
                ...
                y.getPrevious().getFirst(CKEDITOR.dom.walker.invisible(1)) ||
                  y.getPrevious().remove();
                y.getNext().getFirst(CKEDITOR.dom.walker.invisible(1)) ||
                  y.getNext().remove();
            ...
            if ((q = k.splitBlock(A))) {
              ...
              y
                ? ((w = y.getParent()),
                  w.is("li") && (y.breakParent(w), y.move(y.getNext(), 1)))
                : f &&
                  (w = f.getParent()) &&
                  w.is("li") &&
                  (f.breakParent(w),
                  (w = f.getNext()),
                  k.moveToElementEditStart(w),
                  f.move(f.getPrevious()));
              if (p || a) {
                if (f) {
                  if (f.is("li") || (!h.test(f.getName()) && !f.is("pre")))
                    z = f.clone();
                } else y && (z = y.clone());
                z
                  ? v && !z.is("li") && z.renameNode(A)
                  : w && w.is("li")
                  ? (z = w)
                  : ((z = u.createElement(A)),
                    f && (r = f.getDirection()) && z.setAttribute("dir", r));
                if ((u = q.elementPath))
                  for (v = 0, A = u.elements.length; v < A; v++) {
                    w = u.elements[v];
                    if (w.equals(u.block) || w.equals(u.blockLimit)) break;
                    CKEDITOR.dtd.$removeEmpty[w.getName()] &&
                      ((w = w.clone()), z.moveChildren(w), z.append(w));
                  }
                z.appendBogus();
                ...
                !CKEDITOR.env.ie ||
                  !p ||
                  (a && f.getChildCount()) ||
                  (k.moveToElementEditStart(a ? f : z), k.select());
        ...
        enterBr: function (a, b, c, d) {
          if ((c = c || e(a))) {
            var k = c.document,
              m = c.checkEndOfBlock(),
              t = new CKEDITOR.dom.elementPath(
              ...
              ? (!d && m && h.test(y)
                  ? (m = p.getDirection())
                    ? ((k = k.createElement("div")),
                      k.setAttribute("dir", m),
                      k.insertAfter(p),
                      c.setStart(k, 0))
                    : (k.createElement("br").insertAfter(p),
                      CKEDITOR.env.gecko && k.createText("").insertAfter(p),
                      c.setStartAt(
                        p.getNext(),
                        CKEDITOR.env.ie
                          ? CKEDITOR.POSITION_BEFORE_START
                  ...
                  : ((a =
                      "pre" == y && CKEDITOR.env.ie && 8 > CKEDITOR.env.version
                        ? k.createText("\r")
                        : k.createElement("br")),
                    c.deleteContents(),
                    c.insertNode(a),
    ...
    (function () {
      ...
      CKEDITOR.plugins.add("entities", {
        afterInit: function (e) {
          ...
          function c(a) {
            return "force" != d.entities_processNumerical && m[a]
              ? m[a]
              : "\x26#" + a.charCodeAt(0) + ";";
          }
          var d = e.config;
    ...
    (function () {
      ...
      function b() {
        ...
        var d =
            c.config["filebrowser" + e(b.getName()) + "WindowWidth"] ||
            c.config.filebrowserWindowWidth ||
            "80%",
          b =
            c.config["filebrowser" + e(b.getName()) + "WindowHeight"] ||
        ...
        c.popup(
          ...
          d,
          b,
          c.config.filebrowserWindowFeatures ||
            c.config.fileBrowserWindowFeatures
        );
      }
      function c() {
      ...
      function k(a, f, g, m) {
        if (m && m.length)
          for (var v, u = m.length; u--; )
            if (
              ((v = m[u]),
              ("hbox" != v.type && "vbox" != v.type && "fieldset" != v.type) ||
                k(a, f, g, v.children),
              v.filebrowser)
            )
              if (
                ("string" == typeof v.filebrowser &&
                  (v.filebrowser = {
                ...
                void 0 === q &&
                  ((q = a.config["filebrowser" + e(f) + "BrowseUrl"]),
                  void 0 === q && (q = a.config.filebrowserBrowseUrl));
                q &&
                  ((v.onClick = b), (v.filebrowser.url = q), (v.hidden = !1));
              } else if (
                "QuickUpload" == v.filebrowser.action &&
                v["for"] &&
                ((q = v.filebrowser.url),
                void 0 === q &&
                  ((q = a.config["filebrowser" + e(f) + "UploadUrl"]),
                  void 0 === q && (q = a.config.filebrowserUploadUrl)),
                q)
              ) {
                var t = v.onClick;
                ...
                d(
                  a,
                  g.getContents(v["for"][0]).get(v["for"][1]),
                  v.filebrowser
                );
              }
      }
          ...
          if (!f || !1 !== f.call(this._.filebrowserSe, a, b))
            if (
              ...
              a &&
                ...
                (c = d.getDialog()),
                (d = d.filebrowser.target || null)))
            )
              if (((d = d.split(":")), (f = c.getContentElement(d[0], d[1]))))
                f.setValue(a), c.selectPage(d[0]);
      }
      ...
      CKEDITOR.on("dialogDefinition", function (a) {
        if (a.editor.plugins.filebrowser)
          for (var b = a.data.definition, c, d = 0; d < b.contents.length; ++d)
            if ((c = b.contents[d]))
              k(a.editor, a.data.name, b, c.elements),
                c.hidden &&
                  c.filebrowser &&
            ...
            return function (f) {
              if ((l = a.editable())) {
                ...
                k
                  ? (A + w <= p.top
                      ? g("top")
                      : A + w > y.height - p.bottom
                      ? g("pin")
                      : g("bottom"),
                    (f = y.width / 2),
                    (f = d.floatSpacePreferRight
                      ? "right"
                      : 0 < p.left && p.right < y.width && p.width > t.width
                      ? "rtl" == d.contentsLangDirection
                        ? "right"
                        : "left"
                      : f - p.left > p.right - f
                      ? "left"
    ...
    (function () {
      var a =
        ...
        ' title\x3d"{title}" tabindex\x3d"-1" hidefocus\x3d"true" role\x3d"button" aria-labelledby\x3d"{id}_label" aria-haspopup\x3d"{hasArrow}" aria-disabled\x3d"{ariaDisabled}"';
      CKEDITOR.env.gecko &&
        CKEDITOR.env.mac &&
      ...
      var a =
        ...
        a =
          a +
          '\x3e\x26nbsp;\x3c/span\x3e\x3cspan id\x3d"{id}_label" class\x3d"cke_button_label cke_button__{name}_label" aria-hidden\x3d"false"\x3e{label}\x3c/span\x3e{arrowHtml}\x3c/a\x3e',
        e = CKEDITOR.addTemplate(
          "buttonArrow",
        ...
        render: function (a, d) {
          ...
          if (this.modes) {
            ...
            l &&
              ...
              (h +=
                l.state == CKEDITOR.TRISTATE_ON
                  ? "on"
                  : l.state == CKEDITOR.TRISTATE_DISABLED
                  ? "disabled"
                  : "off"));
          if (this.directional)
            a.on(
          ...
          h = {
            ...
            title: this.title,
            titleJs:
              m.gecko && !m.hc ? "" : (this.title || "").replace("'", ""),
        ...
        proto: {
          ...
          render: function (a, c) {
            ...
            k = {
              ...
              cls: this.className || "",
              titleJs:
                k.gecko && !k.hc ? "" : (this.title || "").replace("'", ""),
              keydownFn: g,
              focusFn: n,
              clickFn: f,
            };
      ...
      init: function (a) {
        if (!a.blockless) {
          for (
            ...
            if (!a.filter.customConfig || a.filter.check(l))
              k++,
                (d[h] = l),
    ...
    (CKEDITOR.htmlWriter = CKEDITOR.tools.createClass({
      ...
      $: function () {
        ...
        var a = CKEDITOR.dtd,
          e;
        for (e in CKEDITOR.tools.extend(
          {},
          a.$nonBodyContent,
          a.$block,
          a.$listItem,
      ...
      proto: {
        openTag: function (a) {
          ...
          this._.indent
            ? this.indentation()
            : e && e.breakBeforeOpen && (this.lineBreak(), this.indentation());
          this._.output.push("\x3c", a);
        ...
        attribute: function (a, e) {
          "string" == typeof e &&
            (this.forceSimpleAmpersand && (e = e.replace(/&amp;/g, "\x26")),
        ...
        closeTag: function (a) {
          ...
          this._.indent
            ? this.indentation()
            : e && e.breakBeforeClose && (this.lineBreak(), this.indentation());
          this._.output.push("\x3c/", a, "\x3e");
          "pre" == a && (this._.inPre = 0);
          e &&
            e.breakAfterClose &&
            (this.lineBreak(), (this._.needsSpace = e.needsSpace));
    ...
    (function () {
      ...
      CKEDITOR.editor.prototype.createFakeParserElement = function (
        ...
        h &&
          ...
          (d = h.width),
          (h = h.height),
          void 0 !== d && (a.rules.width = b(d)),
          void 0 !== h && (a.rules.height = b(h)),
          a.populate(c));
      ...
      CKEDITOR.plugins.add("link", {
        ...
        init: function (a) {
          ...
          a.on(
            ...
            function (b) {
              var c =
                CKEDITOR.plugins.link.getSelectedLink(a) || b.data.element;
              c.isReadOnly() ||
                (c.is("a")
                  ? ((b.data.dialog =
                      !c.getAttribute("name") ||
      ...
      CKEDITOR.plugins.link = {
        getSelectedLink: function (a) {
          ...
          return c && c.is("a")
            ...
            ? (b.shrink(CKEDITOR.SHRINK_TEXT),
              a.elementPath(b.getCommonAncestor()).contains("a", 1))
            : null;
        },
        getEditorAnchors: function (a) {
          ...
          for (f = 0; (e = c.getItem(f++)); )
            (e = this.tryRestoreFakeAnchor(a, e)) &&
              d.push({
        ...
        parseLinkAttributes: function (a, b) {
          ...
          c.match(d) &&
            ("encode" == r
              ...
              : r &&
                c.replace(v, function (a, b, c) {
                  if (b == e.name) {
                    C.type = "email";
                    a = C.email = {};
                    b = /(^')|('$)/g;
                    c = c.match(/[^,\s]+/g);
                    for (var d = c.length, f, h, g = 0; g < d; g++)
          ...
          if (b) {
            if ((c = b.getAttribute("target")))
              C.target = { type: c.match(g) ? c : "frame", name: c };
            else if (
              (c =
              ...
              for (
                C.target = { type: "popup", name: c[1] };
                (r = q.exec(c[2]));

              )
                ("yes" != r[2] && "1" != r[2]) ||
                r[1] in { height: 1, width: 1, top: 1, left: 1 }
                  ? isFinite(r[2]) && (C.target[r[1]] = r[2])
                  : (C.target[r[1]] = !0);
            var c = {},
              B;
        ...
        getLinkAttributes: function (c, d) {
          ...
          switch (d.type) {
            ...
            case "anchor":
              ...
              h["data-cke-saved-href"] =
                "#" + ((d.anchor && d.anchor.name) || f || "");
              break;
            case "email":
              var k = d.email,
                g = k.address;
      ...
      CKEDITOR.removeAnchorCommand.prototype = {
        exec: function (a) {
          ...
          if (
            ...
            (d.getChildCount()
              ? d.is("a")
              : CKEDITOR.plugins.link.tryRestoreFakeAnchor(a, d))
          )
            d.remove(1);
    ...
    (function () {
      ...
      function d(a, b, c) {
        return (b = b[c ? "getPrevious" : "getNext"](function (b) {
          return (
            (b && b.type == CKEDITOR.NODE_TEXT && !Z(b)) ||
            (n(b) && !v(b) && !g(a, b))
          );
        }));
      }
        ...
        B(c, {
              ...
              ),
              {
                base:
                  ...
                  (E.hc
                    ...
                    : "") +
                  (E.hidpi ? "background-size: 9px 10px;" : ""),
                looks: [
          ...
          mouseNear: function () {
            ...
            var b = a.holdDistance,
              c = this.size;
            return c &&
              k(a.mouse.y, c.top - b, c.bottom + b) &&
              k(a.mouse.x, c.left - b, c.right + b)
              ? !0
              : !1;
          },
          place: function () {
            ...
            g.equals(c)
              ? ((l.left = b.scroll.x), (l.right = -b.scroll.x), (l.width = ""))
              : ((l.left =
                  h.size.left -
                  h.size.margin.left +
                  b.scroll.x -
            ...
            f && e
              ? (l.top =
                  f.size.margin.bottom === e.size.margin.top
                    ? 0 | (f.size.bottom + f.size.margin.bottom / 2)
                    : f.size.margin.bottom < e.size.margin.top
                    ? f.size.bottom + f.size.margin.bottom
                    : f.size.bottom + f.size.margin.bottom - e.size.margin.top)
              : f
              ? e || (l.top = f.size.bottom + f.size.margin.bottom)
              : (l.top = e.size.top - e.size.margin.top);
            d.is(T) || k(l.top, b.scroll.y - 15, b.scroll.y + 5)
              ? ((l.top = a.inInlineMode ? 0 : b.scroll.y), this.look(T))
              : d.is(O) || k(l.top, b.pane.bottom - 5, b.pane.bottom + 15)
              ? ((l.top = a.inInlineMode
                  ? b.editable.height +
                ...
                this.look(O))
              : (a.inInlineMode &&
                  (l.top -= b.editable.top + b.editable.border.top),
                this.look(J));
            a.inInlineMode &&
              (l.top--,
              (l.top += b.editable.scroll.top),
              (l.left += b.editable.scroll.left));
        ...
        c.lineChildren[0].on("mouseup", function (b) {
          ...
          h(
            ...
            function (b) {
              ...
              b[c.is(N) ? "insertBefore" : "insertAfter"](
                c.is(N) ? c.lower : c.upper
              );
            },
            !0
          );
      ...
      function h(a, b, c) {
        var d = new CKEDITOR.dom.range(a.doc),
          f = a.editor,
          e;
        E.ie && a.enterMode == CKEDITOR.ENTER_BR
          ? (e = a.doc.createText(ca))
          : ((e =
              ((e = m(a.element, !0)) && e.data("cke-enter-mode")) ||
              a.enterMode),
            (e = new D(L[e], a.doc)),
            e.is("br") || a.doc.createText(ca).appendTo(e));
          ...
          exec: (function () {
            ...
            return function (e) {
              ...
              if (
                ...
                h.is(K) &&
                (!d(a, h, !c) ||
                  ((g = d(a, h, !c)) && n(g) && g.is(a.triggers)))
                  ? f(h)
                  : ((g = b(a, e)),
                    n(g) &&
                      (d(a, g, !c)
                        ? (e = d(a, g, !c)) && n(e) && e.is(a.triggers) && f(g)
                        : f(g)));
              }
            };
          })(),
      ...
      function y(a) {
        ...
        var h =
            c.y >
            (a.inInlineMode
              ? d.editable.top + d.editable.height / 2
              : Math.min(d.editable.height, d.pane.height) / 2),
        ...
        r(a, b);
        return !h && 0 <= b.size.top && k(c.y, 0, b.size.top + f)
          ? ((a = a.inInlineMode || 0 === d.scroll.y ? T : J),
            new e([null, b, N, P, a]))
          : h &&
            b.size.bottom <= d.pane.height &&
            k(c.y, b.size.bottom - f, d.pane.height)
          ? ((a =
              a.inInlineMode ||
              k(b.size.bottom, d.pane.height - f, d.pane.height)
                ? O
                : J),
            new e([b, null, H, P, a]))
          : null;
      ...
      function A(a) {
        ...
        if (t) {
          ...
          g.equals(a.editable[u ? "getLast" : "getFirst"](a.isRelevant))
            ? (w(a),
              u &&
              k(c.y, g.size.bottom - h, f.pane.height) &&
              k(g.size.bottom, f.pane.height - h, f.pane.height)
                ? (m = O)
                : k(c.y, 0, g.size.top + h) && (m = T))
            : (m = J),
            (l = [null, g]
              [u ? "reverse" : "concat"]()
              .concat([
      ...
      function z(a, b, c, d) {
        for (
          ...
          (e[ba[l]] =
            parseInt(
              b.getComputedStyle.call(b, "border-" + ba[l] + "-width"),
              10
            ) || 0),
            (g[ba[l]] =
              parseInt(b.getComputedStyle.call(b, "padding-" + ba[l]), 10) ||
              0),
            (h[ba[l]] =
              parseInt(b.getComputedStyle.call(b, "margin-" + ba[l]), 10) || 0);
        (c && !d) || C(a, d);
        ...
        return B({ border: e, padding: g, margin: h, ignoreScroll: c }, k, !0);
      }
      function r(a, b, c) {
        if (!n(b)) return (b.size = null);
        if (!b.size) b.size = {};
        else if (b.size.ignoreScroll == c && b.size.date > new Date() - S)
          return null;
        return B(b.size, z(a, b, c), { date: +new Date() }, !0);
      }
      function w(a, b) {
      ...
      function x(a, b, c, d) {
        for (
          ...
          k || (k = b(f, d));
          l || (l = b(h, d));
          !k && 0 < n.y - g && (f = c(a, { x: n.x, y: n.y - g }));
          !l && n.y + g < m && (h = c(a, { x: n.x, y: n.y + g }));
          if (k && l) break;
          g += 2;
        }
        ...
        init: function (a) {
          ...
          a.on(
            ...
            function () {
              ...
              m.boundary = m.inInlineMode
                ? m.editable
                : m.doc.getDocumentElement();
              k.is(G.$inline) ||
                (m.inInlineMode &&
                  !u(k) &&
                ...
                k.attachListener(
                  m.inInlineMode ? n : n.getWindow().getFrame(),
                  "mouseout",
                  function (b) {
                    if ("wysiwyg" == a.mode)
                      if (m.inInlineMode) {
                        ...
                        (c > d.left - f.x &&
                          ...
                          b > d.top - f.y &&
                          b < d.bottom - f.y) ||
                          (clearTimeout(r), (r = null), m.line.detach());
                    ...
                    if ("wysiwyg" == a.mode && !a.readOnly && !r) {
                      ...
                      r = setTimeout(function () {
                        ...
                        p &&
                          ...
                          !m.line.mouseNear() &&
                          (m.element = da(m, !0)) &&
                          ((m.trigger = y(m) || A(m) || ga(m)) &&
                          !t(m, m.trigger.upper || m.trigger.lower)
                            ? m.line.attach().place()
                            : ((m.trigger = null), m.line.detach()),
                          (p = !1));
                      }, 30);
                    }
                  }
                ...
                k.attachListener(I ? n : v, "mousedown", function () {
                  "wysiwyg" == a.mode &&
                    (m.line.detach(), (m.hiddenMode = 1), (m.mouseDown = 1));
                }),
                k.attachListener(I ? n : v, "mouseup", function () {
                  m.hiddenMode = 0;
                  m.mouseDown = 0;
                }),
                a.addCommand("accessPreviousSpace", l(m)),
                a.addCommand("accessNextSpace", l(m, !0)),
                a.setKeystroke([
                ...
                a.on("loadSnapshot", function () {
                  ...
                  for (f in { p: 1, br: 1, div: 1 })
                    for (
                      b = a.document.getElementsByTag(f), d = b.count();
                      d--;
        ...
        ga = (function () {
          function b(f) {
            ...
            if (h && e.contains(h))
              ...
              h = e.getFirst(function (a) {
                return d(f, a);
              });
            if (g && e.contains(g))
              for (; !g.getParent().equals(e); ) g = g.getParent();
            else
              g = e.getLast(function (a) {
                return d(f, a);
              });
            if (!h || !g) return null;
            r(f, h);
            ...
            for (
              var e = Number.MAX_VALUE, m, q, u, p;
              g && !g.equals(h) && (q = h.getNext(f.isRelevant));

            )
              (m = Math.abs(c(f, h, q) - f.mouse.y)),
                m < e && ((e = m), (u = h), (p = q)),
                (h = q),
                r(f, h);
            if (!u || !p || !k(f.mouse.y, u.size.top, p.size.bottom))
              return null;
            l.upper = u;
            l.lower = p;
            return l.set(R, 8);
              ...
              exec: function () {
                ...
                if (this.state == CKEDITOR.TRISTATE_OFF) {
                  ...
                  for (p = a.container; (p = p.getParent()); )
                    p.setCustomData("maximize_saved_styles", b(p)),
                      p.setStyle("z-index", a.config.baseFloatZIndex - 5);
                  ...
                  q.setStyles({ left: -1 * t.x + "px", top: -1 * t.y + "px" });
                  CKEDITOR.env.gecko && d(a);
                } else if (this.state == CKEDITOR.TRISTATE_ON) {
                  l.removeListener("resize", e);
                  for (var p = [t, q], A = 0; A < p.length; A++)
                    c(p[A], p[A].getCustomData("maximize_saved_styles")),
                      p[A].removeCustomData("maximize_saved_styles");
                  for (p = a.container; (p = p.getParent()); )
                    c(p, p.getCustomData("maximize_saved_styles")),
                      p.removeCustomData("maximize_saved_styles");
                  CKEDITOR.env.ie
                    ? setTimeout(function () {
                        l.$.scrollTo(v.x, v.y);
                      }, 0)
                ...
                if ((p = this.uiItems[0]))
                  (t =
                    this.state == CKEDITOR.TRISTATE_OFF
                      ? f.maximize.maximize
                      : f.maximize.minimize),
                    (p = CKEDITOR.document.getById(p._.id)),
                    p.getChild(1).setHtml(t),
                    p.setAttribute("title", t),
                    p.setAttribute("href", 'javascript:void("' + t + '");');
                "wysiwyg" == a.mode
                  ? g
                    ? (CKEDITOR.env.gecko && d(a),
                      a.getSelection().selectRanges(g),
                      (y = a.getSelection().getStartElement()) &&
                        y.scrollIntoView(!0))
                    : l.$.scrollTo(n.x, n.y)
                  : (g && ((y.selectionStart = g[0]), (y.selectionEnd = g[1])),
                    (y.scrollLeft = n[0]),
                    (y.scrollTop = n[1]));
                g = n = null;
                u = this.state;
      ...
      function a(a, c, d) {
        ...
        e
          ...
          : ((a = CKEDITOR.getUrl(
            ...
            CKEDITOR.scriptLoader.load(a, d, null, !0));
        return !e;
      }
      function e(a) {
        a.data.type = "html";
          ...
          b.on(
            ...
            function (e) {
              ...
              if (
                f &&
                (c ||
                  /(className=\"?Mso|style=\"[^\"]*\bmso\-|w:WordDocument)/.test(
                    f
                  ))
              ) {
                m.dontFilter = !0;
                var h = a(b, d, function () {
                  if (h) b.fire("paste", m);
                    ...
                    !b.config.pasteFromWordPromptCleanup ||
                    c ||
                    confirm(b.lang.pastefromword.confirmCleanup)
                  )
                    m.dataValue = CKEDITOR.cleanWord(f, b);
                  c = 0;
                });
                h && e.cancel();
              }
    ...
    (function () {
      ...
      CKEDITOR.plugins.add("pastetext", {
        ...
        init: function (e) {
          ...
          e.ui.addButton &&
            e.ui.addButton("PasteText", {
              label: e.lang.pastetext.button,
              command: "pastetext",
              toolbar: "clipboard,40",
            });
          if (e.config.forcePasteAsPlainText)
            e.on("beforePaste", function (a) {
          ...
          exec: function (a) {
            for (
              ...
              var h = f.createBookmark(),
                ...
                n = function (b) {
                  for (
                    var d = a.elementPath(b), f = d.elements, h = 1, g;
                    (g = f[h]) && !g.equals(d.block) && !g.equals(d.blockLimit);
                    h++
                  )
              ...
              if (g)
                for (
                  n(g), l = l.getNextSourceNode(!0, CKEDITOR.NODE_ELEMENT);
                  l && !l.equals(g);
                  ...
                  if (l.isReadOnly()) {
                    ...
                    (n = l.getNextSourceNode(!1, CKEDITOR.NODE_ELEMENT)),
                      ("img" == l.getName() && l.data("cke-realelement")) ||
                        !c(a, l) ||
                        (e.test(l.getName())
                          ? l.remove(1)
                          : (l.removeAttributes(b),
                            a.fire("removeFormatCleanup", l))),
                      (l = n);
              f.moveToBookmark(h);
            }
            a.forceNextSelectionCheck();
    ...
    CKEDITOR.plugins.add("resize", {
      init: function (a) {
        function e(b) {
          ...
          l &&
            (d = Math.max(c.resize_minWidth, Math.min(m, c.resize_maxWidth)));
          g &&
            (e = Math.max(c.resize_minHeight, Math.min(b, c.resize_maxHeight)));
          a.resize(l ? d : null, e);
        }
        function b() {
          ...
          a.document &&
            (a.document.removeListener("mousemove", e),
        ...
        if (!1 !== c.resize_enabled) {
          var m = null,
            ...
            n = CKEDITOR.tools.addFunction(function (d) {
              ...
              a.document &&
                (a.document.on("mousemove", e), a.document.on("mouseup", b));
              d.preventDefault && d.preventDefault();
            });
          a.on("destroy", function () {
    ...
    CKEDITOR.plugins.add("scayt", {
        ...
        a.contextMenu &&
          ...
          (a.contextMenu.addListener(function (b, c) {
            var d = a.scayt,
              ...
              l;
            d &&
              (l = d.getSelectionNode()) &&
              ((h = e.menuGenerator(a, l)),
              d.showBanner(
                "." +
      ...
      addMenuItems: function (a) {
        ...
        for (
          var c = a.config.scayt_contextMenuItemsOrder.split("|"), d = 0;
          d < c.length;
          d++
        )
          c[d] = "scayt_" + c[d];
              ...
              function (c) {
                ...
                if ((b || c) && a._.savedSelection) {
                  ...
                  for (var m = 0; m < c.length; m++)
                    (e = c[m]),
                      "string" === typeof e.startContainer.$.nodeValue &&
                        ((f = e.startContainer.getText().length),
                        (f < e.startOffset || f < e.endOffset) &&
                          a.unlockSelection(!1));
                }
              },
              this,
        ...
        a.on("beforeCommandExec", function (b) {
          ...
          b.data.name in e.options.disablingCommandExec && "wysiwyg" == a.mode
            ...
            : ("bold" !== b.data.name &&
              ...
              !c ||
              ("cut" === b.data.name && ((m = !1), (g = !0)),
              "language" === b.data.name &&
                ((d = (d = a.plugins.language.getCurrentLangElement(a)) && d.$),
                (g = !0)),
        ...
        a.on("readOnly", function (b) {
          ...
          b &&
            ...
            !0 === b.editor.readOnly
              ...
              : c
              ? c.fire("startSpellCheck, startGrammarCheck")
              : "wysiwyg" == b.editor.mode &&
                !0 === e.state.scayt[b.editor.name] &&
                (e.createScayt(a),
        ...
        a.on("reloadMarkupScayt", function (b) {
          ...
          setTimeout(function () {
            ...
            d &&
              ...
              (a.document.fire(
                "keydown",
                new CKEDITOR.dom.event({ keyCode: 37 })
              ),
              b.removeMarkupInSelectionNode(c),
              b.fire("startSpellCheck, startGrammarCheck"));
      ...
      parseConfig: function (a) {
        ...
        if (a.config.scayt_disableOptionsStorage) {
          var e = CKEDITOR.tools.isArray(a.config.scayt_disableOptionsStorage)
      ...
      addRule: function (a) {
        var e = CKEDITOR.plugins.scayt,
          ...
          m = function (b) {
            if (
              a.scayt &&
              (b.hasAttribute(e.options.data_attribute_name) ||
        ...
        b &&
          b.addRules({
            elements: {
              span: function (a) {
                var b =
                    a.hasClass(e.options.misspelled_word_class) &&
                    a.attributes[e.options.data_attribute_name],
                  c =
                    a.hasClass(e.options.problem_grammar_class) &&
        ...
        if (0 < e.length && "no_any_suggestions" !== e[0])
          if (b)
            for (b = 0; b < e.length; b++) {
              ...
              a.addCommand(
                h,
                this.createCommand(CKEDITOR.plugins.scayt.suggestions[b], k, m)
              );
      ...
      menuGenerator: function (a, e) {
        ...
        f
          ? ((c = c.scayt),
            (d = e.getAttribute(b.getScaytNodeAttributeName())),
            b.fire("getSuggestionsList", { lang: m, word: d }),
            (d = this.buildSuggestionMenuItems(
              a,
          ...
          : h &&
            ((c = c.grayt),
            (d = e.getAttribute(b.getGraytNodeAttributeName())),
            (h = b.getProblemDescriptionText(d, m)),
            c.grayt_problemdescription &&
              h &&
              (c.grayt_problemdescription.label = h),
            b.fire("getGrammarSuggestionsList", { lang: m, phrase: d }),
            (d = this.buildSuggestionMenuItems(
              a,
              CKEDITOR.plugins.scayt.suggestions,
              f
        ...
        for (var l in c)
          (f &&
            -1 == CKEDITOR.tools.indexOf(k, l.replace("scayt_", "")) &&
            "all" != a.config.scayt_contextCommands) ||
            ((d[l] =
              "undefined" != typeof c[l].state
                ? c[l].state
                : CKEDITOR.TRISTATE_OFF),
            "function" !== typeof c[l].verification ||
              c[l].verification(a) ||
              delete d[l],
            a.addCommand(l, { exec: c[l].exec }),
            a.addMenuItem(l, {
    ...
    (CKEDITOR.plugins.scayt = {
      ...
      replaceOldOptionsNames: function (a) {
        for (var e in a)
          e in this.backCompatibilityMap &&
            ((a[this.backCompatibilityMap[e]] = a[e]), delete a[e]);
      },
          ...
          d
            ? ((d = {
              ...
              a.config.scayt_serviceHost &&
                (d.service_host = a.config.scayt_serviceHost),
              a.config.scayt_servicePort &&
                (d.service_port = a.config.scayt_servicePort),
              a.config.scayt_servicePath &&
                (d.service_path = a.config.scayt_servicePath),
              "boolean" === typeof a.config.scayt_ignoreAllCapsWords &&
                (d["ignore-all-caps-words"] =
                  a.config.scayt_ignoreAllCapsWords),
              "boolean" === typeof a.config.scayt_ignoreDomainNames &&
                (d["ignore-domain-names"] = a.config.scayt_ignoreDomainNames),
              "boolean" === typeof a.config.scayt_ignoreWordsWithMixedCases &&
                (d["ignore-words-with-mixed-cases"] =
                  a.config.scayt_ignoreWordsWithMixedCases),
              "boolean" === typeof a.config.scayt_ignoreWordsWithNumbers &&
                (d["ignore-words-with-numbers"] =
                  a.config.scayt_ignoreWordsWithNumbers),
              (d = new SCAYT.CKSCAYT(
                d,
                function () {},
        ...
        this.loadingHelper[a.name] ||
          ...
          "function" !== typeof window.SCAYT.CKSCAYT
            ? ((this.loadingHelper[a.name] = e),
              ...
              (d += 0 <= d.indexOf("?") ? "" : "?" + c),
              this.loadingHelper.ckscaytLoading ||
                (CKEDITOR.scriptLoader.load(d, function (a) {
                  if (a) {
                    ...
                    for (var c = 0; c < b.loadingHelper.loadOrder.length; c++) {
                      ...
                      if ("function" === typeof b.loadingHelper[a])
                        b.loadingHelper[a](CKEDITOR.instances[a]);
                      delete b.loadingHelper[a];
                    }
                    b.loadingHelper.loadOrder = [];
                  }
                }),
                (this.loadingHelper.ckscaytLoading = !0)))
            : window.SCAYT &&
              "function" === typeof window.SCAYT.CKSCAYT &&
              (CKEDITOR.fireOnce("scaytReady"),
          ...
          return function () {
            ...
            if (
              ...
              if ((c = "ready" == this.status))
                var e = d.removeMarkupFromString(this.getSnapshot()),
        ...
        a[e] = CKEDITOR.tools.override(a[e], function (a) {
          return function (c) {
            ...
            CKEDITOR.plugins.scayt &&
              ...
              c.editor.scayt &&
              ((this.contents = d.removeMarkupFromString(e) || ""),
              (c.contents = d.removeMarkupFromString(m) || ""));
      ...
      CKEDITOR.plugins.add("showborders", {
        ...
        init: function (e) {
          ...
          e.on("removeFormatCleanup", function (a) {
            a = a.data;
            e.getCommand("showborders").state == CKEDITOR.TRISTATE_ON &&
              a.is("table") &&
          ...
          if (
            ...
            (a.setup = CKEDITOR.tools.override(a.setup, function (a) {
              ...
              (a.commit = CKEDITOR.tools.override(a.commit, function (a) {
                return function (b, e) {
                  a.apply(this, arguments);
                  parseInt(e.getAttribute("border"), 10) ||
                    e.addClass("cke_show_border");
                };
              }));
      });
    })(),
      ...
      CKEDITOR.plugins.add("stylescombo", {
        ...
        init: function (a) {
          ...
          a.on("stylesSet", function (b) {
            if ((b = b.data.styles)) {
              for (var f, h, l, g = 0, n = b.length; g < n; g++)
                ((f = b[g]),
                (a.blockless && f.element in CKEDITOR.dtd.$block) ||
                  ((h = f.name),
                  (f = new CKEDITOR.style(f)),
                  a.filter.customConfig && !a.filter.check(f))) ||
                  ((f._name = h),
                  (f._.enterMode = e.enterMode),
                  (f._.type = l = f.assignedTo || f.type),
                  (f._.weight =
                    g +
                    1e3 *
                      (l == CKEDITOR.STYLE_OBJECT
                        ? 1
                        : l == CKEDITOR.STYLE_BLOCK
                        ? 2
                        : 3)),
                  (c[h] = f),
                  d.push(f),
            ...
            init: function () {
              ...
              for (k = d.length; g < k; g++)
                (a = d[g]),
                  ...
                  (l = a._.type),
                  l != e &&
                    (this.startGroup(b["panelTitle" + String(l)]), (e = l)),
                  this.add(
                    c,
    ...
    (function () {
              ...
              if (
                ...
                var c = b.createRange(),
                  e = CKEDITOR.tools.tryThese(
                    function () {
                      var b =
                        f.getParent().$.cells[f.$.cellIndex + (a ? -1 : 1)];
                ...
                if (e || a)
                  ...
                  for (
                    var l = f.getAscendant("table").$,
                      e = f.getParent().$.cells,
                      l = new CKEDITOR.dom.element(l.insertRow(-1), b.document),
                      g = 0,
                      n = e.length;
                    g < n;
                    g++
                    ...
                    l.append(
                      new CKEDITOR.dom.element(e[g], b.document).clone(!1, !1)
                    ).appendBogus();
      ...
      CKEDITOR.plugins.add("tab", {
        init: function (d) {
          for (
            var k = !1 !== d.config.enableTabKeyTools,
          ...
          if (k)
            d.on("key", function (a) {
              ((9 == a.data.keyCode && d.execCommand("selectNextCell")) ||
                (a.data.keyCode == CKEDITOR.SHIFT + 9 &&
                  d.execCommand("selectPreviousCell"))) &&
                a.cancel();
            });
    ...
    (CKEDITOR.dom.element.prototype.focusNext = function (a, e) {
      ...
      if (0 >= b)
        ...
        for (
          f = this.getDocument().getBody().getFirst();
          (f = f.getNextSourceNode(!1, CKEDITOR.NODE_ELEMENT));
          ...
          if (!c)
            if (!d && f.equals(this)) {
              if (((d = !0), a)) {
                if (!(f = f.getNextSourceNode(!0, CKEDITOR.NODE_ELEMENT)))
                  break;
                c = 1;
              }
    ...
    (CKEDITOR.dom.element.prototype.focusPrevious = function (a, e) {
      for (
        var b = void 0 === e ? this.getTabIndex() : e,
          ...
          m = 0,
          f,
          h = this.getDocument().getBody().getLast();
        ...
        if (!c)
          if (!d && h.equals(this)) {
            if (((d = !0), a)) {
              if (!(h = h.getPreviousSourceNode(!0, CKEDITOR.NODE_ELEMENT)))
                break;
              c = 1;
            }
    ...
    (function () {
      function a(a) {
        function b(a) {
          0 < c.length ||
            ...
            (CKEDITOR.dom.element.setMarker(d, a, "selected_cell", !0),
            c.push(a));
        }
        a = a.getRanges();
        for (var c = [], d = {}, f = 0; f < a.length; f++) {
          ...
          if (e.collapsed)
            (e = e.getCommonAncestor()),
              (e = e.getAscendant("td", !0) || e.getAscendant("th", !0)) &&
                c.push(e);
          else {
            ...
            for (e.guard = b; (g = e.next()); )
              (g.type == CKEDITOR.NODE_ELEMENT && g.is(CKEDITOR.dtd.table)) ||
                ((g = g.getAscendant("td", !0) || g.getAscendant("th", !0)) &&
                  ...
                  (CKEDITOR.dom.element.setMarker(d, g, "selected_cell", !0),
                  c.push(g)));
          }
        }
      ...
      function e(b, c) {
        for (
          var d = a(b),
            ...
            h = g.$.rowIndex,
            d = d[d.length - 1],
            l = d.getParent().$.rowIndex + d.$.rowSpan - 1,
            d = new CKEDITOR.dom.element(e.$.rows[l]),
            h = c ? h : l,
            g = c ? g : d,
            d = CKEDITOR.tools.buildTableMap(e),
            e = d[h],
            h = c ? d[h - 1] : d[h + 1],
            d = d[0].length,
            f = f.createElement("tr"),
            l = 0;
          e[l] && l < d;
          l++
        ) {
          var k;
          1 < e[l].rowSpan && h && e[l] == h[l]
            ? ((k = e[l]), (k.rowSpan += 1))
            : ((k = new CKEDITOR.dom.element(e[l]).clone()),
      ...
      function b(c) {
        if (c instanceof CKEDITOR.dom.selection) {
          ...
          for (
            var d = d[d.length - 1],
              g = d.getParent().$.rowIndex + d.$.rowSpan - 1,
              d = [],
              h = c;
            h <= g;
            h++
            ...
            for (
              var l = e[h], k = new CKEDITOR.dom.element(f.$.rows[h]), m = 0;
              m < l.length;
              m++
            ) {
              ...
              1 == n.$.rowSpan
                ...
                : (--n.$.rowSpan,
                  v == h &&
                    ((v = e[h + 1]),
                    v[m - 1]
                      ? n.insertAfter(new CKEDITOR.dom.element(v[m - 1]))
                      : new CKEDITOR.dom.element(f.$.rows[h + 1]).append(
                          n,
                          1
                        )));
              m += n.$.colSpan - 1;
          ...
          e = f.$.rows;
          f = new CKEDITOR.dom.element(
            e[g + 1] || (0 < c ? e[c - 1] : null) || f.$.parentNode
          );
      ...
      function c(a, b) {
        for (var c = b ? Infinity : 0, d = 0; d < a.length; d++) {
          ...
          f = a[d];
          for (
            var e = b, g = f.getParent().$.cells, h = 0, l = 0;
            l < g.length;
            l++
          ) {
            var k = g[l],
      ...
      function d(b, d) {
        for (
          ...
          e.push(h[k][g]), f.push(d ? h[k][g - 1] : h[k][g + 1]);
        for (k = 0; k < l; k++)
          e[k] &&
            (1 < e[k].colSpan && f[k] == e[k]
              ? ((g = e[k]), (g.colSpan += 1))
              : ((g = new CKEDITOR.dom.element(e[k]).clone()),
                g.removeAttribute("colSpan"),
                g.appendBogus(),
                g[d ? "insertBefore" : "insertAfter"].call(
                  g,
                  new CKEDITOR.dom.element(e[k])
                ),
                (g = g.$)),
            (k += g.rowSpan - 1));
      }
      ...
      function m(b) {
        if (b instanceof CKEDITOR.dom.selection) {
          ...
          a: {
            ...
            for (e = 0; (h = b[e++]); )
              if (
                ((l = h.getPrevious()) && !l.getCustomData("delete_cell")) ||
                ((l = h.getNext()) && !l.getCustomData("delete_cell"))
              ) {
            ...
            (l = l.getPrevious())
              ? (d = l.getLast())
              : ((l = b[d].getParent()),
                (d = (l = l.getNext()) ? l.getChild(0) : null));
          }
      ...
      function l(b, c, d) {
        ...
        if (c) {
          ...
          try {
            ...
            B =
              l["up" == c ? n - D : "down" == c ? n + D : n][
                "left" == c ? v - g : "right" == c ? v + g : v
              ];
          } catch (F) {
            return !1;
          }
          if (!B || b.$ == B) return !1;
          f["up" == c || "left" == c ? "unshift" : "push"](
        ...
        for (c = 0; c < f.length; c++) {
          ...
          d ||
            ((H = g),
            (R = H.getBogus()) && R.remove(),
            H.trim(),
            g.getChildren().count() &&
              (L == E ||
                !N ||
                (N.isBlockBoundary && N.isBlockBoundary({ br: 1 })) ||
                ((E = I.getLast(CKEDITOR.dom.walker.whitespaces(!0))),
                !E || (E.is && E.is("br")) || I.append("br")),
              g.moveChildren(I)),
        ...
        if (1 < m) {
          ...
          for (
            var m = Math.floor(m / 2),
              f = l + n,
              e = new CKEDITOR.dom.element(e.$.rows[f]),
              g = h(g, f),
              v,
              f = d.clone(),
              l = 0;
          ...
          t(
            ...
            h({
              ...
              exec: function (b) {
                ...
                for (
                  var e = CKEDITOR.tools.buildTableMap(b),
                    g,
                    h,
                    l = [],
                    k = 0,
                  ...
                  for (var n = 0, q = e[k].length; n < q; n++)
                    e[k][n] == c.$ && (g = n), e[k][n] == d.$ && (h = n);
                for (k = g; k <= h; k++)
                  for (n = 0; n < e.length; n++)
                    (d = e[n]),
                      ...
                      d.$ &&
                        (1 == d.$.colSpan ? d.remove() : --d.$.colSpan,
                        (n += d.$.rowSpan - 1),
                        c.$.cells.length || l.push(c));
                h = b.$.rows[0] && b.$.rows[0].cells;
                g = new CKEDITOR.dom.element(
                  h[g] || (g ? h[g - 1] : b.$.parentNode)
                );
                l.length == m && b.remove();
                g && f(g, !0);
              },
              ...
              tablecell: {
                ...
                getItems: function () {
                  ...
                  return {
                    ...
                    tablecell_merge: l(b, null, !0)
                      ? CKEDITOR.TRISTATE_OFF
                      : CKEDITOR.TRISTATE_DISABLED,
                    tablecell_merge_right: l(b, "right", !0)
                      ? CKEDITOR.TRISTATE_OFF
                      : CKEDITOR.TRISTATE_DISABLED,
                    tablecell_merge_down: l(b, "down", !0)
                      ? CKEDITOR.TRISTATE_OFF
                      : CKEDITOR.TRISTATE_DISABLED,
                    tablecell_split_vertical: n(b, !0)
                      ? CKEDITOR.TRISTATE_OFF
                      : CKEDITOR.TRISTATE_DISABLED,
                    tablecell_split_horizontal: g(b, !0)
                      ? CKEDITOR.TRISTATE_OFF
                      : CKEDITOR.TRISTATE_DISABLED,
    ...
    (function () {
      function a(a) {
        function b() {
          for (
            var g = c(),
              h = CKEDITOR.tools.clone(a.config.toolbarGroups) || e(a),
              l = 0;
            l < h.length;
            l++
          ) {
          ...
          if (c.length) {
            ...
            for (var f; (f = c.shift()); )
              (f = "string" == typeof f ? f : f.name),
                (l && -1 != CKEDITOR.tools.indexOf(l, f)) ||
          ...
          for (c = 0; c < a.length; ++c)
            (d = a[c]),
              ...
              "/" == d
                ...
                ? (f(e, CKEDITOR.tools.clone(d)), b.push(e))
                : d.items &&
                      ...
                      ((c =
                        9 == b
                          ? (c ? c.next : a.toolbar.next) ||
                            d.toolbox.toolbars[0]
                          : (c ? c.previous : a.toolbar.previous) ||
                            d.toolbox.toolbars[d.toolbox.toolbars.length - 1]),
                      c.items.length)
                    )
                      for (
                        a = c.items[e ? c.items.length - 1 : 0];
                        a && !a.focus;
            ...
            if (c.data.space == d.config.toolbarLocation) {
              ...
              var e = CKEDITOR.tools.getNextId(),
                l = [
                  ...
                  e,
                  '" class\x3d"cke_voice_label"\x3e',
                  d.lang.toolbar.toolbars,
                  "\x3c/span\x3e",
                  '\x3cspan id\x3d"' +
                    d.ui.spaceId("toolbox") +
              ...
              for (
                var v = d.toolbox.toolbars, u = a(d), q = 0;
                q < u.length;
                q++
              ) {
                var t,
                  ...
                  z;
                if (A)
                  if ((g && (l.push("\x3c/span\x3e"), (k = g = 0)), "/" === A))
                    l.push(
                      ...
                      if (w) {
                        ...
                        if (w.type == CKEDITOR.UI_SEPARATOR) k = g && w;
                          ...
                          if (!p) {
                            ...
                            y =
                              A.name &&
                              (d.lang.toolbar.toolbarGroups[A.name] || A.name);
                            l.push(
                              '\x3cspan id\x3d"',
                              t,
                              '" class\x3d"cke_toolbar"',
                              y ? ' aria-labelledby\x3d"' + t + '_label"' : "",
                            ...
                            var B = v.push(p) - 1;
                            0 < B &&
                              ((p.previous = v[B - 1]), (p.previous.next = p));
                          }
                          C
                            ? g ||
                              (l.push(
              ...
              if (
                ...
                l.push(
                  '\x3ca title\x3d"' +
                    (e
                      ? d.lang.toolbar.toolbarCollapse
                      : d.lang.toolbar.toolbarExpand) +
                    '" id\x3d"' +
                    d.ui.spaceId("toolbar_collapser") +
                    '" tabIndex\x3d"-1" class\x3d"cke_toolbox_collapser'
                );
                e || l.push(" cke_toolbox_collapser_min");
                l.push(
                  '" onclick\x3d"CKEDITOR.tools.callFunction(' + D + ')"\x3e',
      ...
      CKEDITOR.ui.prototype.addToolbarGroup = function (a, b, c) {
        ...
        if (c) {
          if (
            (c = CKEDITOR.tools.search(f, function (a) {
              return a.name == c;
            }))
          ) {
            !c.groups && (c.groups = []);
    ...
    (function () {
      ...
      CKEDITOR.plugins.add("undo", {
        init: function (c) {
          ...
          g.onChange = function () {
            v.setState(
              g.undoable() ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED
            );
            u.setState(
              g.redoable() ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED
            );
          };
      ...
      b.prototype = {
        type: function (a, c) {
          ...
          this.typing ||
            ...
            this.onChange());
          c
            ? ((e = 0), this.editor.fire("saveSnapshot"))
        ...
        save: function (a, b, d) {
          var e = this.editor;
          if (this.locked || "ready" != e.status || "wysiwyg" != e.mode)
            return !1;
          var k = e.editable();
        ...
        lock: function (a, b) {
          if (this.locked) this.locked.level++;
            ...
            if (b) d = !0;
              ...
              this.currentImage &&
                this.currentImage.equalsContent(e) &&
                (d = e);
            }
        ...
        onKeyup: function (a) {
          ...
          if (
            !(
              ...
              this.lastKeydownImage.equalsContent(new c(d.editor, !0))
            )
          )
            if (0 < e) d.type(a);
    ...
    (function () {
      function a(a) {
        ...
        (l = f.getElementById("cke_basetagscrpt")) &&
        ...
        CKEDITOR.env.ie && !CKEDITOR.env.edge && c.enterMode != CKEDITOR.ENTER_P
          ? b("p")
          : CKEDITOR.env.edge && c.enterMode != CKEDITOR.ENTER_DIV && b("div");
        if (
          CKEDITOR.env.webkit ||
          (CKEDITOR.env.ie && 10 < CKEDITOR.env.version)
        )
          f.getDocumentElement().on("mousedown", function (a) {
            a.data.getTarget().is("html") &&
              setTimeout(function () {
                c.editable().focus();
              });
      ...
      function e(a) {
        function b() {
          ...
          a.editable().attachListener(a, "selectionChange", function () {
            ...
            b &&
              (e && (e.detachEvent("onresizestart", c), (e = null)),
      ...
      CKEDITOR.plugins.add("wysiwygarea", {
        init: function (a) {
          ...
          a.addMode("wysiwyg", function (b) {
            ...
            g &&
              (CKEDITOR.env.ie && n && (g += ", " + n),
              h.setAttribute("title", g));
            if (n) {
      ...
      var c = CKEDITOR.tools.createClass({
        ...
        proto: {
          setData: function (a, c) {
            var e = this.editor;
            if (c)
              this.setHtml(a), this.fixInitialSelection(), e.fire("dataReady");
            else {
              ...
              h
                ...
                : (a =
                    f.docType +
                    '\x3chtml dir\x3d"' +
                    f.contentsLangDirection +
                    '" lang\x3d"' +
                    (f.contentsLanguage || e.langCode) +
                    ...
                    (f.bodyId ? ' id\x3d"' + f.bodyId + '"' : "") +
                    (f.bodyClass ? ' class\x3d"' + f.bodyClass + '"' : "") +
                    "\x3e" +
                    a +
          ...
          getData: function (a) {
            ...
            var b = a.config,
              ...
              l = this.getDocument(),
              c = c
                ? l.getDocumentElement().getOuterHtml()
                : l.getBody().getHtml();
            CKEDITOR.env.gecko &&
          ...
          detach: function () {
            ...
            e && e.getParent()
              ? (e.clearCustomData(),
                (a = e.removeCustomData("onResize")) && a.removeListener(),
                e.remove())
