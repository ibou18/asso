...
(function () {
  ...
  Chosen = (function (_super) {
    ...
    Chosen.prototype.set_up_html = function () {
      ...
      if (this.is_multiple) {
        this.container.html(
          '<ul className="chosen-choices"><li className="search-field"><input type="text" value="' +
            this.default_text +
            '" className="default" autocomplete="off" style="width:25px;" /></li></ul><div className="chosen-drop"><ul className="chosen-results"></ul></div>'
        );
      } else {
        this.container.html(
          '<a className="chosen-single chosen-default"><span>' +
            this.default_text +
            '</span><div><b></b></div></a><div className="chosen-drop"><div className="chosen-search"><input type="text" autocomplete="off" /></div><ul className="chosen-results"></ul></div>'
        );
      }
