...
!(function (a) {
  ...
  var c = {
      ...
      template:
        '<div className="colorpicker dropdown-menu"><div className="colorpicker-saturation"><i><b></b></i></div><div className="colorpicker-hue"><i></i></div><div className="colorpicker-alpha"><i></i></div><div className="colorpicker-color"><div /></div><div className="colorpicker-selectors"></div></div>',
      align: "right",
      customClass: null,
      colorSelectors: null,
    },
    ...
    (a.fn.colorpicker = function (b) {
      var c = arguments,
        ...
        f = this.each(function () {
          ...
          g || "string" == typeof b
            ? "string" == typeof b &&
              (e = g[b].apply(g, Array.prototype.slice.call(c, 1)))
