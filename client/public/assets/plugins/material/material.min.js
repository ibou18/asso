    ...
    (t.material = {
      ...
      togglebutton: function (o) {
        var i = t(o ? o : this.options.togglebuttonElements)
          .filter(":notmdproc")
          .data("mdproc", !0)
          .after("<span className='toggle'></span>");
        n(i);
      },
      radio: function (o) {
      ...
      input: function (o) {
        t(o ? o : this.options.inputElements)
          ...
          .each(function () {
            ...
            0 === i.length &&
              (o.wrap("<div className='form-group'></div>"),
              (i = o.closest(".form-group"))),
              o.attr("data-hint") &&
                (o.after(
                  "<p className='help-block'>" + o.attr("data-hint") + "</p>"
                ),
            ...
            if (
              ...
              a && (r = "for='" + a + "'"),
                ...
                o.after(
                  "<label " + r + "className='control-label'>" + e + "</label>"
                );
            }
            (null === o.val() || "undefined" == o.val() || "" === o.val()) &&
              i.addClass("is-empty"),
              i.append("<span className='material-input'></span>"),
      ...
      i.on("mousedown touchstart", function (n) {
        if (!r.isTouch() || "mousedown" !== n.type) {
          i.find(".ripple-container").length ||
            i.append('<div className="ripple-container"></div>');
