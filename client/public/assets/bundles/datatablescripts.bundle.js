!(function (n) {
  ...
  function x(t, e, n) {
    ...
    n !== j &&
      ...
      n.className && !n.sClass && (n.sclassName = n.className),
    ...
    (e._bAttrSrc =
      ...
      e.bSortable && (t || n)
        ? t && !n
          ? ((e.sSortingclassName = a.sSortableAsc),
            (e.sSortingClassJUI = a.sSortJUIAscAllowed))
          : !t && n
          ? ((e.sSortingclassName = a.sSortableDesc),
            (e.sSortingClassJUI = a.sSortJUIDescAllowed))
          : ((e.sSortingclassName = a.sSortable),
            (e.sSortingClassJUI = a.sSortJUI))
        : ((e.sSortingclassName = a.sSortableNone), (e.sSortingClassJUI = ""));
  }
  function H(t) {
  ...
  function G(n) {
    var t = n.oClasses,
      ...
      r = n.oPreviousSearch,
      o = n.aanFeatures,
      i = '<input type="search" className="' + t.sFilterInput + '"/>',
  ...
  (function (n) {
    ...
    return (
      ...
      (o.ext.renderer.pageButton.bootstrap = function (l, t, s, e, u, c) {
        ...
        S(v(t).empty().html('<ul className="pagination"/>').children("ul"), e),
          n !== r &&
            v(t)
              .find("[data-dt-idx=" + n + "]")
              .focus();
