              ...
              (n =
                "x" == e.direction
                  ? ((i = e.scale = M / Math.abs(o(e.max) - o(e.min))),
                    Math.min(o(e.max), o(e.min)))
                  : ((i = -(i = e.scale = T / Math.abs(o(e.max) - o(e.min)))),
                    Math.max(o(e.max), o(e.min)))),
                (e.p2c =
                  o == t
                    ? function (e) {
                        return (e - n) * i;
              ...
              a % z.legend.noColumns == 0 &&
                ...
                i.push(
                  '<td className="legendColorBox"><div style="border:1px solid ' +
                    ...
                    s.color +
                    ';overflow:hidden"></div></div></td><td className="legendLabel">' +
                    s.label +
                    "</td>"
                );
            }
        ...
        return (
          null == t &&
            (null == this.textContainer &&
              (this.textContainer = Q("<div className='flot-text'></div>")
                .css({
                  position: "absolute",
                  top: 0,
                  left: 0,
              ...
              (function (e, t) {
                if (v) {
                  ...
                  10 <= n &&
                    (o(),
                    v.prepend(
                      "<div className='error'>Could not draw pie with labels contained inside canvas</div>"
                    )),
                    e.setSeries &&
                      e.insertLegend &&
                      ...
                      (function () {
                        ...
                        function i(e, t, i) {
                          ...
                          var a = (t + e.angle + t) / 2,
                            ...
                            c =
                              "<span className='pieLabel' id='pieLabel" +
                              i +
                          ...
                          if (0 != b.series.pie.label.background.opacity) {
                            ...
                            w(
                              "<div className='pieLabelBackground' style='position:absolute;width:" +
                                h.width() +
                                "px;height:" +
                                h.height() +
                                "px;" +
