(function (h) {
  ...
  function o(a, b, d) {
    ...
    d &&
      (d.attr && h(c).attr(d.attr),
      d.children &&
        h.each(d.children, function (a, b) {
          c.appendChild(b);
        }),
      null !== d.text &&
        d.text !== p &&
  ...
  function w(a) {
    q === p &&
      (q =
        -1 ===
        u
          .serializeToString(h.parseXML(m["xl/worksheets/sheet1.xml"]))
          .indexOf("xmlns:r"));
    ...
    i = {
      ...
      $: function (a) {
        ...
        a.addClass ||
          ...
          (a.addclassName = function (a) {
            this.removeClass(a);
            this.className += " " + a;
          }),
          (a.removeclassName = function (a) {
            this.className = this.className
              .replace(RegExp("\\s*" + a + "\\s*"), " ")
              .replace(/^\s+/, "")
              .replace(/\s+$/, "");
          }),
          (a.hasclassName = function (a) {
  ...
  var x = function (a, b) {
    ...
    z = function (a, b) {
      for (
        ...
        n.push(j(c.body[g]));
      return { str: l + n.join(d) + o, rows: n.length };
    },
    t = {
      available: function () {
        return i.hasFlash();
  ...
  g.ext.buttons.excelFlash = h.extend({}, t, {
    ...
    action: function (a, b, d, c) {
      ...
      var n = function (a, b) {
          ...
          c[0].appendChild(
            o(f, "mergeCell", { attr: { ref: "A" + a + ":" + v(b) + a } })
          );
      ...
      c.footer &&
        k.footer &&
        (g(k.footer, e), h("row:last c", f).attr("s", "2"));
      b.messageBottom && (g([b.messageBottom], e), n(e, k.header.length - 1));
      g = o(f, "cols");
      h("worksheet", f).prepend(g);
      n = 0;
      for (r = k.header.length; n < r; n++)
        g.appendChild(
          o(f, "col", {
            attr: { min: n + 1, max: n + 1, width: B(k, n), customWidth: 1 },
          })
        );
