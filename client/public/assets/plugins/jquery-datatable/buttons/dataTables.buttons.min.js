...
(function (d) {
  ...
  i.Api.register("buttons.info()", function (a, b, c) {
    ...
    d('<div id="datatables_buttons_info" className="dt-button-info"/>')
      .html(a ? "<h2>" + a + "</h2>" : "")
  ...
  i.Api.register("buttons.exportInfo()", function (a) {
    ...
    b === l || null === b
      ? (b = null)
      : (-1 !== b.indexOf("*") &&
          (b = d.trim(b.replace("*", d("title").text()))),
    ...
    c =
      null === c
        ? null
        : -1 !== c.indexOf("*")
        ? c.replace("*", d("title").text() || "Exported data")
        : c;
    return {
      filename: b,
      title: c,
