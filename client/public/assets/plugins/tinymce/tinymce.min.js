  ...
  r(l, [], function () {
    ...
    r(d, [], function () {
      ...
      (r = window.opera && window.opera.buildNumber),
        ...
        (a =
          -1 == n.indexOf("Trident/") ||
          (-1 == n.indexOf("rv:") && -1 == t.appName.indexOf("Netscape"))
            ? !1
            : 11),
    ...
    r(f, [u, d], function (e, t) {
      ...
      function o(e, n) {
        ...
        if (
          ...
          t.experimentalShadowDom && (s.target = i(e, s.target)),
          e && c.test(e.type) && e.pageX === l && e.clientX !== l)
        ) {
          ...
          (s.pageX =
            e.clientX +
            ((f && f.scrollLeft) || (h && h.scrollLeft) || 0) -
            ((f && f.clientLeft) || (h && h.clientLeft) || 0)),
            (s.pageY =
              e.clientY +
              ((f && f.scrollTop) || (h && h.scrollTop) || 0) -
              ((f && f.clientTop) || (h && h.clientTop) || 0));
        }
        return (
      ...
      function a(t, i, o) {
        ...
        function s() {
          ("complete" === c.readyState ||
            ("interactive" === c.readyState && c.body)) &&
            (r(c, "readystatechange", s), a());
        }
        function l() {
          try {
        ...
        return o.domLoaded
          ...
          : (c.addEventListener
              ? "complete" === c.readyState
                ? a()
                : n(t, "DOMContentLoaded", a)
              : (n(c, "readystatechange", s),
                c.documentElement.doScroll && t.self === t.top && l()),
            void n(t, "load", a));
      }
      function s() {
        function e(e, t) {
          ...
          if ((n = s && s[e.type]))
            for (r = 0, o = n.length; o > r; r++)
              if (
                ((a = n[r]),
                a && a.func.call(a.scope, e) === !1 && e.preventDefault(),
            ...
            if (r && 3 !== r.nodeType && 8 !== r.nodeType) {
              for (
                ...
                (b = l[y]),
                  ...
                  t.domLoaded && "ready" === b && "complete" == r.readyState
                    ? h.call(p, o({ type: b }))
                    : (d ||
                        ((C = f[b]),
                        C &&
                      ...
                      v
                        ...
                        : ((i[g][b] = v = [{ func: h, scope: p }]),
                          (v.fakeName = C),
                          (v.capture = w),
                          (v.nativeHandler = x),
                          "ready" === b ? a(r, x, t) : n(r, C || b, x, w)));
              return (r = v = 0), h;
            }
          }),
              ...
              if (((f = i[a]), n)) {
                for (n = n.split(" "), l = n.length; l--; )
                  if (((d = n[l]), (s = f[d]))) {
                    ...
                    (o && 0 !== s.length) ||
                      (delete f[d],
                      r(e, s.fakeName || d, s.nativeHandler, s.capture));
                  }
              } else {
                for (d in f)
    ...
    r(h, [], function () {
      ...
      (x = e.support = {}),
          ...
          function (e) {
            ...
            return r !== D && 9 === r.nodeType && r.documentElement
              ? ((D = r),
                ...
                (H = []),
                (P = []),
                (x.qsa = ge.test(r.querySelectorAll)) &&
                  (i(function (e) {
                    (e.innerHTML =
                ...
                (n = ge.test(L.compareDocumentPosition)),
                (I =
                  n || ge.test(L.contains)
                    ? function (e, t) {
                      ...
                      return n
                        ...
                        : ((n =
                          ...
                          (!x.sortDetached &&
                            ...
                            ? e === r || (e.ownerDocument === z && I(z, e))
                              ? -1
                              : t === r || (t.ownerDocument === z && I(z, t))
                              ? 1
                              : R
        ...
        (e.matchesSelector = function (t, n) {
          if (
            ((t.ownerDocument || t) !== D && B(t),
            (n = n.replace(ue, "='$1']")),
            x.matchesSelector && M && (!H || !H.test(n)) && (!P || !P.test(n)))
          )
            try {
              var r = O.call(t, n);
              if (
            ...
            pseudos: {
              ...
              contains: r(function (e) {
                return (
                  ...
                  function (t) {
                    return (
                      (t.textContent || t.innerText || N(t)).indexOf(e) > -1
                    );
                  }
                );
              }),
          ...
          function (e, t, n, r) {
            ...
            if (((n = n || []), 1 === d.length)) {
              if (
                ...
                if (
                  ((t = (w.find.ID(a.matches[0].replace(Ce, xe), t) || [])[0]),
                  !t)
                )
                  return n;
            ...
            return (
              (c || S(e, d))(r, t, !M, n, (ye.test(e) && u(t.parentNode)) || t),
              n
            );
          }),
    ...
    r(b, [m], function (e) {
      function t(n) {
        ...
        function N(e, t, r) {
          ...
          o == i
            ? w(M[W], M[U], M[V], M[$]) > 0 && M.collapse(e)
            : M.collapse(e),
            (M.collapsed = x()),
            (M.commonAncestorContainer = n.findCommonAncestor(M[W], M[V]));
        }
        function E(e) {
          var t,
            n = 0,
        ...
        function T(e, t, n) {
          ...
          return (
            (i = R(t, n)),
            o && o.appendChild(i),
            n != O && (M.setStartAfter(e), M.collapse(F)),
            o
          );
        }
        function R(e, t) {
        ...
        function B(e, t, r, i) {
          ...
          if (3 == e.nodeType) {
            if (
              ((o = e.nodeValue),
              r
                ? ((l = M[U]), (a = o.substring(l)), (s = o.substring(0, l)))
                : ((l = M[$]), (a = o.substring(0, l)), (s = o.substring(l))),
              i != O && (e.nodeValue = s),
              i == I)
            )
              return;
    ...
    r(x, [m, u], function (e, t) {
      return function (n, r) {
        ...
        function o(r, o, c) {
          ...
          function p() {
            h(function () {
              for (var e = n.styleSheets, t, r = e.length, i; r--; )
                if (
                  ((t = e[r]),
                  (i = t.ownerNode ? t.ownerNode : t.owningElement),
                  i && i.id === g.id)
                )
                  return u(), !0;
            }, p);
          ...
          var g, v, y, b;
          if (
            ((r = e._addCacheSuffix(r)),
            s[r] ? (b = s[r]) : ((b = { passed: [], failed: [] }), (s[r] = b)),
            o && b.passed.push(o),
            c && b.failed.push(c),
            1 != b.status)
          ) {
          ...
          (p.prototype = {
            ...
            clone: function (e, t) {
              var n = this,
                r,
                i;
              return !b || 1 !== e.nodeType || t
                ? e.cloneNode(t)
                : ((i = n.doc),
                  t
                    ? r.firstChild
                    : ((r = i.createElement(e.nodeName)),
                      m(n.getAttribs(e), function (t) {
            ...
            add: function (e, t, n, r, i) {
              ...
              return this.run(e, function (e) {
                var a;
                return (
                  (a = g(t, "string") ? o.doc.createElement(t) : t),
                  o.setAttribs(a, n),
            ...
            loadCSS: function (e) {
              var t = this,
                n = t.doc,
                r;
              return t !== p.DOM && n === document
                ? void p.DOM.loadCSS(e)
                : (e || (e = ""),
                  (r = n.getElementsByTagName("head")[0]),
                  void m(e.split(","), function (e) {
                    var i;
            ...
            replace: function (e, t, n) {
              ...
              return r.run(t, function (t) {
                return (
                  g(t, "array") && (e = e.cloneNode(!0)),
                  n &&
                    m(v(t.childNodes), function (t) {
                      e.appendChild(t);
                    }),
            ...
            split: function (e, t, n) {
              ...
              return e && t
                ? (o.setStart(e.parentNode, i.nodeIndex(e)),
                  ...
                  n ? l.insertBefore(n, e) : l.insertBefore(t, e),
          ...
          function (n) {
            ...
            if (s(n))
              for (r = 0; r < t.length; r++)
                if (
                  ((i = getComputedStyle(n, null).getPropertyValue(e)),
                  i === t[r])
                )
                  return !0;
            return !1;
    ...
    r(k, [_, S], function (e, t) {
      function n(e) {
        return (
          d(e) && (e = e.parentNode), u(e) && e.hasAttribute("data-mce-caret")
        );
      }
      function r(e) {
      ...
      function a(e, t, n) {
        ...
        return (
          ...
          n
            ? o.insertBefore(i, t)
            : t.nextSibling
            ? o.insertBefore(i, t.nextSibling)
            : o.appendChild(i),
          i
        );
      }
      function s(e) {
        ...
        u(e) &&
          ...
          d(e) &&
            ((n = t.trim(e.data)),
            0 === n.length && e.parentNode && e.parentNode.removeChild(e),
            (e.nodeValue = n));
      }
      function l(e) {
      ...
      function a(e) {
        (this.walk = function (t, n) {
          ...
          var c = t.startContainer,
            ...
            b;
          if (
            ((b = e.select("td[data-mce-selected],th[data-mce-selected]")),
            b.length > 0)
          )
            return void l(b, function (e) {
              n([e]);
            });
          if (
            (1 == c.nodeType && c.hasChildNodes() && (c = c.childNodes[u]),
            1 == d.nodeType && d.hasChildNodes() && (d = o(d, f)),
            c == d)
          )
            return n(r([c]));
          ...
          (this.normalize = function (n) {
            function r(r) {
              ...
              function s(n, r) {
                for (
                  var i = new t(n, e.getParent(n.parentNode, e.isBlock) || g);
                  (n = i[r ? "prev" : "next"]());
              ...
              function f(n, r) {
                ...
                if (
                  ((r = r || h),
                  (l = e.getParent(r.parentNode, e.isBlock) || g),
                  n && "BR" == r.nodeName && C && e.isEmpty(l))
                )
                  return (
                    (h = r.parentNode), (p = e.nodeIndex(r)), void (i = !0)
                  );
                for (a = new t(r, l); (v = a[n ? "prev" : "next"]()); ) {
                  if ("false" === e.getContentEditableParent(v) || u(v)) return;
                  if (3 === v.nodeType && v.nodeValue.length > 0)
                    return (
                      (h = v), (p = n ? v.nodeValue.length : 0), void (i = !0)
                    );
              ...
              var h,
                ...
                C;
              if (
                ((h = n[(r ? "start" : "end") + "Container"]),
                (p = n[(r ? "start" : "end") + "Offset"]),
                (C = 1 == h.nodeType && p === h.childNodes.length),
                (y = e.schema.getNonEmptyElements()),
                (b = r),
                !u(h))
              ) {
                if (
                  (1 == h.nodeType && p > h.childNodes.length - 1 && (b = !1),
                  9 === h.nodeType && ((h = e.getRoot()), (p = 0)),
                  h === g)
                ) {
                  ...
                  if (h.hasChildNodes()) {
                    if (
                      ...
                      (h = h.childNodes[p]),
                      (p = 0),
                      !o && h === g.lastChild && "TABLE" === h.nodeName)
                    )
                      return;
                    if (l(h) || u(h)) return;
                ...
                o &&
                  (3 === h.nodeType && 0 === p && f(!0),
                  1 === h.nodeType &&
                    ((v = h.childNodes[p]),
                    v || (v = h.childNodes[p - 1]),
                    !v ||
                      "BR" !== v.nodeName ||
                      d(v, "A") ||
                      s(v) ||
    ...
    r(R, [T, d, u], function (e, t, n) {
      return function (r) {
        function i(e) {
          var t, n;
          if (
            ((n = r.$(e).parentsUntil(r.getBody()).add(e)),
            n.length === a.length)
          ) {
        ...
        "onselectionchange" in r.getDoc() ||
          r.on("NodeChange Click MouseUp KeyUp Focus", function (t) {
            var n, i;
            (n = r.selection.getRng()),
              ...
              ("nodechange" != t.type && e.compareRanges(i, o)) ||
          ...
          r.on("SelectionChange", function () {
            ...
            (!t.range && r.selection.isCollapsed()) ||
              (!i(e) &&
          ...
          (this.nodeChanged = function (e) {
            ...
            r.initialized &&
              t &&
              !r.settings.disable_nodechange &&
              !r.readonly &&
              ((o = r.getBody()),
              (n = t.getStart() || o),
              (n.ownerDocument == r.getDoc() && r.dom.isChildOf(n, o)) ||
                (n = o),
              "IMG" == n.nodeName && t.isCollapsed() && (n = n.parentNode),
              (i = []),
        ...
        function f(e) {
          ...
          if (e)
            for (
              e = t(e, ","),
                y["@"] &&
                  ((w = y["@"].attributes), (N = y["@"].attributesOrder)),
                n = 0,
                r = e.length;
              r > n;
              n++
                    ...
                    if ((s = k.exec(f[i]))) {
                      ...
                      b &&
                        ("=" === b &&
                          ...
                          l.attributesDefault.push({ name: p, value: _ }),
                          (c.defaultValue = _)),
                        ":" === b &&
                          ((l.attributesForced = l.attributesForced || []),
                          l.attributesForced.push({ name: p, value: _ }),
                          (c.forcedValue = _)),
                        "<" === b && (c.validValues = a(_, "?"))),
                        T.test(p)
        ...
        (i = i || {}),
          ...
          (l.parse = function (e) {
            ...
            var l = this,
              ...
              z = t.decode,
              U,
              W = n.makeMap("src,href,data,background,formaction,poster"),
            ...
            for (
              P = new RegExp(
                ...
                M = i.self_closing_elements || a.getSelfClosingElements(),
                x = a.getBoolAttrs(),
                N = i.validate,
                b = i.remove_internals,
                U = i.fix_self_closing,
              ...
              if (
                ...
                if (
                  ...
                  U &&
                    ...
                    h[h.length - 1].name === d &&
                    o(d),
                  !N || (E = a.getElementRule(d)))
                ) {
                  if (
                    ((_ = !0),
                    N && ((T = E.attributes), (R = E.attributePatterns)),
                    (k = c[8])
                      ? ((y = -1 !== k.indexOf("data-mce-type")),
                        y && b && (_ = !1),
                        (p = []),
                        (p.map = {}),
                        k.replace(H, s))
        ...
        (r = r || {}),
          ...
          (u.parse = function (t, o) {
            ...
            if (
              ...
              v.parse(t),
              k && A.length && (o.context ? (o.invalid = !0) : c(A)),
              ...
              if (n) n(e);
                ...
                if (
                  ...
                  a &&
                    c &&
                    c.length > 1 &&
                    ((f = []), (f.map = {}), (m = r.getElementRule(e.name))))
                ) {
        ...
        return function (e, o) {
          ...
          function g() {
            ...
            for (e = m(e), l = c.getShortEndedElements(); (s = t.exec(e)); )
              (i = t.lastIndex),
                (a = s[0].length),
                (r = l[s[1]] ? i : n.findEndTag(c, e, i)),
                (e = e.substring(0, i - a) + e.substring(r)),
                (t.lastIndex = i - a);
            return f(e);
          }
          function v(e) {
            -1 === l.inArray(p, e) &&
              (C.addAttributeFilter(e, function (e, t) {
          ...
          return (
                ...
                (i = t[r]),
                  ...
                  o !== c
                    ...
                    : ((o = i.attributes.map[n]),
                      "style" === n
                        ? (o = y.serializeStyle(y.parseStyle(o), i.name))
                        : s && (o = s.call(l, o, n, i.name)),
            ...
            e.fix_list_elements &&
              C.addNodeFilter("ul,ol", function (e) {
                for (var t = e.length, n, r; t--; )
                  (n = e[t]),
                    (r = n.parent),
                    ("ul" !== r.name && "ol" !== r.name) ||
                      (n.prev && "li" === n.prev.name && n.prev.append(n));
              }),
            C.addAttributeFilter(
            ...
            ),
            {
              ...
              serialize: function (t, n) {
                var r = this,
                  ...
                  m;
                return (
                  s.ie && y.select("script,style,select,map").length > 0
                    ? ((p = t.innerHTML),
                      (t = t.cloneNode(!1)),
                      y.setHTML(t, p))
                    : (t = t.cloneNode(!0)),
                  ...
                  o.createHTMLDocument &&
                    ((a = o.createHTMLDocument("")),
                    d("BODY" == t.nodeName ? t.childNodes : [t], function (e) {
                  ...
                  (m = C.parse(
                    f(n.getInner ? t.innerHTML : y.getOuterHTML(t)),
                    n
                  )),
                  u(m),
                  (h = new i(e, b)),
      ...
      return function (i, s) {
        ...
        function c(t) {
          ...
          (n = t.screenX - L),
            ...
            (W = 5 > W ? 5 : W),
            (i =
              "IMG" == k.nodeName && s.settings.resize_img_proportional !== !1
                ? !e.modifierPressed(t)
                : e.modifierPressed(t) ||
                  ("IMG" == k.nodeName && B[2] * B[3] !== 0)),
            i &&
              (j(n) > j(r)
                ? ((W = Y(U * F)), (U = Y(W / F)))
                : ((U = Y(W / F)), (W = Y(U * F)))),
            _.setStyles(T, { width: U, height: W }),
            (o = B.startPos.x + n),
            (a = B.startPos.y + r),
            (o = o > 0 ? o : 0),
            (a = a > 0 ? a : 0),
            _.setStyles(R, { left: o, top: a, display: "block" }),
            (R.innerHTML = U + " &times; " + W),
            B[2] < 0 &&
              T.clientWidth <= U &&
              _.setStyle(T, "left", P + (O - U)),
            B[3] < 0 &&
              T.clientHeight <= W &&
              _.setStyle(T, "top", H + (I - W)),
            (n = X.scrollWidth - K),
            (r = X.scrollHeight - G),
            n + r !== 0 && _.setStyles(R, { left: o - n, top: a - r }),
            z ||
              (s.fire("ObjectResizeStart", { target: k, width: O, height: I }),
              (z = !0));
        }
        function u() {
          function e(e, t) {
            t &&
              (k.style[e] || !s.schema.isValid(k.nodeName.toLowerCase(), e)
                ? _.setStyle(k, e, t)
                : _.setAttrib(k, e, t));
          }
          (z = !1),
            e("width", U),
            e("height", W),
            _.unbind(V, "mousemove", c),
            _.unbind(V, "mouseup", u),
            $ != V && (_.unbind($, "mousemove", c), _.unbind($, "mouseup", u)),
            _.remove(T),
            _.remove(R),
            (q && "TABLE" != k.nodeName) || d(k),
            s.fire("ObjectResized", { target: k, width: U, height: W }),
            _.setAttrib(k, "style", _.getAttrib(k, "style")),
            s.nodeChanged();
        }
        function d(e, t, n) {
          var i, o, a, d, h;
          f(),
            ...
            k != e && (C(), (k = e), (U = W = 0)),
            (d = s.fire("ObjectSelected", { target: e })),
            l(e) && !d.isDefaultPrevented()
              ? S(A, function (e, i) {
                  function s(t) {
                    (L = t.screenX),
                      (M = t.screenY),
                      ...
                      (F = I / O),
                      (B = e),
                      (e.startPos = { x: o * e[0] + P, y: a * e[1] + H }),
                      (K = X.scrollWidth),
                      (G = X.scrollHeight),
                      (T = k.cloneNode(!0)),
                      _.addClass(T, "mce-clonedresizable"),
                      _.setAttrib(T, "data-mce-bogus", "all"),
                      (T.contentEditable = !1),
                      (T.unSelectabe = !0),
                      _.setStyles(T, { left: P, top: H, margin: 0 }),
                      T.removeAttribute("data-mce-selected"),
                      X.appendChild(T),
                      _.bind(V, "mousemove", c),
                      _.bind(V, "mouseup", u),
                      $ != V &&
                        (_.bind($, "mousemove", c), _.bind($, "mouseup", u)),
                      (R = _.add(
                        X,
                        "div",
        ...
        function f() {
          ...
          for (e in A)
            (t = _.get("mceResizeHandle" + e)), t && (_.unbind(t), _.remove(t));
        }
        function h(e) {
          function t(e, t) {
            if (e)
          ...
          if (!z && !s.removed)
            return (
              S(
                _.select("img[data-mce-selected],hr[data-mce-selected]"),
                function (e) {
                  e.removeAttribute("data-mce-selected");
                }
              ),
              (r = "mousedown" == e.type ? e.target : i.getNode()),
              (r = _.$(r).closest(q ? "table" : "table,img,hr")[0]),
              t(r, X) &&
              (w(),
              (n = i.getStart(!0)),
              t(n, r) &&
                t(i.getEnd(!0), r) &&
                (!q || (r != n && "IMG" !== n.nodeName)))
                ? void d(r)
                : void f()
            );
        }
        ...
        return (
          s.contentStyles.push(
            J +
              ...
              (r.gecko ? "" : "outline: 1px dashed black;") +
              ...
              : (w(),
                r.ie >= 11 &&
                  ...
                  s.dom.bind(X, "mscontrolselect", function (e) {
                    ...
                    return y(e.target)
                      ? (e.preventDefault(), void t(e.target))
                      : void (
    ...
    r(W, [], function () {
      ...
      function t(t, n) {
        return (
          ...
          n
            ? (t.right = t.left)
            : ((t.left = t.left + t.width), (t.right = t.left)),
          (t.width = 0),
          t
        );
      }
    ...
    r($, [z, _, w, T, U, W, V], function (e, t, n, r, i, o, a) {
      ...
      function u(e) {
        ...
        function n(e) {
          ...
          return (
            ...
            (n =
              r.length > 0
                ? o.clone(r[0])
                : o.clone(e.getBoundingClientRect())),
            b(e) && 0 === n.left ? t(e) : n
          );
        }
        function r(e, t) {
          return (
            (e = o.collapse(e, t)), (e.width = 1), (e.right = e.left + 1), e
          );
        }
        function i(e) {
          0 !== e.height &&
            ((u.length > 0 && o.isEqual(e, u[u.length - 1])) || u.push(e));
        }
        function l(e, t) {
          ...
          if (t < e.data.length) {
            ...
            if (
              a.isExtendingChar(e.data[t - 1]) &&
              (o.setStart(e, t), o.setEnd(e, t + 1), !c(o))
            )
              return i(r(n(o), !1)), u;
          }
          t > 0 &&
            (o.setStart(e, t - 1), o.setEnd(e, t), c(o) || i(r(n(o), !1))),
            t < e.data.length &&
              (o.setStart(e, t), o.setEnd(e, t + 1), c(o) || i(r(n(o), !0)));
        }
        var u = [],
          d,
          h;
        ...
        if (f(e.container()))
          if (e.isAtEnd())
            (h = x(e.container(), e.offset())),
              y(h) && l(h, h.data.length),
              g(h) && !b(h) && i(r(n(h), !1));
          else {
            if (
              ((h = x(e.container(), e.offset())),
              ...
              return i(r(n(h), !1)), u;
            (d = x(e.container(), e.offset() - 1)),
              g(d) && !b(d) && (p(d) || p(h) || !g(h)) && i(r(n(d), !1)),
              g(h) && i(r(n(h), !0));
          }
        return u;
      }
      ...
      var f = t.isElement,
        ...
        v = e.negate(
          t.matchStyleValues("white-space", "pre pre-line pre-wrap")
        ),
        y = t.isText,
        b = t.isBr,
        C = n.nodeIndex,
    ...
    r(q, [_, w, z, p, $], function (e, t, n, r, i) {
      ...
      function a(e) {
        return e
          ? r.reduce(
              ...
              function (e, t) {
                return (
                  v(t) && "BR" != t.nodeName ? (e = e.concat(a(t))) : e.push(t),
                  e
                );
              },
              []
      ...
      function u(e) {
        var t;
        return (
          (t = g(e) ? "text()" : e.nodeName.toLowerCase()), t + "[" + c(e) + "]"
        );
      }
      function d(e, t, n) {
        var r = [];
      ...
      function a(a) {
        ...
        (this.getBookmark = function (e, c) {
          function u(e, n) {
            var r = 0;
            return (
              t.each(l.select(e), function (e) {
                return "all" !== e.getAttribute("data-mce-bogus")
                  ? e == n
                    ? !1
                    : void r++
                  : void 0;
            ...
            function t(e, t) {
              ...
              if (3 == r.nodeType) {
                ...
                (s = r.childNodes),
                  i >= s.length &&
                    s.length &&
                    ((u = 1), (i = Math.max(0, s.length - 1))),
                  o.push(l.nodeIndex(s[i], c) + u);
          ...
          if (2 == e)
            return (
              ...
              s(b) || "IMG" == y
                ? { name: y, index: u(y, b) }
                : a.tridentSel
                ? a.tridentSel.getBookmark(e)
                : ((b = h(p)),
                  b ? ((y = b.tagName), { name: y, index: u(y, b) }) : f(p))
            );
          if (3 == e)
            return (
              (p = a.getRng()),
          ...
          if (
            ...
            if (p.item)
              return (
                (b = p.item(0)), (y = b.nodeName), { name: y, index: u(y, b) }
              );
            m = p.duplicate();
            try {
              p.collapse(),
                ...
                v ||
                  (m.collapse(!1),
                  p.moveToElementText(m.parentElement()),
                  0 === p.compareEndPoints("StartToEnd", m) &&
                    m.move("character", -1),
                  m.pasteHTML(
                    '<span data-mce-type="bookmark" id="' +
                      g +
            ...
            (m = d(p.cloneRange())),
              v ||
                ...
                m.insertNode(
                  l.create(
                    "span",
                    { "data-mce-type": "bookmark", id: g + "_end", style: x },
                    C
                  )
                )),
              (p = d(p)),
              ...
              p.insertNode(
                l.create(
                  "span",
                  { "data-mce-type": "bookmark", id: g + "_start", style: x },
                  C
                )
              );
          }
          ...
          (this.moveToBookmark = function (n) {
            ...
            function o(r) {
              ...
              if (
                ...
                ((o = i.parentNode),
                "start" == r
                  ? (u ? ((o = i.firstChild), (a = 1)) : (a = l.nodeIndex(i)),
                    (f = h = o),
                    (p = m = a))
                  : (u ? ((o = i.firstChild), (a = 1)) : (a = l.nodeIndex(i)),
                    (h = o),
                ...
                for (
                  c = i.previousSibling,
                    s = i.nextSibling,
                    t.each(t.grep(i.childNodes), function (e) {
                      3 == e.nodeType &&
                ...
                "string" == typeof n.start
                  ...
                  ? (o("start"),
                    ...
                    f &&
                      ...
                      a.setRng(u)))
                  : n.name
                  ? a.select(l.select(n.name)[n.index])
                  : n.rng && a.setRng(n.rng);
          });
      }
      var s = o.isContentEditableFalse;
      return (
        (a.isBookmarkNode = function (e) {
          return (
            e &&
            "SPAN" === e.tagName &&
      ...
      return (
        (u.prototype = {
          ...
          getRng: function (e) {
            ...
            if (
              ((l = n.editor.fire("GetSelectionRange", { range: i })),
              l.range !== i)
            )
              return l.range;
          ...
          setRng: function (e, t) {
            ...
            if (e)
              if (e.select) {
                ...
                if (
                  ((r = n.getSel()),
                  (o = n.editor.fire("SetSelectionRange", { range: e })),
                  (e = o.range),
                  r)
                ) {
                  n.explicitRange = e;
                ...
                n.setStart
                  ? ((r = n.commonAncestorContainer),
                    ...
                    3 === i.nodeType &&
                      3 === o.nodeType &&
                      ((i =
                        i.length === a ? e(i.nextSibling, !0) : i.parentNode),
          ...
          scrollIntoView: function (e, t) {
            ...
            if (a.isElement(e)) {
              ...
              (i = s.getViewPort(o.editor.getWin())),
                ...
                (u = i.h),
                (r < i.y || r + 25 > c + u) &&
                  o.editor.getWin().scrollTo(0, c > r ? r : r - u + 25);
            }
          },
          ...
          getBoundingClientRect: function () {
            var e = this.getRng();
            return e.collapsed
              ? c.fromRangeStart(e).getClientRects()[0]
              : e.getBoundingClientRect();
          },
          destroy: function () {
    ...
    r(G, [p, _, g], function (e, t, n) {
      ...
      return (
        r("pre", function (r) {
          function i(t) {
            return (
              c(t.previousSibling) && -1 != e.indexOf(u, t.previousSibling)
            );
          }
          function o(e, t) {
          ...
          (c = t.matchNodeNames("pre")),
            l.collapsed ||
              ((u = r.selection.getSelectedBlocks()),
              s(a(a(u, c), i), function (e) {
    ...
    r(J, [y, T, j, X, m, K, G], function (e, t, n, r, i, o, a) {
      return function (s) {
        ...
        function b(e) {
          var t;
          return (
            s.dom.getParent(e, function (e) {
              return (
                (t = s.dom.getStyle(e, "text-decoration")), t && "none" !== t
              );
            }),
            t
          );
        ...
        function C(e) {
          ...
          1 === e.nodeType &&
            ...
            ((t = b(e.parentNode)),
            s.dom.getStyle(e, "color") && t
              ? s.dom.setStyle(e, "text-decoration", t)
              : s.dom.getStyle(e, "text-decoration") === t &&
                s.dom.setStyle(e, "text-decoration", null));
        }
        function x(t, n, r) {
          function i(e, t) {
            if (((t = t || d), e)) {
            ...
            (s = d.inline || d.block),
                ...
                function r(e) {
                  ...
                  return (
                    ...
                    1 === e.nodeType &&
                      ...
                      ((C = h), (h = "true" === ae(e)), (b = !0)),
                    B(m, "br")
                      ? ((p = 0), void (d.block && Y.remove(e)))
                      : d.wrapper && E(e, t, n)
                      ? void (p = 0)
                      : h && !b && d.block && !d.wrapper && l(m) && G(v, s)
                      ? ((e = Y.rename(e, s)), i(e), a.push(e), void (p = 0))
                      : d.selector &&
                        (ue(u, function (t) {
                          return "collapsed" in t && t.collapsed !== g
                            ? void 0
                            : Y.is(e, t.selector) && !f(e)
                            ? (i(e, t), (y = !0), !1)
                            : void 0;
                        }),
                        !d.inline || y)
              ...
              ue(a, function (e) {
                ...
                if (d.inline || d.wrapper) {
                  ...
                  d.merge_with_parents &&
                    Y.getParent(e.parentNode, function (r) {
                      return E(r, t, n)
                        ? (Y.remove(e, 1), (e = 0), re)
                        : void 0;
                    }),
          ...
          if ("false" !== ae(X.getNode())) {
            if (d) {
              if (r)
                ...
                g &&
                d.inline &&
                !Y.select("td[data-mce-selected],th[data-mce-selected]").length
              )
                $("apply", t, n);
              else {
                ...
                Q ||
                  !u[0].defaultBlock ||
                  Y.getParent(v, Y.isBlock) ||
                  x(u[0].defaultBlock),
                  s.selection.setRng(o()),
                  (h = X.getBookmark()),
                  c(O(X.getRng(re), u), h),
                  d.styles &&
                    (d.styles.color || d.styles.textDecoration) &&
                    (fe(v, C, "childNodes"), C(v)),
                  X.moveToBookmark(h),
                  q(X.getRng(re)),
                  s.nodeChanged();
              }
        ...
        function w(e, t, n, r) {
          ...
          function o(n) {
            var i;
            return (
              ue(d(n.parentNode).reverse(), function (n) {
                var o;
                i ||
                  "_start" == n.id ||
                  "_end" == n.id ||
                  ((o = E(n, e, t, r)), o && o.split !== !1 && (i = n));
              }),
              i
            );
          }
          ...
          function u(e) {
            ...
            return (
              ce(n) && (n = n[e ? "firstChild" : "lastChild"]),
              3 == n.nodeType &&
                0 === n.data.length &&
                (n = e
          ...
          if ("false" !== ae(X.getNode()))
            ...
            !Y.select("td[data-mce-selected],th[data-mce-selected]").length
              ...
              : ((g = X.getBookmark()),
                f(X.getRng(re)),
                X.moveToBookmark(g),
                p.inline && _(e, t, X.getStart()) && q(X.getRng(!0)),
                s.nodeChanged());
          else {
            n = X.getNode();
            for (
              var C = 0, x = h.length;
              x > C && (!h[C].ceFalseOverride || !F(h[C], t, n, n));
              C++
            );
          }
        }
        ...
        function E(e, t, n, r) {
              ...
              if (s.length === oe) {
                for (o in s)
                  if (s.hasOwnProperty(o)) {
                    if (
                      ((a = "attributes" === i ? Y.getAttrib(e, o) : D(e, o)),
                      r && !a && !t.exact)
                    )
                      return;
          ...
          if (o && e)
            for (s = 0; s < o.length; s++)
              if (
                ((a = o[s]),
                A(e, a) && i(e, a, "attributes") && i(e, a, "styles"))
              ) {
                if ((l = a.classes))
        ...
        function _(e, t, n) {
          ...
          return n
            ? r(n)
            : ((n = X.getNode()),
              r(n) ? re : ((i = X.getStart()), i != n && r(i) ? re : ne));
        }
        function S(e, t) {
          var n,
            r = [],
        ...
        function A(e, t) {
          return B(e, t.inline)
            ...
            ? re
            : t.selector
            ? 1 == e.nodeType && Y.is(e, t.selector)
            : void 0;
        }
        function B(e, t) {
          return (
        ...
        function L(e, t) {
          return (
            ("color" != t && "backgroundColor" != t) || (e = Y.toHex(e)),
        ...
        function O(t, n, r) {
          function i(e) {
            ...
            if (
              ...
              (s = Y.getRoot()),
              3 == r.nodeType && !P(r) && (e ? v > 0 : b < r.nodeValue.length))
            )
              return r;
            for (;;) {
          ...
          function c(t, n, i) {
            ...
            for (
              a = new e(t, Y.getParent(t, J) || s.getBody());
              (l = a[i ? "prev" : "next"]());
          ...
          function f(e, t) {
            var r,
              i = Y.getRoot();
            if (
              (n[0].wrapper || (r = Y.getParent(e, n[0].block, i)),
              r ||
                (r = Y.getParent(
              ...
              r && n[0].wrapper && (r = d(r, "ul,ol").reverse()[0] || r),
              !r)
            )
          ...
          if (
            ...
            (g = a(g)),
            (y = a(y)),
            (ce(g.parentNode) || ce(g)) &&
              ((g = ce(g) ? g : g.parentNode),
              (g = g.nextSibling || g),
              3 == g.nodeType && (v = 0)),
            (ce(y.parentNode) || ce(y)) &&
              ((y = ce(y) ? y : y.parentNode),
          ...
          return (
            ...
            n[0].selector &&
              n[0].expand !== ne &&
              !n[0].inline &&
              ((g = u(g, "previousSibling")), (y = u(y, "nextSibling"))),
            (n[0].block || n[0].selector) &&
              ((g = f(g, "previousSibling")),
              (y = f(y, "nextSibling")),
              n[0].block && (J(g) || (g = i(!0)), J(y) || (y = i()))),
        ...
        function F(e, t, n, r) {
          ...
          if ("all" != e.remove)
            for (
              ue(e.styles, function (i, o) {
                (i = L(M(i, t), o)),
                  "number" == typeof o && ((o = i), (r = 0)),
                  (e.remove_similar || !r || B(D(r, o), i)) &&
                    Y.setStyle(n, o, ""),
                  (a = 1);
              }),
                a &&
                ...
                ue(e.attributes, function (e, i) {
                  var o;
                  if (
                    ((e = M(e, t)),
                    "number" == typeof i && ((i = e), (r = 0)),
                    !r || B(Y.getAttrib(r, i), e))
                  ) {
                    if (
                      "class" == i &&
                      ((e = Y.getAttrib(n, i)),
        ...
        function z(e, t) {
          ...
          t.block &&
            (Q
              ? r == Y.getRoot() &&
                ((t.list_block && B(e, t.list_block)) ||
                  ue(de(e.childNodes), function (e) {
                    G(Q, e.nodeName.toLowerCase())
                      ? i
                        ? i.appendChild(e)
                        : ((i = H(e, Q)),
                          Y.setAttribs(i, s.settings.forced_root_block_attrs))
                      : (i = 0);
                  }))
              : J(e) &&
                !J(r) &&
                (n(e, ne) ||
                  n(e.firstChild, re, 1) ||
                  e.insertBefore(Y.create("br"), e.firstChild),
                n(e, re) ||
                  n(e.lastChild, ne, 1) ||
                  e.appendChild(Y.create("br")))),
        ...
        function V(t, n) {
          ...
          return (
            ...
            3 === r.nodeType &&
              ...
              (r = new e(r, s.getBody()).next() || r),
            3 !== r.nodeType ||
              n ||
              0 !== i ||
              (r = new e(r, s.getBody()).prev() || r),
            r
          );
        }
        function $(t, n, r, i) {
                ...
                fe(
                  ...
                  function (e) {
                    1 != e.nodeType ||
                      e.id === g ||
                      Y.isEmpty(e) ||
                      Y.setAttrib(e, "data-mce-bogus", null);
                  },
                  "childNodes"
                );
          }
        ...
        function q(t) {
          ...
          if (
            ...
            (3 == n.nodeType &&
              r >= n.nodeValue.length &&
              ((r = Z(n)), (n = n.parentNode), (i = !0)),
            1 == n.nodeType)
          )
            for (
              s = n.childNodes,
                n = s[Math.min(r, s.length - 1)],
                o = new e(n, Y.getParent(n, Y.isBlock)),
              ...
              if (3 == a.nodeType && !P(a))
                return (
                  (l = Y.create("a", { "data-mce-bogus": "all" }, ee)),
        ...
        return (
            ...
            a.isDefaultPrevented() ||
              ...
              c &&
                ...
                (e.isDirty() ||
                  (r(s[0] && n() != s[0].content),
                  e.isDirty() &&
                    e.fire("change", { level: s[0], lastLevel: null })),
                e.fire("TypingUndo"),
                (c = !1),
                e.nodeChanged()));
          }),
          e.on("KeyDown", function (e) {
            ...
            if (!e.isDefaultPrevented()) {
              ...
              !(16 > t || t > 20) ||
                ...
                o.typing ||
                n ||
                (o.beforeChange(), (o.typing = !0), o.add({}, e), (c = !0));
            }
          }),
          ...
          (o = {
            ...
            add: function (t, i) {
              ...
              if (
                (s[a] && (s[a].beforeBookmark = l),
                c.custom_undo_redo_levels &&
                  s.length > c.custom_undo_redo_levels)
              ) {
              ...
              return (
                e.fire("AddUndo", f), a > 0 && (r(!0), e.fire("change", f)), t
              );
            },
            undo: function () {
              var t;
              return (
                o.typing && (o.add(), (o.typing = !1)),
                a > 0 &&
                  ((t = s[--a]),
            ...
            extra: function (t, n) {
              ...
              o.transact(t) &&
                ((i = s[a].bookmark),
                (r = s[a - 1]),
                e.setContent(r.content, { format: "raw" }),
                e.selection.moveToBookmark(r.beforeBookmark),
                o.transact(n) && (s[a - 1].beforeBookmark = i));
            },
          })
        );
      };
    ...
    r(Z, [y, T, d], function (e, t, n) {
      ...
      return function (i) {
        function o(o) {
          ...
          function x(t) {
            var n, r, i;
            if (3 == D.nodeType && (t ? L > 0 : L < D.nodeValue.length))
              return !1;
            if (D.parentNode == M && V && !t) return !0;
            if (t && 1 == D.nodeType && D == M.firstChild) return !0;
            if (
              "TABLE" === D.nodeName ||
              (D.previousSibling && "TABLE" == D.previousSibling.nodeName)
            )
              return (V && !t) || (!V && t);
            for (
              n = new e(D, M),
          ...
          function w(e, t) {
            ...
            if (((r = a.getParent(e, a.isBlock)), !r || !h(r))) {
              if (
                ...
                (c =
                  r == i.getBody() || p(r)
                    ...
                    : r.parentNode.nodeName.toLowerCase()),
                !r.hasChildNodes())
              )
                return (
                  (n = a.create(d)),
              ...
              if (o && u.isValidChild(c, d.toLowerCase())) {
                for (
                  n = a.create(d), y(n), o.parentNode.insertBefore(n, o), s = o;
                  s && !a.isBlock(s);
          ...
          function N() {
            function e(e) {
              for (
                var t = F[e ? "firstChild" : "lastChild"];
                t && 1 != t.nodeType;
            ...
            if (F != i.getBody()) {
              ...
              /^(OL|UL|LI)$/.test(n) && (W = "LI"),
                ...
                e(!0) && e()
                  ...
                  ? "LI" == n
                    ? (a.insertAfter(O, t()),
                      O.appendChild(a.doc.createTextNode(" ")),
                      O.appendChild(F))
                    : F.parentNode.insertBefore(O, F)
                  : e()
                  ? (a.insertAfter(O, t()), m(O))
                  : ((F = t()),
                    (A = R.cloneRange()),
                    A.setStartAfter(M),
                    A.setEndAfter(F),
                    (I = A.extractContents()),
                    "LI" == W && "LI" == I.firstChild.nodeName
                      ? ((O = I.firstChild), a.insertAfter(I, F))
                      : (a.insertAfter(I, F), a.insertAfter(O, F))),
                a.remove(M),
                v(O),
                c.add();
            }
          ...
          function T() {
            (O = /^(H[1-6]|PRE|FIGURE)$/.test(z) && "HGROUP" != U ? C(W) : C()),
              l.end_container_on_empty_block && h(F) && a.isEmpty(M)
                ? (O = a.split(F, M))
                : a.insertAfter(O, M),
              v(O);
          }
          ...
          if (((R = s.getRng(!0)), !o.isDefaultPrevented())) {
            ...
            if (
              ...
              (W = W ? W.toUpperCase() : ""),
              (P = a.doc.documentMode),
              (H = o.shiftKey),
              1 == D.nodeType &&
                D.hasChildNodes() &&
                ((V = L > D.childNodes.length - 1),
                (D = D.childNodes[Math.min(L, D.childNodes.length - 1)] || D),
                (L = V && 3 == D.nodeType ? D.nodeValue.length : 0)),
              (B = S(D)))
            ) {
              ...
              if (
                (((W && !H) || (!W && H)) && (D = w(D, L)),
                (M = a.getParent(D, a.isBlock)),
                (F = M ? a.getParent(M.parentNode, a.isBlock) : null),
                (z = M ? M.nodeName.toUpperCase() : ""),
                (U = F ? F.nodeName.toUpperCase() : ""),
                "LI" != U || o.ctrlKey || ((M = F), (z = U)),
                /^(LI|DT|DD)$/.test(z))
              ) {
              ...
              (W && M === i.getBody()) ||
                ...
                x()
                  ? T()
                  : x(!0)
                  ? ((O = M.parentNode.insertBefore(C(), M)), m(O), v(M))
                  : ((A = R.cloneRange()),
                    A.setEndAfter(M),
                    (I = A.extractContents()),
                    _(I),
                    ...
                    a.isEmpty(M) && b(M),
                    O.normalize(),
                    a.isEmpty(O) ? (a.remove(O), T()) : v(O)),
                a.setAttrib(O, "id", ""),
                i.fire("NewBlock", { newBlock: O }),
                c.add());
            }
          }
        }
          ...
          if (((C = n.forced_root_block), t && 1 === t.nodeType && C)) {
            ...
            for (t = s.firstChild, b = s.nodeName.toLowerCase(); t; )
              if (
                ...
                h ||
                  ((h = r.create(C, e.settings.forced_root_block_attrs)),
    ...
    r(te, [z, y, _, $, k, U], function (e, t, n, r, i, o) {
      ...
      function v(e, t, r) {
        ...
        if (
          ...
          if (
            (E(a) || (a = a.parentNode),
            (l = a.getAttribute("data-mce-caret")),
            "before" == l && ((o = a.nextSibling), C(o)))
          )
            return S(o);
      ...
      var b = n.isContentEditableTrue,
        C = n.isContentEditableFalse,
        x = n.matchStyleValues(
          "display",
          "block table table-cell table-caption"
        ),
    ...
    r(ne, [_, U, $, te, p, z], function (e, t, n, r, i, o) {
      ...
      function c(t, i) {
        ...
        return e.isBr(t)
          ? ((o = u(1, n.after(t), i)),
            o ? !r.isInSameBlock(n.before(t), n.before(o), i) : !1)
          : !1;
      }
      function u(e, t, p) {
        var C, x, w, N, E, _, S;
        ...
        if (((S = t), (C = S.container()), (x = S.offset()), f(C))) {
          ...
          if (g(e) && x > 0 && ((N = s(C, x - 1)), v(N)))
            return !y(N) && (E = r.findNode(N, e, b, N))
              ? f(E)
                ? n(E, E.data.length)
                : n.after(E)
              : f(N)
        ...
        return ((m(e) && S.isAtEnd()) || (g(e) && S.isAtStart())) &&
          ((w = r.findNode(w, e, o.constant(!0), p, !0)), b(w))
          ? l(e, w)
          : ((N = r.findNode(w, e, b, p)),
            (_ = i.last(i.filter(a(C, p), d))),
            !_ || (N && _.contains(N))
              ? N
                ? l(e, N)
                : null
              : (S = m(e) ? n.after(_) : n.before(_)));
      }
    ...
    r(re, [m, ne, $], function (e, t, n) {
      var r = function (e) {
          var t = e.firstChild,
            n = e.lastChild;
          return (
            t && "meta" === t.name && (t = t.next),
            n && "mce_marker" === n.attr("id") && (n = n.prev),
            t && t === n ? "ul" === t.name || "ol" === t.name : !1
          );
        },
        i = function (e) {
          var t = e.firstChild,
      ...
      var l = a.matchNodeNames("td th"),
        c = function (a, c, u) {
          ...
          function y(t) {
            ...
            var s, c, u;
            if (t) {
              if ((D.scrollIntoView(t), (s = n(t))))
                return L.remove(t), void D.select(s);
              (S = L.createRng()),
                (k = t.previousSibling),
                k && 3 == k.nodeType
                  ? (S.setStart(k, k.nodeValue.length),
                    e.ie ||
                      ((T = t.nextSibling),
                      T &&
                        3 == T.nodeType &&
                        (k.appendData(T.data), T.parentNode.removeChild(T))))
                  : (S.setStartBefore(t), S.setEndBefore(t)),
                (c = L.getParent(t, L.isBlock)),
                L.remove(t),
                c &&
                  L.isEmpty(c) &&
                  (a.$(c).empty(),
                  ...
                  S.setEnd(c, 0),
                  l(c) || g(c) || !(u = o(S))
                    ? L.add(c, L.create("br", { "data-mce-bogus": "1" }))
                    : ((S = u), L.remove(c))),
                D.setRng(S);
            }
          }
          var b,
            ...
            R,
            A,
            B = a.schema.getTextInlineElements(),
            D = a.selection,
            L = a.dom;
          /^ | $/.test(c) && (c = d(c)),
            (b = a.parser),
            (A = u.merge),
            (C = new n({ validate: a.settings.validate }, a.schema)),
            (R =
              '<span id="mce_marker" data-mce-type="bookmark">&#xFEFF;&#x200B;</span>'),
            (E = { content: c, format: "html", selection: !0 }),
            a.fire("BeforeSetContent", E),
            (c = E.content),
            -1 == c.indexOf("{$caret}") && (c += "{$caret}"),
            (c = c.replace(/\{\$caret\}/, R)),
            (S = D.getRng());
          var M =
              S.startContainer || (S.parentElement ? S.parentElement() : null),
            P = a.getBody();
          M === P &&
            D.isCollapsed() &&
            L.isBlock(P.firstChild) &&
            v(P.firstChild) &&
            L.isEmpty(P.firstChild) &&
            ((S = L.createRng()),
            S.setStart(P.firstChild, 0),
            S.setEnd(P.firstChild, 0),
            D.setRng(S)),
            D.isCollapsed() ||
              ...
              f()),
            (x = D.getNode());
          var H = { context: x.nodeName.toLowerCase(), data: u.data };
          if (
            ((N = b.parse(c, H)),
            u.paste === !0 && s.isListFragment(N) && s.isParentBlockLi(L, x))
          )
            return (
              (S = s.insertAtCaret(C, L, a.selection.getRng(!0), N)),
              a.selection.setRng(S),
              void a.fire("SetContent", E)
            );
          if ((p(N), (k = N.lastChild), "mce_marker" == k.attr("id")))
            for (_ = k, k = k.prev; k; k = k.walk(!0))
              if (3 == k.type || !L.isBlock(k.name)) {
                a.schema.isValidChild(k.parent.name, "span") &&
                  k.parent.insert(_, k, "br" === k.name);
                break;
              }
          if ((a._selectionOverrides.showBlockCaretContainer(x), H.invalid)) {
            for (
              D.setContent(R),
                x = D.getNode(),
                w = a.getBody(),
                9 == x.nodeType ? (x = k = w) : (k = x);
              k !== w;

            )
              (x = k), (k = k.parentNode);
            (c = x == w ? w.innerHTML : L.getOuterHTML(x)),
              (c = C.serialize(
                b.parse(
                  c.replace(
        ...
        u = function (e) {
          var n;
          return "string" != typeof e
            ? ((n = t.extend({ paste: e.paste, data: { paste: e.paste } }, e)),
              { content: e.content, details: n })
            : { content: e, details: {} };
        },
        d = function (e, t) {
          var n = u(t);
        ...
        function p(e, t, r, i) {
          ...
          if (
            (/^(mceAddUndoLevel|mceEndUndoLevel|mceBeginUndoLevel|mceRepaint)$/.test(
              ...
              (i && i.skip_focus) ||
              n.focus(),
            (i = n.fire("BeforeExecCommand", { command: e, ui: t, value: r })),
            i.isDefaultPrevented())
          )
            return !1;
          if (((s = e.toLowerCase()), (o = B.exec[s])))
            return (
              o(s, t, r),
              n.fire("ExecCommand", { command: e, ui: t, value: r }),
              !0
            );
          if (
            (a(n.plugins, function (i) {
              return i.execCommand && i.execCommand(e, t, r)
                ? (n.fire("ExecCommand", { command: e, ui: t, value: r }),
                  (l = !0),
                  !1)
                : void 0;
          ...
          if (n.theme && n.theme.execCommand && n.theme.execCommand(e, t, r))
            return n.fire("ExecCommand", { command: e, ui: t, value: r }), !0;
          try {
            l = n.getDoc().execCommand(e, t, r);
          } catch (c) {}
          return l
            ? (n.fire("ExecCommand", { command: e, ui: t, value: r }), !0)
            : !1;
        }
        function m(e) {
          var t;
        ...
        n.on("PreInit", function () {
          ...
          v({
            ...
            "Cut,Copy,Paste": function (t) {
              ...
              if (
                ("paste" !== t || r.queryCommandEnabled(t) || (i = !0),
                i || !r.queryCommandSupported(t))
              ) {
                var a = n.translate(
                  "Your browser doesn't support direct access to the clipboard. Please use the Ctrl+X/C/V keyboard shortcuts instead."
                );
                e.mac && (a = a.replace(/Ctrl\+/g, "\u2318+")),
                  n.notificationManager.open({ text: a, type: "error" });
              }
            },
            unlink: function () {
              if (R.isCollapsed()) {
            ...
            FontSize: function (e, t, n) {
              ...
              n >= 1 &&
                7 >= n &&
                ((i = u(D.font_size_style_values)),
                (r = u(D.font_size_classes)),
                (n = r ? r[n - 1] || n : i[n - 1] || n)),
                _(e, n);
            },
            ...
            mceCleanup: function () {
              var e = R.getBookmark();
              n.setContent(n.getContent({ cleanup: f }), { cleanup: f }),
                R.moveToBookmark(e);
            },
            ...
            "Indent,Outdent": function (e) {
              ...
              (t = D.indentation),
                ...
                m("InsertUnorderedList") || m("InsertOrderedList")
                  ? N(e)
                  : (D.forced_root_block ||
                      T.getParent(R.getNode(), T.isBlock) ||
                      A.apply("div"),
                    a(R.getSelectedBlocks(), function (o) {
                      if (
                        "false" !== T.getContentEditable(o) &&
                        "LI" != o.nodeName
                      ) {
                        var a = n.getParam("indent_use_margin", !1)
                          ? "margin"
                          : "padding";
                        (a +=
                          "rtl" == T.getStyle(o, "direction", !0)
                            ? "Right"
                            : "Left"),
                          "outdent" == e
                            ? ((i = Math.max(
                              ...
                              T.setStyle(o, a, i ? i + r : ""))
                            : ((i = parseInt(o.style[a] || 0, 10) + t + r),
                              T.setStyle(o, a, i));
                      }
                    }));
            },
            ...
            mceReplaceContent: function (e, t, r) {
              n.execCommand(
                "mceInsertContent",
                !1,
                r.replace(/\{\$selection\}/g, R.getContent({ format: "text" }))
              );
            },
            mceInsertLink: function (e, t, n) {
              var r;
              "string" == typeof n && (n = { href: n }),
                (r = T.getParent(R.getNode(), "a")),
            ...
            delete: function () {
              ...
              T.isEmpty(e) &&
                (n.setContent(""),
                e.firstChild && T.isBlock(e.firstChild)
                  ? n.selection.setCursorLocation(e.firstChild, 0)
            ...
            InsertLineBreak: function (e, t, o) {
              function a() {
                for (
                  var e = new i(m, v), t, r = n.schema.getNonEmptyElements();
                  (t = e.next());
              ...
              if (1 == m.nodeType && m.hasChildNodes()) {
                ...
                (m = m.childNodes[Math.min(p, m.childNodes.length - 1)] || m),
                  (p = g && 3 == m.nodeType ? m.nodeValue.length : 0);
              }
              ...
              return (
                d &&
                  "PRE" == y &&
                  (!w || 8 > w) &&
                  l.parentNode.insertBefore(T.doc.createTextNode("\r"), l),
                (u = T.create("span", {}, "&nbsp;")),
                l.parentNode.insertBefore(u, l),
                R.scrollIntoView(u),
                T.remove(u),
                c
                  ? (h.setStartBefore(l), h.setEndBefore(l))
                  : (h.setStartAfter(l), h.setEndAfter(l)),
                R.setRng(h),
                n.undoManager.add(),
                f
              );
          ...
          v(
            {
              ...
              Outdent: function () {
                ...
                if (D.inline_styles) {
                  if (
                    (e = T.getParent(R.getStart(), T.isBlock)) &&
                    parseInt(e.style.paddingLeft, 10) > 0
                  )
                    return f;
                  if (
                    (e = T.getParent(R.getEnd(), T.isBlock)) &&
                    parseInt(e.style.paddingLeft, 10) > 0
                  )
                    return f;
                }
                return (
                  ...
                  m("InsertOrderedList") ||
                  (!D.inline_styles && !!T.getParent(R.getNode(), "BLOCKQUOTE"))
                );
              },
              "InsertUnorderedList,InsertOrderedList": function (e) {
    ...
    r(ke, [Ee, _e, Se, pe, g, u], function (e, t, n, r, i, o) {
        ...
        if (!g) {
          ...
          (g = function () {
            (document.all && t == e.clientWidth && n == e.clientHeight) ||
              ((t = e.clientWidth), (n = e.clientHeight), C.hideAll());
          }),
      ...
      function f(e, t) {
        var n,
          ...
          o;
        if (e) y.push(t);
        else for (n = y.length; n--; ) y[n] === t && y.splice(n, 1);
        if (y.length)
          for (n = 0; n < y.length; n++)
            y[n].modal && (r++, (o = y[n])),
              (y[n].getEl().style.zIndex = r),
              (y[n].zIndex = r),
              r++;
      ...
      var p,
        ...
        C = e.extend({
            ...
            t._super(e),
              ...
              t.on("postrender show", function (e) {
                if (e.control == t) {
                  ...
                  t.modal &&
                    !b &&
                    ((n = i("#" + r + "modal-block", t.getContainerElm())),
                    n[0] ||
                      (n = i(
                        '<div id="' +
                          r +
                          'modal-block" className="' +
                          r +
                          "reset " +
                          r +
                          'fade"></div>'
              ...
              e.popover &&
                ((t._preBodyHtml =
                  '<div className="' + t.classPrefix + 'arrow"></div>'),
                t.classes
                  .add("popover")
                  .add("bottom")
          ...
          close: function () {
            var e = this;
            return (
              e.fire("close").isDefaultPrevented() || (e.remove(), f(!1, e)), e
            );
          },
          remove: function () {
            h(this), this._super();
    ...
    r(Te, [ke, Ee, pe, g, we, me, d, u], function (e, t, n, r, i, o, a, s) {
      function l(e) {
        ...
        a.overrideViewPort !== !1 &&
          ...
          i && "undefined" != typeof f && (f = i),
          n.setAttribute("content", e ? t : f));
      }
      function c(e) {
      ...
      function u() {
        function e() {
          ...
          for (e = 0; e < d.length; e++)
            (r = d[e].layoutRect()),
              d[e].moveTo(
                d[e].settings.x || Math.max(0, t.w / 2 - r.w / 2),
                d[e].settings.y || Math.max(0, t.h / 2 - r.h / 2)
              );
        }
        if (!a.desktop) {
          ...
          init: function (e) {
            ...
            r._super(e),
              ...
              r.on("click", function (e) {
                ...
                (n.hasClass(e.target, t) ||
                  n.hasClass(e.target.parentNode, t)) &&
                  r.close();
              }),
            ...
            return (
              ...
              i.title &&
                (o =
                  ...
                  '-dragh" className="' +
                  r +
                  'dragh"></div><button type="button" className="' +
                  r +
                  'close" aria-hidden="true"><i className="mce-ico mce-i-remove"></i></button></div>'),
              i.url &&
              ...
              if (
                (r(window).on("resize", function () {
                  ...
                  if (t._fullscreen)
                    if (a)
                      t._timer ||
                        (t._timer = s.setTimeout(function () {
                ...
                (t._initial = { x: c.x, y: c.y, w: c.w, h: c.h }),
                ...
                (t.borderBox = o.parseBox(t.settings.border)),
                  ...
                  (c.deltaH += c.headerH),
                  r([i, document.body]).removeClass(l + "fullscreen"),
      ...
      return e.extend({
        ...
        renderHtml: function () {
          ...
          return (
            ...
            '" className="' +
            e.classes +
            '" role="presentation"><div className="' +
            t +
            'tooltip-arrow"></div><div className="' +
            t +
            'tooltip-inner">' +
      ...
      return e.extend({
        ...
        renderHtml: function () {
          ...
          return (
            ...
            '"><div className="' +
            n +
            'bar-container"><div className="' +
            n +
            'bar"></div></div><div className="' +
            n +
            'text">0%</div></div>'
          );
        },
        ...
        bindStates: function () {
          ...
          var t = this;
          return (
            t.state.on("change:value", function (t) {
              e(t.value);
            }),
            e(t.state.get("value")),
            t._super()
      ...
      return e.extend({
        ...
        renderHtml: function () {
          ...
          return (
            e.icon &&
              (n =
                '<i className="' + t + "ico " + t + "i-" + e.icon + '"></i>'),
      ...
      function (e, t, n, r, i, o, a, s, l, c, u, d) {
        return function (f) {
          ...
          function g(e) {
            var t, n;
            e.dataTransfer &&
              (f.selection.isCollapsed() &&
                "IMG" == e.target.tagName &&
                re.select(e.target),
              (t = f.selection.getContent()),
              t.length > 0 &&
                ((n = ue + escape(f.id) + "," + escape(t)),
                e.dataTransfer.setData(de, n)));
          }
          function v(e) {
            var t;
            return e.dataTransfer &&
              ((t = e.dataTransfer.getData(de)), t && t.indexOf(ue) >= 0)
              ? ((t = t.substr(ue.length).split(",")),
                { id: unescape(t[0]), html: unescape(t[1]) })
              : null;
          }
          function y(e) {
            f.queryCommandSupported("mceInsertClipboardContent")
              ? f.execCommand("mceInsertClipboardContent", !1, { content: e })
          ...
          function b() {
            ...
            function o(e, t) {
              ...
              for (n = e.nextSibling; n && n != t; n = n.nextSibling)
                if ((3 != n.nodeType || 0 !== Z.trim(n.data).length) && n !== t)
                  return !1;
              return n === t;
            }
            function a(e, t, r) {
              var o, a, s;
              for (
                s = C.schema.getNonEmptyElements(), o = new n(r || e, e);
                (a = o[t ? "next" : "prev"]());
            ...
            function c(e) {
              ...
              if (
                ...
                n != r &&
                  s[n.nodeName] &&
                  s[r.nodeName] &&
                  "false" !== C.getContentEditable(n) &&
                  "false" !== C.getContentEditable(r))
              )
                return (
                  e.deleteContents(),
                  (i = a(n, !1)),
                  (o = a(r, !0)),
                  C.isEmpty(r) || Z(n).append(r.childNodes),
                  Z(r).remove(),
                  i
                    ? 1 == i.nodeType
                      ? "BR" == i.nodeName
                      ...
                      : (e.setStart(i, i.data.length),
                        e.setEnd(i, i.data.length))
                    : o &&
                      (1 == o.nodeType
                        ? (e.setStartBefore(o), e.setEndBefore(o))
                        : (e.setStart(o, 0), e.setEnd(o, 0))),
                  x.setRng(e),
                  !0
                );
            }
            function u(e, n) {
              ...
              if (
                ((c = e.startContainer), (u = e.startOffset), 3 == c.nodeType)
              )
                if (n) {
              ...
              if (
                ...
                (s = C.getParent(r, C.isBlock)),
                (i = a(f.getBody(), n, r)),
                (l = C.getParent(i, C.isBlock)),
                !r || !i)
              )
                return e;
              if (l && s != l)
            ...
            function h(e, t) {
                ...
                return (
                  ...
                  (m = s.map(m, function (e) {
                    return (
                      (e = e.cloneNode(!1)),
                      l.hasChildNodes()
                        ? (e.appendChild(l.firstChild), l.appendChild(e))
                        : l.appendChild(e),
                      l.appendChild(e),
                      e
                    );
              ...
              if (
                ...
                ((d = t.startContainer),
                (h = t.startOffset),
                (a = C.getParent(d, C.isBlock)),
                i(a))
              )
                if (1 == d.nodeType) {
                  if (((d = d.childNodes[h]), d && "BR" != d.tagName)) return;
                  if (
                    ((u = e ? a.nextSibling : a.previousSibling),
                    C.isEmpty(a) && i(u) && C.isEmpty(u) && n(a, d))
                  )
                    return C.remove(u), !0;
            ...
            function p(e) {
              ...
              d(e) ||
                ...
                f
                  .getDoc()
                  .execCommand(e ? "ForwardDelete" : "Delete", !1, null),
                  ...
                  (n = f.selection.getRng()),
                    ...
                    r.length
                      ? ((i = C.createFragment()),
                        ...
                        (o = C.getParent(n.startContainer, C.isBlock)),
                        C.isEmpty(o) ? Z(o).empty().append(i) : n.insertNode(i),
                        n.setStart(a.firstChild, 1),
                        n.setEnd(a.firstChild, 1),
                        f.selection.setRng(n))
                      : f.selection.setContent(s);
                }
              }),
                ...
                f.on("cut", function (e) {
                  m(e) ||
                    ...
                    e.clipboardData.setData(
                      "text/html",
                      f.selection.getContent()
                    ),
                    e.clipboardData.setData(
                      "text/plain",
                      f.selection.getContent({ format: "text" })
                    ),
                    l.setEditorTimeout(f, function () {
                      p(!0);
                    }));
          ...
          function C() {
            function e(e) {
              var t = ne.create("body"),
                n = e.cloneContents();
              return (
                t.appendChild(n), re.serializer.serialize(t, { format: "html" })
              );
            }
            function n(n) {
              if (!n.setStart) {
            ...
            f.on("keydown", function (e) {
              ...
              if (!m(e) && (t == te || t == ee)) {
                ...
                e.preventDefault(),
                  f.setContent(""),
                  i.firstChild && ne.isBlock(i.firstChild)
                    ? f.selection.setCursorLocation(i.firstChild, 0)
                    : f.selection.setCursorLocation(i, 0),
                  f.nodeChanged();
              }
            });
          }
          ...
          function w() {
            f.settings.content_editable ||
              ne.bind(f.getDoc(), "mousedown mouseup", function (e) {
                var t;
              ...
              if (!m(e) && e.keyCode === ee) {
                ...
                if (re.isCollapsed() && 0 === re.getRng(!0).startOffset) {
                  var t = re.getNode(),
                    n = t.previousSibling;
                  if ("HR" == t.nodeName)
                    return ne.remove(t), void e.preventDefault();
                  n &&
                    n.nodeName &&
                    "hr" === n.nodeName.toLowerCase() &&
                    (ne.remove(n), e.preventDefault());
                }
              }
            });
          }
          ...
          function _() {
            f.on("click", function (e) {
              ...
              /^(IMG|HR)$/.test(t.nodeName) &&
                "false" !== ne.getContentEditableParent(t) &&
                (e.preventDefault(),
                re.getSel().setBaseAndExtent(t, 0, t, 1),
                f.nodeChanged()),
                "A" == t.nodeName &&
                  ne.hasClass(t, "mce-item-anchor") &&
                  (e.preventDefault(), re.select(t));
            });
          }
          function S() {
            function e() {
            ...
            function t() {
              return (
                !re.isCollapsed() &&
                ne.getParent(re.getStart(), ne.isBlock) !=
                  ne.getParent(re.getEnd(), ne.isBlock)
              );
            }
            f.on("keypress", function (n) {
              var r;
              return m(n) || (8 != n.keyCode && 46 != n.keyCode) || !t()
                ? void 0
                : ((r = e()),
          ...
          function R() {
            p() > 7 ||
              (h("RespectVisibilityInDesign", !0),
              f.contentStyles.push(".mceHideBrInPre pre br {display: none}"),
              ne.addClass(f.getBody(), "mceHideBrInPre"),
              oe.addNodeFilter("pre", function (e) {
          ...
          function A() {
            ne.bind(f.getBody(), "mouseup", function () {
              var e,
                t = re.getNode();
              "IMG" == t.nodeName &&
                ((e = ne.getStyle(t, "width")) &&
                  (ne.setAttrib(t, "width", e.replace(/[^0-9%]+/g, "")),
                  ne.setStyle(t, "width", "")),
                (e = ne.getStyle(t, "height")) &&
                  (ne.setAttrib(t, "height", e.replace(/[^0-9%]+/g, "")),
                  ne.setStyle(t, "height", "")));
            });
          }
          function B() {
            f.on("keydown", function (t) {
              ...
              if (
                ...
                "BLOCKQUOTE" === a.tagName &&
                  (f.formatter.toggle("blockquote", null, a),
                  (n = ne.createRng()),
                  n.setStart(r, 0),
                  n.setEnd(r, 0),
                  re.setRng(n));
          ...
          function D() {
            function e() {
              K(),
                ...
                ie.object_resizing || h("enableObjectResizing", !1);
            }
          ...
          function P() {
            f.on("keydown", function (e) {
              ...
              m(e) ||
                e.keyCode != ee ||
                ((t = f.getDoc().selection.createRange()),
                t &&
                  t.item &&
                  (e.preventDefault(),
          ...
          function O() {
            p() < 9 &&
              (oe.addNodeFilter("noscript", function (e) {
                for (var t = e.length, n, r; t--; )
                  (n = e[t]),
                    (r = n.firstChild),
          ...
          function I() {
            ...
            function n() {
              ...
              a &&
                ...
                a.select(),
                ne.unbind(r, "mouseup", n),
                ne.unbind(r, "mousemove", t),
                (a = o = 0);
            }
            var r = ne.doc,
              i = r.body,
            ...
            (r.documentElement.unselectable = !0),
              ne.bind(r, "mousedown contextmenu", function (i) {
            ...
            f.on("keypress", function (n) {
              ...
              f.on("keydown", function (e) {
                ...
                m(e) ||
                  (n != te && n != ee) ||
                  (t(f) &&
                    (e.preventDefault(), f.setContent(""), f.nodeChanged()));
              });
          }
          var Q = s.each,
            Z = f.$,
          ...
          return (
            ...
            ce &&
              ...
              Y(),
              a.iOS ? (U(), W(), q()) : x()),
            le && a.ie < 11 && (N(), k(), R(), A(), P(), H(), O(), I()),
            a.ie >= 11 && (W(), T()),
            a.ie && (x(), $(), X()),
            se && (J(), N(), E(), S(), D(), L(), z(), V(), T()),
            { refreshContentEditable: K, isHidden: G }
          );
        };
      }
    ),
      ...
      function i(e, t) {
        ...
        if ((e.delegates || (e.delegates = {}), !e.delegates[t]))
          if (e.settings.event_root) {
            ...
            (s = function (r) {
              for (
                var i = r.target, a = e.editorManager.editors, s = a.length;
                s--;
    ...
    r(Fe, [], function () {
      ...
      function n(n, r) {
        n._clickBlocker && (n._clickBlocker.unbind(), (n._clickBlocker = null)),
          r
            ? ((n._clickBlocker = t(n)),
              n.selection.controlSelection.hideResizeRect(),
              (n.readonly = !0),
              (n.getBody().contentEditable = !1))
            : ((n.readonly = !1),
              (n.getBody().contentEditable = !0),
              e(n, "StyleWithCSS", !1),
              e(n, "enableInlineTableEditing", !1),
              e(n, "enableObjectResizing", !1),
              n.focus(),
              n.nodeChanged());
      }
      function r(e, t) {
    ...
    r(ze, [m, d], function (e, t) {
      ...
      return function (a) {
        function s(e) {
          ...
          n(r(e, "+"), function (e) {
            e in o
              ? (l[e] = !0)
              : /^[0-9]{2,}$/.test(e)
              ? (l.keyCode = parseInt(e, 10))
              : ((l.charCode = e.charCodeAt(0)),
        ...
        function d(e, t) {
          return t
            ? t.ctrl != e.ctrlKey || t.meta != e.metaKey
              ? !1
              : t.alt != e.altKey || t.shift != e.shiftKey
              ? !1
              : e.keyCode == t.keyCode ||
        ...
        a.on("keyup keypress keydown", function (e) {
          (!c(e) && !u(e)) ||
            ...
            (n(p, function (t) {
              return d(e, t)
                ? ((m = t.subpatterns.slice(0)),
                  "keydown" == e.type && f(t),
                  !0)
                : void 0;
            }),
            d(e, m[0]) &&
              (1 === m.length && "keydown" == e.type && f(m[0]), m.shift()));
        }),
    ...
    r(Ue, [c, m, z], function (e, t, n) {
      return function (r, i) {
        ...
        function l(e, t, n, r) {
          ...
          (s = new XMLHttpRequest()),
            ...
            (s.onload = function () {
              var e;
              return 200 != s.status
                ? void n("HTTP Error: " + s.status)
                : ((e = JSON.parse(s.responseText)),
                  e && "string" == typeof e.location
                    ? void t(a(i.basePath, e.location))
                    : void n("Invalid JSON: " + s.responseText));
            }),
            (l = new FormData()),
            l.append("file", e.blob(), o(e)),
            s.send(l);
        }
        function c() {
        ...
        var y = {};
        return (
          (i = t.extend({ credentials: !1, handler: l }, i)), { upload: v }
        );
      };
    }),
    r(We, [c], function (e) {
    ...
    r(Ve, [c, p, z, We, d], function (e, t, n, r, i) {
      ...
      return function (a, s) {
        function l(l, u) {
          ...
          return (
            u || (u = n.constant(!0)),
            (f = t.filter(l.getElementsByTagName("img"), function (e) {
              var t = e.src;
              return i.fileApi
      ...
      return function () {
        ...
        function s(t) {
          c = e.filter(c, function (e) {
            return e.blobUri() === t
              ? (URL.revokeObjectURL(e.blobUri()), !1)
              : !0;
          });
        }
        function l() {
    ...
    r(je, [p, Ue, Ve, $e, qe], function (e, t, n, r, i) {
      return function (o) {
        ...
        function d(e, t) {
          y.removeByUri(e.src),
            c(e.src, t),
            o.$(e).attr({ src: t, "data-mce-src": o.convertURL(t, "src") });
        }
        function f(n) {
          return (
            b ||
                    ...
                    a(function (r) {
                      return (
                        (r = e.map(r, function (e, n) {
                          ...
                          return (
                            e.status &&
                              o.settings.images_replace_blob_uris !== !1 &&
                              d(r, e.url),
        ...
        function v(t) {
          return t.replace(/src="(blob:[^"]+)"/g, function (t, n) {
            ...
            return (
              ...
              i
                ? 'src="data:' + i.blob().type + ";base64," + i.base64() + '"'
                : t
            );
          });
        }
      ...
      return function (t, n) {
          ...
          return (
            "BODY" == t.tagName
              ? ((i = t.ownerDocument.documentElement),
                (a = t.scrollLeft || i.scrollLeft),
                (s = t.scrollTop || i.scrollTop))
              : ((c = t.getBoundingClientRect()),
                (a = t.scrollLeft - c.left),
                (s = t.scrollTop - c.top)),
            (r.left += a),
            (r.right += a),
            (r.top += s),
        ...
        function l() {
          ...
          for (n = i("*[contentEditable=false]", t), a = 0; a < n.length; a++)
            (r = n[a]),
              (o = r.previousSibling),
              e.endsWithCaretContainer(o) &&
                ((s = o.data),
                1 == s.length
                  ? o.parentNode.removeChild(o)
                  : o.deleteData(s.length - 1, 1)),
              (o = r.nextSibling),
              e.startsWithCaretContainer(o) &&
                ((s = o.data),
                1 == s.length
                  ? o.parentNode.removeChild(o)
                  : o.deleteData(0, 1));
        ...
        function c(o, a) {
          ...
          return (
            u(),
            n(a)
              ? ((g = e.insertBlock("p", a, o)),
                (l = r(a, o)),
                i(g).css("top", l.top),
                (m = i(
                  '<div className="mce-visual-caret" data-mce-bogus="all"></div>'
                )
                  .css(l)
                  .appendTo(t)),
                o && m.addClass("mce-visual-caret-before"),
                d(),
                ...
                c.setEnd(f, 1),
                c)
              : ((g = e.insertInline(a, o)),
                (c = a.ownerDocument.createRange()),
                s(g.nextSibling)
                  ? (c.setStart(g, 0), c.setEnd(g, 0))
                  : (c.setStart(g, 1), c.setEnd(g, 1)),
                c)
          );
        }
        function u() {
    ...
    r(Xe, [p, _, W], function (e, t, n) {
      function r(i) {
        ...
        if (t.isText(i)) {
          ...
          return (
            a.setStart(i, 0), a.setEnd(i, i.data.length), o(a.getClientRects())
          );
        }
      }
    ...
    r(Ke, [z, p, Xe, U, te, ne, $, W], function (e, t, n, r, i, o, a, s) {
      ...
      function c(e, r, i, o, a, s) {
        function c(o) {
          var s, l, c;
          for (
            c = n.getClientRects(o), -1 == e && (c = c.reverse()), s = 0;
            s < c.length;
            s++
          )
            if (((l = c[s]), !i(l, h))) {
        ...
        var u = 0,
          ...
          f = [],
          h;
        return (h = t.last(s.getClientRects()))
          ? ((d = s.getNode()), c(d), l(e, o, c, d), f)
          : f;
      }
      function u(e, t) {
        return t.line > e;
      ...
      function f(e, n, r, i) {
        ...
        var c = new o(n),
          ...
          v;
        1 == e
          ? ((u = c.next), (d = s.isBelow), (f = s.isAbove), (h = a.after(i)))
          : ((u = c.prev), (d = s.isAbove), (f = s.isBelow), (h = a.before(i))),
          (v = l(h));
        do
          if (h.isVisible() && ((g = l(h)), !f(g, v))) {
            if (
              (p.length > 0 && d(g, t.last(p)) && m++,
              (g = s.clone(g)),
              (g.position = h),
              (g.line = m),
              r(g))
    ...
    r(Ge, [z, p, _, Xe, W, te, U], function (e, t, n, r, i, o, a) {
      ...
      function d(e, n) {
        function o(e, i) {
          var o;
          return (
            (o = t.filter(r.getClientRects(i), function (t) {
              return !e(t, n);
            })),
            (a = a.concat(o)),
            0 === o.length
      ...
      function r(e) {
        ...
        function l(t) {
          var n,
            ...
            h;
          0 === t.button &&
            ((n = t.screenX - g.screenX),
            (r = t.screenY - g.screenY),
            (c = Math.max(Math.abs(n), Math.abs(r))),
            !g.dragging &&
              c > 10 &&
              ((g.dragging = !0),
              a("default"),
              (g.clone = g.element.cloneNode(!0)),
              (i = m.getPos(g.element)),
              (g.relX = g.clientX - i.x),
              (g.relY = g.clientY - i.y),
              ...
              (g.ghost = f("<div>")
                ...
                .append(g.clone)
                .appendTo(e.getBody())[0]),
              (o = e.dom.getViewPort(e.getWin())),
              (g.maxX = o.w),
              (g.maxY = o.h)),
            g.dragging &&
              (e._selectionOverrides.hideFakeCaret(),
              e.selection.placeCaretAt(t.clientX, t.clientY),
              (u = g.clientX + n - g.relX),
              (d = g.clientY + r + 5),
              u + g.width > g.maxX && (s = u + g.width - g.maxX),
              d + g.height > g.maxY && (l = d + g.height - g.maxY),
              (h =
                "BODY" != e.getBody().nodeName
                  ? e.getBody().getBoundingClientRect()
                  : { left: 0, top: 0 }),
              f(g.ghost).css({
                left: u - h.left,
                top: d - h.top,
        ...
        function c(t) {
          ...
          if (
            g.dragging &&
            (e.selection.setRng(e.selection.getSel().getRangeAt(0)),
        ...
        function u(a) {
          ...
          if (
            (d(),
            0 === a.button &&
              ((s = t.find(e.dom.getParents(a.target), n.or(i, o))), r(s)))
          ) {
            if (
              ((u = e.fire("dragstart", { target: s })), u.isDefaultPrevented())
            )
              return;
            e.on("mousemove", l),
              e.on("mouseup", c),
          ...
          e.on("drop", function (t) {
            var n =
              "undefined" != typeof t.clientX
                ...
                : null;
            (i(n) || i(e.dom.getContentEditableParent(n))) &&
              t.preventDefault();
          });
      }
    ...
    r(
      Qe,
      [d, ne, $, k, te, Ye, Ke, Ge, _, T, W, I, z, p, u, Je, S],
      function (e, t, n, r, i, o, a, s, l, c, u, d, f, h, p, m, g) {
        function v(e, t) {
        ...
        function y(c) {
          ...
          function R(e, t, n) {
            var r;
            return (
              (r = c.fire("ShowCaret", { target: t, direction: e, before: n })),
          ...
          function A(e) {
            ...
            return (
              ie.hide(),
              (t = c.fire("BeforeObjectSelected", { target: e })),
            ...
            return !r.collapsed && ((i = _(r)), x(i))
              ...
              : ((s = M(r)),
                ...
                n(o)
                  ...
                  : (o = t(o))
                  ? n(o)
                    ? R(e, o.getNode(-1 == e), 1 == e)
                    : ((a = t(o)),
                      n(a) && D(o, a)
                        ? R(e, a.getNode(-1 == e), 1 == e)
                        : s
                        ? V(o.toRange())
                        : null)
                  : s
          ...
          function O(t, r) {
            ...
            if (r.collapsed && c.settings.forced_root_block) {
              ...
              (a = 1 == t ? ne(n.fromRangeStart(r)) : re(n.fromRangeStart(r))),
                a ||
                  ((s = i()),
                  1 == t ? c.$(o).after(s) : c.$(o).before(s),
                  c.selection.select(s, !0),
          ...
          function U(e) {
            (e = se(e)),
              e.attr("data-mce-caret") &&
                (ie.hide(),
                e.removeAttr("data-mce-caret"),
                e.removeAttr("data-mce-bogus"),
                e.removeAttr("style"),
                S(k()),
                T(e[0]));
          }
          function W(e) {
            var t, r;
            return (
              (e = i.normalizeRange(1, ee, e)),
              (t = n.fromRangeStart(e)),
              x(t.getNode())
                ? R(1, t.getNode(), !t.isAtEnd())
                : x(t.getNode(!0))
                ? R(1, t.getNode(!0), !1)
                : ((r = c.dom.getParent(t.getNode(), f.or(x, C))),
                  x(r) ? R(1, r, !1) : (ie.hide(), null))
            );
          }
          function V(e) {
            var t;
          ...
          function $(e) {
            var t, i, o, a;
            return x(e)
              ? (x(e.previousSibling) && (o = e.previousSibling),
                (i = re(n.before(e))),
                i || (t = ne(n.after(e))),
                t && w(t.getNode()) && (a = t.getNode()),
                r.remove(e.previousSibling),
                r.remove(e.nextSibling),
                c.dom.remove(e),
                J(),
                c.dom.isEmpty(c.getBody())
                  ? (c.setContent(""), void c.focus())
                  : o
                  ? n.after(o).toRange()
                  : a
                  ? n.before(a).toRange()
          ...
          function q(e, t, n) {
            ...
            if (
              ((s = c.schema.getTextBlockElements()),
              (i = r.getParent(t.getNode(), r.isBlock)),
              (o = r.getParent(n.getNode(), r.isBlock)),
              i === o || !s[i.nodeName] || !s[o.nodeName])
            )
              return null;
          ...
          function j(e, t, n, i) {
            var o, a, s, l;
            return !i.collapsed && ((o = _(i)), x(o))
              ? V($(o))
              : ((a = L(e, i)),
                n(a) && r.isCaretContainerBlock(i.startContainer)
                  ? ((l = -1 == e ? te.prev(a) : te.next(a)),
                    l ? V(l.toRange()) : i)
                  : t(a)
                  ? V($(a.getNode(-1 == e)))
                  : ((s = -1 == e ? te.prev(a) : te.next(a)),
                    t(s) ? (-1 === e ? q(e, a, s) : q(e, s, a)) : void 0));
          }
          function Y() {
            function e(e, t) {
              var n = t(k());
            ...
            function l() {
              var e,
                t = r(c.selection.getNode());
              C(t) &&
                y(t) &&
                c.dom.isEmpty(t) &&
                ((e = c.dom.create("br", { "data-mce-bogus": "1" })),
                c.$(t).empty().append(e),
            ...
            function f(e) {
              var t = z();
              if (t)
                return "compositionstart" == e.type
                  ? (e.preventDefault(), e.stopPropagation(), void U(t))
                  : void ("&nbsp;" != t.innerHTML && U(t));
            }
            function g(e) {
              var t;
              switch (e.keyCode) {
            ...
            o(c),
              c.on("mousedown", function (e) {
                ...
                if ((t = r(e.target)))
                  x(t)
                    ? (e.preventDefault(), G(A(t)))
                    : (J(),
                      i(e.clientX, e.clientY, c.selection.getRng()) ||
                        c.selection.placeCaretAt(e.clientX, e.clientY));
                else {
                  J(), ie.hide();
          ...
          function X() {
            ...
            e.push(ie.getCss()),
              e.push(
                t +
                  " .mce-offscreen-selection {position: absolute;left: -9999999999px;width: 100px;height: 100px;}" +
                  t +
          ...
          function K(e) {
            return (
              r.isCaretContainer(e.startContainer) ||
              r.isCaretContainer(e.endContainer)
            );
          }
          function G(t) {
            var n,
            ...
            return (
              ...
              3 == s.nodeType &&
                0 == l &&
                x(s.parentNode) &&
                ((s = s.parentNode), (l = i.nodeIndex(s)), (s = s.parentNode)),
              1 != s.nodeType
                ? (J(), null)
                : (u == l + 1 && (n = s.childNodes[l]),
                  x(n)
                    ? ((h = p = n.cloneNode(!0)),
                      (d = c.fire("ObjectSelected", {
                        target: n,
                        targetClone: h,
                      })),
                        ...
                        : ((h = d.targetClone),
                          ...
                          h === p && e.ie
                            ? (o
                                ...
                                .append(h)
                                .append(g.ZWSP),
                              t.setStart(o[0].firstChild, 0),
                              t.setEnd(o[0].lastChild, 1))
                            : (o
                                .empty()
                                .append("\xa0")
                                .append(h)
                                .append("\xa0"),
                              t.setStart(o[0].firstChild, 1),
                              t.setEnd(o[0].lastChild, 0)),
                          o.css({ top: i.getPos(n, c.getBody()).y }),
                          o[0].focus(),
          ...
          return (
            e.ceFalse && (Y(), X()),
            { showBlockCaretContainer: U, hideFakeCaret: Z, destroy: Q }
          );
        }
        var b = f.curry,
      ...
      function (
        ...
        function B(e, t, i) {
          ...
          (a = o.documentBaseUrl = i.documentBaseURL),
            ...
            (o.editorManager = i),
            (o.inline = t.inline),
            (o.settings.content_editable = o.inline),
            t.cache_suffix &&
              (w.cacheSuffix = t.cache_suffix.replace(/^[\?\&]+/, "")),
          ...
          (B.prototype = {
            render: function () {
              ...
              function t() {
                ...
                N.isArray(r.plugins) && (r.plugins = r.plugins.join(" ")),
                  H(r.external_plugins, function (e, t) {
              ...
              if (n.getElement() && w.contentEditable) {
                ...
                a &&
                  ...
                  r.hidden_input &&
                    ...
                    (D.insertAfter(
                      D.create("input", { type: "hidden", name: i }),
                      i
                    ),
                    (n.hasHiddenInput = !0)),
                  ...
                  D.bind(a, "submit reset", n.formEventDelegate),
                  n.on("reset", function () {
            ...
            init: function () {
              function e(n) {
                var r = M.get(n),
                  ...
                  o;
                if (
                  ((i = M.urls[n] || t.documentBaseUrl.replace(/\/$/, "")),
                  (n = F(n)),
                  r && -1 === I(m, n))
                ) {
                  if (
                    (H(M.dependencies(n), function (t) {
                      e(t);
                    }),
                    t.plugins[n])
                  )
              ...
              if (
                ...
                D.setAttrib(y, "src", u || 'javascript:""'),
                (t.contentAreaContainer = l.iframeContainer),
                (t.iframeElement = y),
                (s = D.add(l.iframeContainer, y)),
                V)
              )
                try {
                  t.getDoc();
              ...
              l.editorContainer &&
                ((D.get(l.editorContainer).style.display = t.orgDisplay),
                (t.hidden = D.isHidden(l.editorContainer))),
                (t.getElement().style.display = "none"),
                D.setAttrib(t.id, "aria-hidden", !0),
                u || t.initContentBody(),
                (r = s = l = null);
            },
            initContentBody: function (t) {
              ...
              r.inline || (n.getElement().style.visibility = n.orgVisibility),
                ...
                r.content_editable &&
                  (n.on("remove", function () {
                    var e = this.getBody();
                    D.removeClass(e, "mce-content-body"),
                      D.removeClass(e, "mce-edit-focus"),
                      D.setAttrib(e, "contentEditable", null);
                  }),
                  D.addClass(s, "mce-content-body"),
                ...
                n.readonly ||
                  (n.inline &&
                    "static" == D.getStyle(p, "position", !0) &&
                ...
                r.browser_spellcheck ||
                  r.gecko_spellcheck ||
                  ((h.body.spellcheck = !1),
                  D.setAttrib(p, "spellcheck", "false")),
                (n.quirks = new x(n)),
                n.fire("PostRender"),
                ...
                n.contentStyles.length > 0 &&
                  ((m = ""),
                  H(n.contentStyles, function (e) {
                    m += e + "\r\n";
                  }),
                  n.dom.addStyle(m)),
                H(n.contentCSS, function (e) {
            ...
            focus: function (e) {
              ...
              if (!e) {
                if (
                  ((o = r.getRng()),
                  o.item && (a = o.item(0)),
                  n.quirks.refreshContentEditable(),
                  (c = t(r.getNode())),
                  n.$.contains(l, c))
                )
                  return (
                    c.focus(), r.normalize(), void n.editorManager.setActive(n)
                  );
                if (
                  (i || (w.opera || n.getBody().focus(), n.getWin().focus()),
                  W || i)
                ) {
                  if (l.setActive)
                    try {
            ...
            show: function () {
              ...
              e.hidden &&
                ...
                e.inline
                  ...
                  : (D.show(e.getContainer()), D.hide(e.id)),
                e.load(),
                e.fire("show"));
            },
            hide: function () {
              var e = this,
                t = e.getDoc();
              e.hidden ||
                (V && t && !e.inline && t.execCommand("SelectAll"),
                e.save(),
                e.inline
                  ? ((e.getBody().contentEditable = !1),
                    e == e.editorManager.focusedEditor &&
                      (e.editorManager.focusedEditor = null))
                  : (D.hide(e.getContainer()),
                    D.setStyle(e.id, "display", e.orgDisplay)),
                (e.hidden = !0),
                e.fire("hide"));
            },
            isHidden: function () {
                ...
                return (
                  ...
                  /TEXTAREA|INPUT/i.test(n.nodeName)
                    ...
                    : (t.inline || (n.innerHTML = r),
                      (i = D.getParent(t.id, "form")) &&
                        H(i.elements, function (e) {
            ...
            setContent: function (e, t) {
              ...
              return (
                ...
                (e = t.content),
                0 === e.length || /^\s+$/.test(e)
                  ? ((o = V && 11 > V ? "" : '<br data-mce-bogus="1">'),
                    "TABLE" == r.nodeName
                      ? (e = "<tr><td>" + o + "</td></tr>")
                      : /^(UL|OL)$/.test(r.nodeName) &&
                        (e = "<li>" + o + "</li>"),
                    ...
                    n.schema.isValidChild(
                      ...
                      : V || e || (e = '<br data-mce-bogus="1">'),
                    n.dom.setHTML(r, e),
                    n.fire("SetContent", t))
                  : ("raw" !== t.format &&
                      (e = new s({ validate: n.validate }, n.schema).serialize(
            ...
            getContent: function (e) {
              ...
              return (
                ...
                (n =
                  "raw" == e.format
                    ? t.serializer.getTrimmedContent()
                    : "text" == e.format
                    ? r.innerText || r.textContent
                    : t.serializer.serialize(r, e)),
                "text" != e.format ? (e.content = F(n)) : (e.content = n),
            ...
            getContainer: function () {
              ...
              return (
                e.container ||
                  (e.container = D.get(e.editorContainer || e.id + "_parent")),
                e.container
              );
            },
            ...
            getElement: function () {
              return (
                this.targetElm || (this.targetElm = D.get(this.id)),
                this.targetElm
              );
            },
            getWin: function () {
            ...
            addVisual: function (e) {
              ...
              (e = e || n.getBody()),
                ...
                H(i.select("table,a", e), function (e) {
                  var t;
                  switch (e.nodeName) {
                    case "TABLE":
                      return (
            ...
            remove: function () {
              ...
              e.removed ||
                ...
                e.hasHiddenInput && D.remove(e.getElement().nextSibling),
                e.inline ||
                  (V && 10 > V && e.getDoc().execCommand("SelectAll", !1, null),
                  D.setStyle(e.id, "display", e.orgDisplay),
                  (e.getBody().onload = null)),
                e.fire("remove"),
                e.editorManager.remove(e),
                D.remove(e.getContainer()),
              ...
              if (!t.destroyed) {
                ...
                e ||
                  ...
                  n &&
                    ...
                    D.unbind(n, "submit reset", t.formEventDelegate)),
    ...
    r(nt, [w, u, d], function (e, t, n) {
      function r(e) {
        ...
        function f(r) {
          ...
          f.on("init", function () {
            (f.inline || n.ie) &&
              ("onbeforedeactivate" in document && n.ie < 9
                ? f.dom.bind(f.getBody(), "beforedeactivate", function (e) {
                ...
                : f.on("nodechange mouseup keyup", function (e) {
                    ...
                    ("nodechange" == e.type && e.selectionChange) ||
                      (t && t.id == f.id + "_ifr" && (t = f.getBody()),
                      f.dom.isChildOf(t, f.getBody()) &&
                        (f.lastRng = f.selection.getRng()));
                  }),
              n.webkit &&
                !i &&
            ...
            f.on("focusin", function () {
              var t = e.focusedEditor,
                n;
              f.selection.lastFocusBookmark &&
                ((n = u(f, f.selection.lastFocusBookmark)),
                (f.selection.lastFocusBookmark = null),
                f.selection.setRng(n)),
                t != f &&
                  (t && t.fire("blur", { focusedEditor: f }),
                  e.setActive(f),
                  (e.focusedEditor = f),
                  f.fire("focus", { blurredEditor: t }),
                  f.focus(!0)),
                (f.lastRng = null);
            }),
            f.on("focusout", function () {
              t.setEditorTimeout(f, function () {
                ...
                d(l()) ||
                  t != f ||
                  (f.fire("blur", { focusedEditor: null }),
                  (e.focusedEditor = null),
                  f.selection && (f.selection.lastFocusBookmark = null));
              });
            }),
            o ||
              ((o = function (t) {
                ...
                (r = t.target),
                  n &&
                    ...
                    (n.selection &&
                      r != n.getBody() &&
                      (n.selection.lastFocusBookmark = c(n.dom, n.lastRng)),
                    r == document.body ||
                      d(r) ||
                      e.focusedEditor != n ||
        ...
        function h(t) {
          e.focusedEditor == t.editor && (e.focusedEditor = null),
            e.activeEditor ||
              (s.unbind(document, "selectionchange", i),
      ...
      var i,
        ...
        s = e.DOM;
      return (
        (r.isEditorUIElement = function (e) {
    ...
    r(
      ...
      function (e, t, n, r, i, o, a, s, l, c) {
        ...
        function d(e, n) {
          n !== x &&
            (n
              ? t(window).on("resize scroll", u)
              : t(window).off("resize scroll", u),
            (x = n));
        }
        function f(e) {
          var t = C.editors,
          ...
          return (
            C.activeEditor == e && (C.activeEditor = t[0]),
          ...
          (C = {
            ...
            setup: function () {
              var e = this,
                ...
                a;
              if (
                ((n = r.getDocumentBaseUrl(document.location)),
                /^[^:]+:\/\/\/?[^\/]+\//.test(n) &&
                  ((n = n.replace(/[\?#].*$/, "").replace(/[\/\\][^\/]+$/, "")),
                  /[\/\\]$/.test(n) || (n += "/")),
            ...
            overrideDefaults: function (e) {
              ...
              (t = e.base_url),
                t &&
                  ((this.baseURL = new r(this.documentBaseURL).toAbsolute(
                    t.replace(/\/+$/, "")
                  )),
            ...
            init: function (n) {
              ...
              function l(e) {
                var t = n[e];
                if (t)
                  return t.apply(f, Array.prototype.slice.call(arguments, 2));
              }
              function c(e, t) {
                ...
                switch (e.mode) {
                  ...
                  case "specific_textareas":
                    g(p.select("textarea"), function (t) {
                      (e.editor_deselector && c(t, e.editor_deselector)) ||
                        (e.editor_selector && !c(t, e.editor_selector)) ||
                        n.push(t);
                    });
                }
                return n;
              ...
              function d() {
                ...
                var c = 0,
                  ...
                  y;
                return (
                  p.unbind(window, "ready", d),
                  l("onpageload"),
                  (y = t.unique(u(n))),
                  n.types
                    ? void g(n.types, function (e) {
                        o.each(y, function (t) {
                          return p.is(t, e.selector)
                            ? (a(s(t), v({}, n, e), t), !1)
                            : !0;
                        });
                      })
            ...
            remove: function (e) {
                ...
                i;
              {
                if (e)
                  return "string" == typeof e
                    ? ((e = e.selector || e),
                      void g(p.select(e), function (e) {
                        (i = r[e.id]), i && t.remove(i);
                      }))
                    : ((i = e),
                      r[i.id]
                        ? (f(i) && t.fire("RemoveEditor", { editor: i }),
                          r.length || p.unbind(window, "beforeunload", b),
                          i.remove(),
                          d(r, r.length > 0),
                          i)
                        : null);
      ...
      var n = {
        send: function (e) {
          ...
          if (
            ...
            (e.async = e.async !== !1),
            (e.data = e.data || ""),
            n.fire("beforeInitialize", { settings: e }),
        ...
        renderHtml: function () {
          ...
          return (
            ...
            o &&
              ...
              (a =
                '<span className="' + n + 'txt">' + e.encode(o) + "</span>")),
        ...
        renderHtml: function () {
          ...
          return (
            r &&
              (e.classes.add("btn-has-text"),
              (a =
                '<span className="' + n + 'txt">' + e.encode(r) + "</span>")),
            '<div id="' +
              t +
              '" className="' +
              e.classes +
              ...
              n +
              'open" hidefocus="1" tabindex="-1"> <i className="' +
              n +
              'caret"></i></button></div>'
          );
        },
        ...
        renderHtml: function () {
          ...
          return (
            ...
            '<div id="' +
              ...
              '-sv" className="' +
              r +
              'colorpicker-sv"><div className="' +
              r +
              'colorpicker-overlay1"><div className="' +
              r +
              'colorpicker-overlay2"><div id="' +
              n +
              '-svp" className="' +
              r +
              'colorpicker-selector1"><div className="' +
              r +
        ...
        _getDataPathHtml: function (e) {
          ...
          for (r = 0, i = n.length; i > r; r++)
            o +=
              ...
              n[r].name +
              "</div>";
          return o || (o = '<div className="' + a + 'path-item">\xa0</div>'), o;
        },
      });
    }),
    r(Nt, [wt], function (e) {
        ...
        recalc: function (e) {
          ...
          for (
            ...
            (h = r[t]),
              ...
              (g = m.flex),
              (d -= n - 1 > t ? c : 0),
              g > 0 && ((u += g), p[k] && v.push(h), (p.flex = g)),
              (d -= p[_]),
              (y = o[H] + p[P] + o[O]),
              y > N && (N = y);
          if (
            ((x = {}),
            0 > d ? (x[_] = i[_] - d + i[A]) : (x[_] = i[R] - d + i[A]),
            (x[P] = N + i[I]),
            (x[B] = i[R] - d),
            (x[F] = N),
            (x.minW = U(x.minW, i.maxW)),
            (x.minH = U(x.minH, i.maxH)),
            (x.minW = z(x.minW, i.startMinWidth)),
            (x.minH = z(x.minH, i.startMinHeight)),
            !i.autoResize || (x.minW == i.minW && x.minH == i.minH))
          ) {
            ...
            for (
              ...
              (h = r[t]),
                ...
                (y = p.maxFlexSize || p[_]),
                "center" === s
                  ? (x[D] = Math.round(i[L] / 2 - p[M] / 2))
                  : "stretch" === s
                  ? ((x[M] = z(p[P] || 0, i[L] - o[H] - o[O])), (x[D] = o[H]))
                  : "end" === s && (x[D] = i[L] - p[M] - o.top),
                p.flex > 0 && (y += p.flex * C),
                (x[E] = y),
                (x[S] = w),
                h.layoutRect(x),
            ...
            for (p = g.top, f = 0; n > f; f++) {
              for (
                ...
                (m = u.settings),
                  ...
                  (c.x = h),
                  (c.y = p),
                  (v = m.alignH || (C ? C[d] || C[0] : null)),
                  "center" == v
                    ? (c.x = h + a / 2 - c.w / 2)
                    : "right" == v
                    ? (c.x = h + a - c.w)
                    : "stretch" == v && (c.w = a),
                  (v = m.alignV || (x ? x[d] || x[0] : null)),
                  "center" == v
                    ? (c.y = p + s / 2 - c.h / 2)
                    : "bottom" == v
                    ? (c.y = p + s - c.h)
      ...
      return e.extend({
        ...
        renderHtml: function () {
          ...
          return (
            ...
            '-body">' +
            e.encode(e.state.get("text")) +
            '<button role="button" tabindex="-1"><i className="' +
            t +
            "ico " +
            t +
    ...
    r(Pt, [De, pe], function (e, t) {
      return e.extend({
        ...
        renderHtml: function () {
          ...
          return (
            !r &&
              (n = e.settings.forName) &&
              ((t = e.getRoot().find("#" + n)[0]), t && (r = t._id)),
            r
              ? '<label id="' +
                e._id +
                '" className="' +
        ...
        renderHtml: function () {
          ...
          return (
            ...
            a &&
              (e.classes.add("btn-has-text"),
              (s =
                '<span className="' + r + 'txt">' + e.encode(a) + "</span>")),
            ...
            '<div id="' +
              ...
              (c
                ? '<div id="' +
                  ...
                  "</div>"
                : "") +
              (i.menu ? '<div className="' + o + 'caret"></div>' : "") +
              "</div>"
          );
        },
        postRender: function () {
      ...
      return e.extend({
        ...
        load: function () {
          ...
          (i = t.settings.itemsFactory),
            i &&
              (t.throbber ||
                ((t.throbber = new n(t.getEl("body"), !0)),
                0 === t.items().length
                ...
                t.on("hide close", e)),
              (t.requestTime = r = new Date().getTime()),
              t.settings.itemsFactory(function (n) {
                return 0 === n.length
                  ? void t.hide()
                  : void (
                      t.requestTime === r &&
    ...
    r(qt, [De], function (e) {
      ...
      return e.extend({
        ...
        bindStates: function () {
          var e = this;
          return (
            e.state.on("change:options", function (n) {
        ...
        postRender: function () {
          ...
          function o(t, n) {
            function o(o) {
              var a;
              (a = s.value()),
                (a = i(t, n, e(t, n, a) + 0.05 * o)),
                (a = r(a, t, n)),
                s.value(a),
                s.fire("dragstart", { value: a }),
                s.fire("drag", { value: a }),
                s.fire("dragend", { value: a });
            }
            ...
            s._dragHelper = new t(s._id, {
              ...
              drag: function (t) {
                ...
                (p = r(l + n, 0, c)),
                  ...
                  s
                    .tooltip()
                    .text("" + s.settings.previewFilter(m))
                    .show()
                    .moveRel(o, "bc tc"),
                  s.fire("drag", { value: m });
              },
          ...
          (l = s._minValue),
            (c = s._maxValue),
            "v" == s.settings.orientation
              ? ((u = "screenY"), (d = "top"), (f = "height"), (h = "h"))
              : ((u = "screenX"), (d = "left"), (f = "width"), (h = "w")),
            s._super(),
      ...
      return e.extend({
        renderHtml: function () {
          ...
          return (
            ...
            (e.canFocus = !1),
            '<div id="' + e._id + '" className="' + e.classes + '"></div>'
          );
        },
      });
    }),
    ...
    r(Qt, [], function () {
      ...
      return (
        "function" == typeof e.define &&
          (e.define.amd || e.define("ephox/tinymce", [], t)),
        {}
      );
    }),
    a([
