  ...
  Plugin.prototype = {
    ...
    initTemplate: function () {
      this.template =
        ...
        '<div className="dtp-close"><a href="javascript:void(0);"><i className="material-icons">clear</i></</div>' +
        "</header>" +
        ...
        "</div>" +
        '<div className="dtp-actual-year p80">2014</div>' +
        '<div className="right center p10">' +
        ...
        '<button className="dtp-btn-now btn btn-flat hidden">' +
        this.params.nowText +
        "</button>" +
        '<button className="dtp-btn-clear btn btn-flat hidden">' +
        this.params.clearText +
        "</button>" +
        '<button className="dtp-btn-cancel btn btn-flat">' +
        this.params.cancelText +
        "</button>" +
        '<button className="dtp-btn-ok btn btn-flat">' +
        this.params.okText +
        "</button>" +
        '<div className="clearfix"></div>' +
        "</div>" +
    ...
    initHours: function () {
      ...
      for (var i = 0; i < 12; i++) {
        ...
        var fill =
          this.currentDate.format(hFormat) == i ? "#007d72" : "transparent";
    ...
    initMinutes: function () {
      ...
      for (var i = 0; i < 60; i++) {
        ...
        var color =
          this.currentDate.format("m") == i ? "#007d72" : "transparent";
    ...
    constructHTMLCalendar: function (date, calendar) {
      ...
      _template +=
        '<div className="dtp-picker-month">' +
        ...
        if (calendar.days[i] != 0) {
          if (
            ...
            if (
              ...
              _template +=
                '<a href="javascript:void(0);" className="dtp-select-day selected">' +
                moment(calendar.days[i]).locale(this.params.lang).format("DD") +
                "</a>";
            } else {
              _template +=
                '<a href="javascript:void(0);" className="dtp-select-day">' +
                moment(calendar.days[i]).locale(this.params.lang).format("DD") +
                "</a>";
            }
          }
