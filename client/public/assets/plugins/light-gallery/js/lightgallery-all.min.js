...
!(function (a, b, c, d) {
  ...
  (e.prototype.init = function () {
    ...
    (e.prototype.structure = function () {
      var c,
        ...
        h = this;
      for (
        a("body").append('<div className="lg-backdrop"></div>'),
          a(".lg-backdrop").css(
            "transition-duration",
        ...
        d += '<div className="lg-item"></div>';
      if (
        (this.s.controls &&
          this.$items.length > 1 &&
          (e =
            '<div className="lg-actions"><div className="lg-prev lg-icon">' +
            this.s.prevHtml +
            '</div><div className="lg-next lg-icon">' +
            this.s.nextHtml +
            "</div></div>"),
        ".lg-sub-html" === this.s.appendSubHtmlTo &&
          (g = '<div className="lg-sub-html"></div>'),
        (c =
          ...
          d +
          '</div><div className="lg-toolbar group"><span className="lg-close lg-icon"></span></div>' +
          e +
          g +
          "</div></div>"),
        a("body").append(c),
    ...
    (e.prototype.manageSwipeclassName = function () {
      var a = this.index + 1,
        b = this.index - 1,
        c = this.$slide.length;
      this.s.loop &&
  ...
  (function (a, b, c, d) {
    ...
    (f.prototype.init = function () {
      ...
      (f.prototype.controls = function () {
        var b = this,
          c = '<span className="lg-autoplay-button lg-icon"></span>';
    ...
    (f.prototype.init = function () {
      ...
      if (this.core.s.fullScreen) {
        if (
          ...
          return;
        (a = '<span className="lg-fullscreen lg-icon"></span>'),
    ...
    (f.prototype.init = function () {
      ...
      (f.prototype.build = function () {
        ...
        var d,
          ...
          g = "",
          h =
            '<div className="lg-thumb-outer"><div className="lg-thumb group"></div></div>';
  ...
  (function (a, b, c, d) {
    ...
    (f.prototype.init = function () {
      ...
      c.core.s.actualSize &&
        (d += '<span id="lg-actual-size" className="lg-icon"></span>'),
