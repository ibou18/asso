  ...
  AbstractChosen = (function () {
    ...
    AbstractChosen.prototype.choice_label = function (item) {
      if (this.include_group_label_in_selected && item.group_label != null) {
        return (
          "<b className='group-name'>" + item.group_label + "</b>" + item.html
        );
      } else {
        return item.html;
      }
  ...
  this.Chosen = (function (_super) {
    ...
    Chosen.prototype.set_default_values = function () {
      ...
      this.single_temp = new Template(
        '<a className="chosen-single chosen-default"><span>#{default}</span><div><b></b></div></a><div className="chosen-drop"><div className="chosen-search"><input type="text" autocomplete="off" /></div><ul className="chosen-results"></ul></div>'
      );
      this.multi_temp = new Template(
        '<ul className="chosen-choices"><li className="search-field"><input type="text" value="#{default}" className="default" autocomplete="off" style="width:25px;" /></li></ul><div className="chosen-drop"><ul className="chosen-results"></ul></div>'
      );
    ...
    Chosen.prototype.set_up_html = function () {
      ...
      this.container = this.is_multiple
        ? new Element("div", container_props).update(
            this.multi_temp.evaluate({
              default: this.default_text,
            })
          )
        : new Element("div", container_props).update(
            this.single_temp.evaluate({
              default: this.default_text,
            })
          );
      ...
      if (!this.is_disabled) {
        ...
        if (!(evt != null && evt.target.hasClassName("search-choice-close"))) {
          if (!this.active_field) {
            ...
            this.container.ownerDocument.observe(
              "click",
              this.click_test_action
            );
            this.results_show();
    ...
    Chosen.prototype.search_results_mouseup = function (evt) {
      var target;
      target = evt.target.hasClassName("active-result")
        ? evt.target
    ...
    Chosen.prototype.result_select = function (evt) {
      ...
      if (this.result_highlight) {
        ...
        this.show_search_field_default();
        if (
          typeof Event.simulate === "function" &&
          (this.is_multiple ||
    ...
    Chosen.prototype.single_deselect_control_build = function () {
      ...
      if (!this.selected_item.down("abbr")) {
        this.selected_item.down("span").insert({
          after: '<abbr className="search-choice-close"></abbr>',
        });
      }
