...
(Vel = $ ? $.Velocity : jQuery ? jQuery.Velocity : Velocity),
      ...
      (a.fn.dropdown = function (b) {
        ...
        return "open" === b
          ...
          : void this.each(function () {
              function b() {
                void 0 !== f.data("induration") &&
                  (g.inDuration = f.data("induration")),
                  void 0 !== f.data("outduration") &&
                    (g.outDuration = f.data("outduration")),
                  void 0 !== f.data("constrainwidth") &&
                    (g.constrain_width = f.data("constrainwidth")),
                  void 0 !== f.data("hover") && (g.hover = f.data("hover")),
                  void 0 !== f.data("gutter") && (g.gutter = f.data("gutter")),
                  void 0 !== f.data("beloworigin") &&
                    (g.belowOrigin = f.data("beloworigin")),
                  void 0 !== f.data("alignment") &&
                    (g.alignment = f.data("alignment")),
                  void 0 !== f.data("stoppropagation") &&
                    (g.stopPropagation = f.data("stoppropagation"));
              }
              function d(c) {
                "focus" === c && (h = !0),
                  b(),
                ...
                if (
                  (r.is("body") ||
                    ...
                    r[0].scrollWidth > r[0].clientWidth &&
                      (q = r[0].scrollLeft)),
                  j + i.innerWidth() > a(window).width()
                    ? (l = "right")
                    : j - i.innerWidth() + f.innerWidth() < 0 && (l = "left"),
                  k + i.innerHeight() > d)
                )
              ...
              if ((b(), f.after(i), g.hover)) {
                ...
                f.unbind("click." + f.attr("id")),
                  ...
                  f.on("mouseleave", function (b) {
                    ...
                    a(c).closest(".dropdown-content").is(i) ||
                      (i.stop(!0, !0), e(), (j = !1));
                  }),
                  i.on("mouseleave", function (b) {
                    var c = b.toElement || b.relatedTarget;
                    a(c).closest(".dropdown-button").is(f) ||
                      (i.stop(!0, !0), e(), (j = !1));
                  });
              } else
                f.unbind("click." + f.attr("id")),
                  f.bind("click." + f.attr("id"), function (b) {
                    h ||
                      (f[0] != b.currentTarget ||
                      f.hasClass("active") ||
                      0 !== a(b.target).closest(".dropdown-content").length
                        ...
                        : (b.preventDefault(),
                          g.stopPropagation && b.stopPropagation(),
                          d("click")),
                      i.hasClass("active") &&
                        a(document).bind(
                          "click." +
  ...
  (function (a) {
    ...
    a.fn.extend({
      openModal: function (c) {
        ...
        if (!h.hasClass("open")) {
          var i = d(),
            j = a('<div className="lean-overlay"></div>');
          (lStack = ++b),
            j.attr("id", i).css("z-index", 1e3 + 2 * lStack),
            h.data("overlay-id", i).css("z-index", 1e3 + 2 * lStack + 1),
            h.addClass("open"),
            a("body").append(j),
            (c = a.extend(g, c)),
            c.dismissible &&
            ...
            j.css({ display: "block", opacity: 0 }),
            h.css({ display: "block", opacity: 0 }),
            j.velocity(
              { opacity: c.opacity },
              { duration: c.in_duration, queue: !1, ease: "easeOutCubic" }
            ),
            h.data("associated-overlay", j[0]),
            h.hasClass("bottom-sheet")
              ? h.velocity(
                  { bottom: "0", opacity: 1 },
                  {
              ...
              : (a.Velocity.hook(h, "scaleX", 0.7),
                h.css({ top: c.starting_top }),
                h.velocity(
      ...
      a.fn.extend({
        closeModal: function (c) {
          ...
          e.removeClass("open"),
            ...
            g.velocity(
              { opacity: 0 },
              { duration: c.out_duration, queue: !1, ease: "easeOutQuart" }
            ),
          ...
          i.wrap(j),
            i.on("click", function () {
              ...
              if (
                ...
                var p = a('<div className="materialbox-caption"></div>');
        ...
        return (
          ...
          this.each(function () {
            ...
            (d = a(f.filter('[href="' + location.hash + '"]'))),
              ...
              c.append('<div className="indicator"></div>');
            var j = c.find(".indicator");
            c.is(":visible") &&
              (j.css({ right: g - (i + 1) * h }), j.css({ left: i * h })),
              a(window).resize(function () {
                (g = c.width()),
                  (h = Math.max(g, c[0].scrollWidth) / f.length),
                  0 > i && (i = 0),
              ...
              c.on("click", "a", function (k) {
                ...
                if (!a(this).attr("target")) {
                  ...
                  (i = f.index(a(this))),
                    ...
                    void 0 !== e &&
                      (e.show(),
                      "function" == typeof b.onShow && b.onShow.call(this, e)),
                    i - l >= 0
                      ? (j.velocity(
                          { right: g - (i + 1) * h },
      ...
      return "remove" === c
        ...
        : ((c = a.extend(e, c)),
          this.each(function () {
            ...
            m();
            var n = function () {
              var b = a('<div className="material-tooltip"></div>');
              return (
                (j = g
                  ? a("<span></span>").html(j)
                  : a("<span></span>").text(j)),
                b.append(j).appendTo(a("body")).attr("id", e),
                (l = a('<div className="backdrop"></div>')),
                l.appendTo(b),
                b
              );
            };
      ...
      init: function (b) {
        ...
        (b = a.extend(c, b)),
          a(this).each(function () {
            ...
            var f = a('<div className="drag-target"></div>');
            a("body").append(f),
              "left" == b.edge
                ? (e.css("transform", "translateX(-100%)"), f.css({ left: 0 }))
                : (e
                  ...
                  if ("touch" == d.gesture.pointerType) {
                    ...
                    if (
                      ...
                      f < b.menuWidth / 2
                        ...
                        e.css(
                          "transform",
                          "translateX(" + (f - b.menuWidth) + "px)"
                        );
                    else {
                      f < window.innerWidth - b.menuWidth / 2
                        ? (h = !0)
                        : f >= window.innerWidth - b.menuWidth / 2 && (h = !1);
                    ...
                    "left" === b.edge
                      ...
                      : ((l = Math.abs((f - window.innerWidth) / b.menuWidth)),
                        a("#sidenav-overlay").velocity(
                          { opacity: l },
                          { duration: 10, queue: !1, easing: "easeOutQuad" }
                        ));
  ...
  (function (a) {
    a(document).ready(function () {
      ...
      e.length ||
        ((e = a('<div className="hiddendiv common"></div>')),
        a("body").append(e));
      ...
      (a.fn.material_select = function (b) {
        ...
        a(this).each(function () {
          ...
          if (!d.hasClass("browser-default")) {
            ...
            d.data("select-id", g);
            var h = a('<div className="select-wrapper"></div>');
            ...
            j.length &&
              ...
              d.wrap(h);
            var o = a('<span className="caret">&#9660;</span>');
        ...
        return (
          ...
          this.each(function () {
            ...
            -1 != k && (e = j.eq(k)),
              ...
              b.indicators &&
                ((f = a('<ul className="indicators"></ul>')),
                j.each(function (c) {
                  var e = a('<li className="indicator-item"></li>');
                  e.click(function () {
                    var c = i.parent(),
      ...
      (a.fn.material_chip = function (d) {
        ...
        return (
          ...
          "data" === d
            ...
            : (this.$el.data("options", a.extend({}, c, d)),
              (this.init = function () {
                var b = 0;
                e.$el.each(function () {
                  var c = a(this);
                ...
                e.$document.on("click", b.CHIPS, function (c) {
                  ...
                  e.$document.on(
                    ...
                    function (c) {
                      ...
                      return 13 === c.which
                        ? (c.preventDefault(),
                          e.addChip(g, { tag: d.val() }, f),
                          void d.val(""))
                        : (8 !== c.keyCode && 37 !== c.keyCode) ||
                          "" !== d.val() ||
                          !h
                        ? void 0
                        : (e.selectChip(g, h - 1, f), void d.blur());
                    }
                  ),
                  e.$document.on(
                    "click",
              ...
              (this.chips = function (a) {
                ...
                a.data("chips").forEach(function (a) {
                  ...
                  (b += '<input className="input" placeholder="">'),
                  a.html(b),
                  e.setPlaceholder(a);
              }),
              (this.renderChip = function (a) {
                if (a.tag) {
                  var b = '<div className="chip">' + a.tag;
                  return (
                    a.image && (b += ' <img src="' + a.image + '"> '),
                    (b += '<i className="material-icons close">close</i>'),
                    (b += "</div>")
                  );
                }
              }),
              (this.setPlaceholder = function (a) {
                ...
                a.data("chips").length && b.placeholder
                  ? a.find("input").prop("placeholder", b.placeholder)
                  : !a.data("chips").length &&
                    b.secondaryPlaceholder &&
                    a.find("input").prop("placeholder", b.secondaryPlaceholder);
              }),
              ...
              (this.selectChip = function (a, b, c) {
                ...
                d &&
                  !1 === d.hasClass("selected") &&
                  (d.addClass("selected"),
                  c.trigger("chip.select", c.data("chips")[b]));
              }),
              (this.getChipsElement = function (a, b) {
                return b.eq(a);
              }),
              this.init(),
              void (b || (this.handleEvents(), (b = !0))))
        );
      });
  })(jQuery),
  (function (a) {
  ...
  (function (a) {
    ...
    function c(b) {
      var c = b.parent().find('span[className="character-counter"]');
      c.length ||
        ((c = a("<span/>")
    ...
    function d() {
      a(this).parent().find('span[className="character-counter"]').html("");
    }
    function e(a, b) {
    ...
    (a.fn.characterCounter = function () {
      return this.each(function () {
        var e = a(this),
          f = e.parent().find('span[className="character-counter"]');
        if (!f.length) {
        ...
        return (
          ...
          this.each(function () {
            ...
            var o,
              ...
              E,
              F,
              G = a('<ul className="indicators"></ul>'),
              H = a(this),
            ...
            H.addClass("initialized"),
              ...
              H.find(".carousel-item").each(function (b) {
                if ((o.push(a(this)[0]), I)) {
                  var c = a('<li className="indicator-item"></li>');
