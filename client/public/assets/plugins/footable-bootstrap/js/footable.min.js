    ...
    b.Cell = b.Class.extend({
      ...
      val: function (c, d) {
        ...
        if (
          ((this.o = a.extend(
            !0,
            { classes: e.classes, style: e.style },
            f ? c.options : {}
          )),
          (this.value = f ? c.value : c),
          ...
          h.append(this.format(this.value)),
            this._setClasses(h),
            this._setStyle(h),
    ...
    b.Row = b.Class.extend({
      ...
      val: function (c, d) {
        ...
        if (
          ((this.o = a.extend(
            !0,
            { expanded: e.expanded, classes: e.classes, style: e.style },
            g ? c.options : {}
          )),
        ...
        b.arr.each(this.cells, function (a) {
          b.is.defined(e.value[a.column.name]) &&
            a.val(e.value[a.column.name], !1);
        }),
          this.created &&
            (this._setClasses(this.$el),
            this._setStyle(this.$el),
        ...
        if (this.created) {
          ...
          a.ft.raise("expand.ft.row", [a]).then(function () {
            (a.__hidden__ = b.arr.map(a.cells, function (a) {
              ...
              a.$toggle.removeClass("fooicon-plus").addClass("fooicon-minus"),
              (a.expanded = !0);
          });
        }
      },
        ...
        if (this.created) {
          ...
          c.ft.raise("collapse.ft.row", [c]).then(function () {
            b.arr.each(c.__hidden__, function (a) {
              ...
              c.$toggle.removeClass("fooicon-minus").addClass("fooicon-plus"),
            ...
            .always(function (d) {
              return (
                ...
                b.is.error(d)
                  ...
                  : c.raise("ready.ft.table").then(function () {
  ...
  (function (a, b) {
    (b.Filtering = b.Component.extend({
      ...
      $create: function () {
        ...
        d.ft.$el.addClass("footable-filtering").addClass(c),
          ...
          (d.$cell = a("<th/>")
            ...
            .appendTo(d.$row)),
          (d.$form = a("<form/>", { class: "form-inline" })
            .append(e)
            .appendTo(d.$cell)),
          (d.$input = a("<input/>", {
            type: "text",
          ...
          (d.$button = a("<button/>", {
            ...
            .append(a("<span/>", { class: "fooicon fooicon-search" }))),
          (d.$dropdown = a("<ul/>", {
            class: "dropdown-menu dropdown-menu-right",
          })),
          b.is.emptyString(d.dropdownTitle) ||
            d.$dropdown.append(
              a("<li/>", { class: "dropdown-header", text: d.dropdownTitle })
            ),
          d.$dropdown.append(
      ...
      filter: function () {
        var a = this;
        return (
          (a.filters = a.ensure(a.filters)),
          a.ft.raise("before.ft.filtering", [a.filters]).then(function () {
            return (
              (a.filters = a.ensure(a.filters)),
              a.ft.draw().then(function () {
      ...
      _onSearchColumnClicked: function (a) {
        ...
        null != b._filterTimeout && clearTimeout(b._filterTimeout),
          (b._filterTimeout = setTimeout(function () {
            ...
            a.hasClass("fooicon-remove") &&
              (a.removeClass("fooicon-remove").addClass("fooicon-search"),
            ...
            b.arr.each(c.ft.columns.array, function (b) {
              b.sortable &&
                b.$el
                  ...
                  .append(a("<span/>", { class: "fooicon fooicon-sort" }));
            }),
              c.ft.$el.on(
                "click.footable",
                ".footable-sortable",
      ...
      draw: function () {
        if (this.column) {
          ...
          b
            ...
            b.not(c).children(".fooicon").addClass("fooicon-sort"),
            c
              .addClass(
  ...
  (function (a, b) {
    (b.Paging = b.Component.extend({
      ...
      draw: function () {
        if (this.total <= 1)
          ...
          if (this.detached) {
            ...
            0 == b.length && ((b = a("<tfoot/>")), this.ft.$el.append(b)),
              this.$row.appendTo(b),
              (this.detached = !1);
          }
          this.$cell.attr("colspan", this.ft.columns.visibleColspan),
      ...
      $create: function () {
        ...
        this.ft.$el.addClass("footable-paging").addClass(b),
          (this.$cell = a("<td/>").attr(
            "colspan",
        ...
        0 == c.length && ((c = a("<tfoot/>")), this.ft.$el.append(c)),
          (this.$row = a("<tr/>", { class: "footable-paging" })
            .append(this.$cell)
            .appendTo(c)),
          (this.$pagination = a("<ul/>", { class: "pagination" }).on(
            "click.footable",
            "a.footable-page-link",
            { self: this },
            this._onPageClicked
          )),
          (this.$count = a("<span/>", { class: "label label-default" })),
          this.$cell.append(
            this.$pagination,
            a("<div/>", { class: "divider" }),
            this.$count
      ...
      pageSize: function (a) {
        return b.is.number(a)
          ? ((this.size = a),
            (this.total = Math.ceil(this.ft.rows.all.length / this.size)),
            b.is.jq(this.$row) && this.$row.remove(),
            this.$create(),
            void this.ft.draw())
          : this.size;
      },
