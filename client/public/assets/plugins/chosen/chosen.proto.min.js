      ...
      return (
        ...
        (AbstractChosen.prototype.choice_label = function (a) {
          return this.include_group_label_in_selected && null != a.group_label
            ? "<b className='group-name'>" + a.group_label + "</b>" + a.html
            : a.html;
        }),
    ...
    (this.Chosen = (function (b) {
      ...
      return (
        ...
        (Chosen.prototype.set_up_html = function () {
          ...
          return (
            ...
            this.form_field.id.length &&
              (b.id = this.form_field.id.replace(/[^\w]/g, "_") + "_chosen"),
            (this.container = this.is_multiple
              ? new Element("div", b).update(
                  this.multi_temp.evaluate({ default: this.default_text })
                )
              : new Element("div", b).update(
                  this.single_temp.evaluate({ default: this.default_text })
                )),
            ...
            this.is_multiple
              ? ((this.search_choices =
                  this.container.down("ul.chosen-choices")),
                (this.search_container =
                  this.container.down("li.search-field")))
              : ((this.search_container =
                  this.container.down("div.chosen-search")),
        ...
        (Chosen.prototype.register_observers = function () {
          var a = this;
          return (
            this.container.observe("touchstart", function (b) {
            ...
            this.is_multiple
              ? this.search_choices.observe("click", function (b) {
          ...
          return (
            ...
            this.is_disabled
              ...
              : (this.container.removeClassName("chosen-disabled"),
                ...
                this.is_multiple
                  ? void 0
                  : this.selected_item.observe("focus", this.activate_action))
          );
        }),
        (Chosen.prototype.container_mousedown = function (a) {
          return this.is_disabled ||
            (a && "mousedown" === a.type && !this.results_showing && a.stop(),
            null != a && a.target.hasClassName("search-choice-close"))
            ? void 0
            : (this.active_field
                ? this.is_multiple ||
                  !a ||
                  (a.target !== this.selected_item &&
                    !a.target.up("a.chosen-single")) ||
                  this.results_toggle()
                : (this.is_multiple && this.search_field.clear(),
        ...
        (Chosen.prototype.search_results_mousewheel = function (a) {
          var b;
          return (
            (b = a.deltaY || -a.wheelDelta || a.detail),
            null != b
              ? (a.preventDefault(),
        ...
        (Chosen.prototype.test_active_click = function (a) {
          return a.target.up(".chosen-container") === this.container
            ? (this.active_field = !0)
            : this.close_field();
        }),
            ...
            this.is_multiple
              ...
              : this.is_multiple ||
                ...
                this.form_field.options.length <= this.disable_search_threshold
                  ? ((this.search_field.readOnly = !0),
                    this.container.addClassName(
                      "chosen-container-single-nosearch"
                    ))
                  : ((this.search_field.readOnly = !1),
                    this.container.removeClassName(
                      "chosen-container-single-nosearch"
                    ))),
        ...
        (Chosen.prototype.result_do_highlight = function (a) {
          ...
          return (
            ...
            b >= e
              ? (this.search_results.scrollTop = b - d > 0 ? b - d : 0)
              : f > c
              ? (this.search_results.scrollTop = c)
              : void 0
          );
        }),
        ...
        (Chosen.prototype.set_label_behavior = function () {
          ...
          return (
            ...
            null != this.form_field_label
              ? this.form_field_label.observe("click", function (b) {
                  return a.is_multiple
        ...
        (Chosen.prototype.search_results_mouseup = function (a) {
          var b;
          return (
            (b = a.target.hasClassName("active-result")
              ? a.target
              : a.target.up(".active-result")),
            b
        ...
        (Chosen.prototype.search_results_mouseout = function (a) {
          return a.target.hasClassName("active-result") ||
            a.target.up(".active-result")
            ? this.result_clear_highlight()
            : void 0;
        }),
        (Chosen.prototype.choice_build = function (a) {
          var b,
            ...
            d = this;
          return (
            (b = new Element("li", { class: "search-choice" }).update(
              "<span>" + this.choice_label(a) + "</span>"
            )),
            a.disabled
              ? b.addClassName("search-choice-disabled")
              : ((c = new Element("a", {
                  href: "#",
                ...
                b.insert(c)),
            this.search_container.insert({ before: b })
          );
        }),
        ...
        (Chosen.prototype.choice_destroy = function (a) {
          return this.result_deselect(a.readAttribute("rel"))
            ? (this.show_search_field_default(),
              this.is_multiple &&
                this.choices_count() > 0 &&
        ...
        (Chosen.prototype.results_reset = function () {
          return (
            ...
            "function" == typeof Event.simulate &&
            ...
            ? ((b = this.result_highlight),
              ...
              this.max_selected_options <= this.choices_count()
                ? (this.form_field.fire("chosen:maxselected", { chosen: this }),
                  !1)
                : (this.is_multiple
                    ? b.removeClassName("active-result")
                    : this.reset_single_select_options(),
                  b.addClassName("result-selected"),
                  (c =
                    this.results_data[
                      b.getAttribute("data-option-array-index")
                    ]),
                  (c.selected = !0),
        ...
        (Chosen.prototype.single_deselect_control_build = function () {
          return this.allow_single_deselect
            ? (this.selected_item.down("abbr") ||
                this.selected_item
                  .down("span")
                  .insert({
                    after: '<abbr className="search-choice-close"></abbr>',
                  }),
              this.selected_item.addClassName("chosen-single-with-deselect"))
            : void 0;
        }),
        ...
        (Chosen.prototype.winnow_results_set_highlight = function () {
          ...
          return (
            this.is_multiple ||
              (a = this.search_results.down(".result-selected.active-result")),
        ...
        (Chosen.prototype.no_results = function (a) {
          return (
            this.search_results.insert(
              this.no_results_temp.evaluate({ terms: a })
            ),
            this.form_field.fire("chosen:no_results", { chosen: this })
          );
        }),
        (Chosen.prototype.no_results_clear = function () {
          ...
          for (
            a = null, b = [];
            (a = this.search_results.down(".no-results"));
        ...
        (Chosen.prototype.keydown_arrow = function () {
          ...
          return this.results_showing && this.result_highlight
            ? (a = this.result_highlight.next(".active-result"))
        ...
        (Chosen.prototype.keyup_arrow = function () {
          ...
          return this.results_showing || this.is_multiple
            ? this.result_highlight
              ? ((c = this.result_highlight.previousSiblings()),
                (a = this.search_results.select("li.active-result")),
                (b = c.intersect(a)),
                b.length
                  ? this.result_do_highlight(b.first())
        ...
        (Chosen.prototype.keydown_backstroke = function () {
          ...
          return this.pending_backstroke
            ? (this.choice_destroy(this.pending_backstroke.down("a")),
              this.clear_backstroke())
            : ((a = this.search_container.siblings().last()),
              a &&
              a.hasClassName("search-choice") &&
              !a.hasClassName("search-choice-disabled")
                ? ((this.pending_backstroke = a),
                  this.pending_backstroke &&
                    this.pending_backstroke.addClassName("search-choice-focus"),
                  this.single_backstroke_delete
                    ? this.keydown_backstroke()
                    : this.pending_backstroke.addClassName(
                        "search-choice-focus"
                      ))
                : void 0);
        }),
        ...
        (Chosen.prototype.search_field_scale = function () {
          ...
          if (this.is_multiple) {
            ...
            return (
              (a = new Element("div", { style: e }).update(
                this.search_field.value.escapeHTML()
              )),
              ...
              g > b - 10 && (g = b - 10),
              this.search_field.setStyle({ width: g + "px" })
            );
          }
        }),
        Chosen
