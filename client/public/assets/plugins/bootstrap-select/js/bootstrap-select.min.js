    ...
    (l.VERSION = "1.12.4"),
      ...
      (l.prototype = {
        ...
        createLi: function () {
          var c = this,
            ...
            i = function (d, e, f, g) {
              return (
                '<a tabindex="0"' +
                ("undefined" != typeof e ? ' className="' + e + '"' : "") +
                (f ? ' style="' + f + '"' : "") +
          ...
          return (
            m.each(function (b) {
              ...
              if ((g++, !f.hasClass("bs-title-option"))) {
                ...
                if (
                  (f.data("content") ||
                    (o = r + '<span className="text">' + o + q + "</span>"),
                  t && f.data("divider") !== !0)
                ) {
                    ...
                    var y = s[0].label,
                      ...
                      A = s.data("icon")
                        ? '<span className="' +
                          ...
                          '"></span> '
                        : "";
                    (y = A + '<span className="text">' + j(y) + z + "</span>"),
                      0 !== b &&
                        d.length > 0 &&
        ...
        selectPosition: function () {
          this.$bsContainer = a('<div className="bs-container" />');
          var b,
            c,
            d,
            e = this,
        ...
        liveSearchListener: function () {
          var c = this,
            d = a('<li className="no-results"></li>');
