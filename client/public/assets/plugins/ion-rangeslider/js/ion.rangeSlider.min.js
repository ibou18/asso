          ...
          for (d = 1; d <= h && 0 !== f; d++)
            (m = this.toFixed(f - k * d)),
              (n +=
                ...
                '%"></span>');
          n +=
            '<span className="irs-grid-pol" style="left: ' + f + '%"></span>';
