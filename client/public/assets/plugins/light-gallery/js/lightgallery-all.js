  ...
  Plugin.prototype.structure = function () {
    ...
    if (this.s.controls && this.$items.length > 1) {
      controls =
        ...
        '<div className="lg-prev lg-icon">' +
        this.s.prevHtml +
        "</div>" +
        '<div className="lg-next lg-icon">' +
        this.s.nextHtml +
        "</div>" +
        "</div>";
    }
    ...
    if (this.s.download) {
      this.$outer
        .find(".lg-toolbar")
        .append(
          '<a id="lg-download" target="_blank" download className="lg-download lg-icon"></a>'
        );
    }
    ...
    if (!_this.$slide.eq(index).hasClass("lg-loaded")) {
      if (iframe) {
        ...
        _this.$slide
          .eq(index)
          .prepend(
            '<div className="lg-img-wrap"><img className="lg-object lg-image" src="' +
              _src +
              '" /></div>'
          );
      }
  ...
  Autoplay.prototype.init = function () {
    ...
    if (_this.core.s.progressBar) {
      _this.core.$outer
        .find(".lg")
        .append(
          '<div className="lg-progress-bar"><div className="lg-progress"></div></div>'
        );
    }
...
(function ($, window, document, undefined) {
  ...
  Pager.prototype.init = function () {
    ...
    _this.core.$outer
      .find(".lg")
      .append('<div className="lg-pager-outer"></div>');

    if (_this.core.s.dynamic) {
      for (var i = 0; i < _this.core.s.dynamicEl.length; i++) {
        pagerList +=
          '<span className="lg-pager-cont"> <span className="lg-pager"></span><div className="lg-pager-thumb-cont"><span className="lg-caret"></span> <img src="' +
  ...
  Thumbnail.prototype.build = function () {
    ...
    function getThumb(src, thumb, index) {
      ...
      thumbList +=
        '<div data-vimeo-id="' +
        vimeoId +
        '" className="lg-thumb-item" style="width:' +
  ...
  Thumbnail.prototype.toogle = function () {
    ...
    if (_this.core.s.toogleThumb) {
      ...
      _this.$thumbOuter.append(
        '<span className="lg-toogle-thumb lg-icon"></span>'
      );
...
(function ($, window, document, undefined) {
  ...
  Video.prototype.loadVideo = function (src, addClass, noposter, index, html) {
    ...
    if (isVideo.youtube) {
      ...
      video =
        '<iframe className="lg-video-object lg-youtube ' +
        addClass +
      ...
      video =
        '<iframe className="lg-video-object lg-vimeo ' +
        addClass +
      ...
      video =
        '<iframe className="lg-video-object lg-dailymotion ' +
        addClass +
      ...
      video =
        '<iframe className="lg-video-object lg-vk ' +
        addClass +
...
(function ($, window, document, undefined) {
  ...
  Zoom.prototype.init = function () {
    var _this = this;
    var zoomIcons =
      '<span id="lg-zoom-in" className="lg-icon"></span><span id="lg-zoom-out" className="lg-icon"></span>';
